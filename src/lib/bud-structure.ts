...
export const GENETICS: Record<string, Genetics> = {
  ...
  // Batch 6 — Runtz/Gelato/Punch crosses, OG line, forum cookies, classics.
  "Platinum OG": { indica: 80, sativa: 20 },
  "Face Off OG": { indica: 80, sativa: 20 },
  "Yoda OG": { indica: 80, sativa: 20 },
  "Cherry Punch": { indica: 60, sativa: 40 },
  "LA Kush Cake": { indica: 70, sativa: 30 },
  "Lemon Cherry Gelato": { indica: 60, sativa: 40 },
  "Obama Runtz": { indica: 60, sativa: 40 },
  "Black Cherry Punch": { indica: 70, sativa: 30 },
  "Tropicana Cookies": { indica: 40, sativa: 60 },
  "White Hot Guava": { indica: 50, sativa: 50 },
  "Modified Grapes": { indica: 70, sativa: 30 },
  "Cherry MAC": { indica: 50, sativa: 50 },
  "High Octane OG": { indica: 85, sativa: 15 },
  "Gelato 45": { indica: 55, sativa: 45 },
  Guava: { indica: 60, sativa: 40 },
  "Fruity Pebbles OG": { indica: 55, sativa: 45 },
  OGKB: { indica: 80, sativa: 20 },
  "Garlic Juice": { indica: 70, sativa: 30 },
  "Forum Cookies": { indica: 60, sativa: 40 },
  "Black Cherry Pie": { indica: 60, sativa: 40 },
  "Strawberry Runtz": { indica: 50, sativa: 50 },
  "Apple Runtz": { indica: 50, sativa: 50 },
  "Grape Stomper": { indica: 50, sativa: 50 },
  "Cherry AK-47": { indica: 45, sativa: 55 },
  "White Widow": { indica: 50, sativa: 50 },
  "Purple Haze": { indica: 15, sativa: 85 },
  "Chocolate Diesel": { indica: 20, sativa: 80 },
  "Lemon Up": { indica: 30, sativa: 70 },
  "California Orange": { indica: 50, sativa: 50 },
  "Orange Velvet": { indica: 40, sativa: 60 },
  // Batch 7 — long tail by lineage signal (cake/cookies/sherb/kush/OG = dense).
  "Cake Crasher": { indica: 60, sativa: 40 },
  "Georgia Pie": { indica: 60, sativa: 40 },
  "Wedding Pie": { indica: 60, sativa: 40 },
  "Mandarin Cookies": { indica: 40, sativa: 60 },
  "White Tahoe Cookies": { indica: 60, sativa: 40 },
  "Banana Punch": { indica: 70, sativa: 30 },
  "Sundae Sherbert": { indica: 60, sativa: 40 },
  Sherblato: { indica: 55, sativa: 45 },
  "Blue Sherbert": { indica: 60, sativa: 40 },
  "White Gushers": { indica: 60, sativa: 40 },
  "Guava Runtz": { indica: 50, sativa: 50 },
  "Mango Runtz": { indica: 50, sativa: 50 },
  "Pink Kush": { indica: 90, sativa: 10 },
  "Platinum Kush": { indica: 80, sativa: 20 },
  "Khalifa Kush": { indica: 80, sativa: 20 },
  "Holy Grail Kush": { indica: 70, sativa: 30 },
  "Pakistani Chitral Kush": { indica: 100, sativa: 0 },
  "Triangle Mints": { indica: 60, sativa: 40 },
  "Sour OG": { indica: 50, sativa: 50 },
  "Marshmallow OG": { indica: 70, sativa: 30 },
  "White Fire OG": { indica: 55, sativa: 45 },
  "Goji OG": { indica: 50, sativa: 50 },
  "Super Silver Haze": { indica: 20, sativa: 80 },
  Haze: { indica: 10, sativa: 90 },
  "Neville's Haze": { indica: 10, sativa: 90 },
  "Sour Tsunami": { indica: 40, sativa: 60 },
  "Lemon Diesel": { indica: 40, sativa: 60 },
  "White Diesel": { indica: 40, sativa: 60 },
  "Sour Apple": { indica: 50, sativa: 50 },
  "Tangie Banana": { indica: 40, sativa: 60 },
  // Batch 8 — deeper long tail, lineage signal (low confidence).
  "Layer Cake": { indica: 60, sativa: 40 },
  "Grape Cake": { indica: 60, sativa: 40 },
  "Insane Pound Cake": { indica: 70, sativa: 30 },
  "Cherry Cookies": { indica: 50, sativa: 50 },
  "Monster Cookies": { indica: 70, sativa: 30 },
  "Zesty Garlic Cookies": { indica: 70, sativa: 30 },
  "Foreign Kush Mints": { indica: 60, sativa: 40 },
  "Bubba Mints": { indica: 70, sativa: 30 },
  "Cotton Candy Kush": { indica: 60, sativa: 40 },
  "Cataract Kush": { indica: 90, sativa: 10 },
  "Durban Kush": { indica: 60, sativa: 40 },
  "Presidential Kush": { indica: 80, sativa: 20 },
  "Triple Double OG": { indica: 60, sativa: 40 },
  "OG #18": { indica: 70, sativa: 30 },
  "Nepali OG": { indica: 70, sativa: 30 },
  "Hells OG": { indica: 70, sativa: 30 },
  "Aspen OG": { indica: 60, sativa: 40 },
  "Grape Soda": { indica: 70, sativa: 30 },
  "Hash Plant": { indica: 90, sativa: 10 },
  "Purple Gorilla": { indica: 80, sativa: 20 },
  "Master Bubba": { indica: 80, sativa: 20 },
  "Sour Grape": { indica: 60, sativa: 40 },
  "Sour Glue": { indica: 50, sativa: 50 },
  "Uptown Haze": { indica: 20, sativa: 80 },
  "Lemon OG Haze": { indica: 30, sativa: 70 },
  "Sapphire Haze": { indica: 20, sativa: 80 },
  "Super Diesel": { indica: 30, sativa: 70 },
  "Delphi Diesel": { indica: 40, sativa: 60 },
  "California Sour": { indica: 40, sativa: 60 },
  "Purple Dream": { indica: 40, sativa: 60 },
  // Batch 9 — long tail (lineage signal, low confidence).
  "Gas Face": { indica: 60, sativa: 40 },
  "Hippie Crasher": { indica: 55, sativa: 45 },
  "Grape Gas": { indica: 60, sativa: 40 },
  Sherbanger: { indica: 50, sativa: 50 },
  "Lemon Pound Cake": { indica: 50, sativa: 50 },
  "Sherb Crasher": { indica: 55, sativa: 45 },
  "Power Sherbet": { indica: 60, sativa: 40 },
  "Cherry Cake": { indica: 60, sativa: 40 },
  "OZ Kush": { indica: 70, sativa: 30 },
  "Orange Cookies": { indica: 50, sativa: 50 },
  "Jet Fuel Gelato": { indica: 50, sativa: 50 },
  "Rainbow Sherbet": { indica: 50, sativa: 50 },
  "Chem's Sister": { indica: 50, sativa: 50 },
  "Tres Dawg": { indica: 60, sativa: 40 },
  "Alien Kush": { indica: 70, sativa: 30 },
  "Sour Bubble": { indica: 70, sativa: 30 },
  "Khalifa Mints": { indica: 60, sativa: 40 },
  "Lemon Cherry Pie": { indica: 60, sativa: 40 },
  "Burmese Kush": { indica: 80, sativa: 20 },
  "Purple Skunk": { indica: 60, sativa: 40 },
  "Grape Krush": { indica: 80, sativa: 20 },
  "Big Skunk Korean": { indica: 70, sativa: 30 },
  "Sweet Skunk": { indica: 60, sativa: 40 },
  Skunkberry: { indica: 50, sativa: 50 },
  "BOG Bubble": { indica: 70, sativa: 30 },
  "Face Mints": { indica: 60, sativa: 40 },
  "Florida Kush": { indica: 70, sativa: 30 },
  "High Country Diesel": { indica: 40, sativa: 60 },
  Grapefruit: { indica: 40, sativa: 60 },
  "Pink Grapefruit": { indica: 40, sativa: 60 },
  // Batch 10 — long tail (lineage signal, low confidence).
  "Berry White": { indica: 60, sativa: 40 },
  "Cherry Lemonade": { indica: 50, sativa: 50 },
  "Orange Creamsicle": { indica: 50, sativa: 50 },
  "Lemon Cherry Push Pop": { indica: 60, sativa: 40 },
  "Sour Dubb": { indica: 60, sativa: 40 },
  "Banana Cream": { indica: 60, sativa: 40 },
  "Banana Daddy": { indica: 70, sativa: 30 },
  "Honey Banana": { indica: 60, sativa: 40 },
  "91 Hollywood Pure Kush": { indica: 70, sativa: 30 },
  "Black Cherry Funk": { indica: 60, sativa: 40 },
  "Eddy OG": { indica: 60, sativa: 40 },
  "Lost Coast OG": { indica: 60, sativa: 40 },
  "OG LA Affie": { indica: 70, sativa: 30 },
  "South Florida OG": { indica: 70, sativa: 30 },
  "Cherry Cola": { indica: 60, sativa: 40 },
  "Banana Runtz": { indica: 50, sativa: 50 },
  "Cookie Burger": { indica: 60, sativa: 40 },
  "Cookie Dough": { indica: 60, sativa: 40 },
  "Cookie Stash": { indica: 60, sativa: 40 },
  "Cookie Kush": { indica: 70, sativa: 30 },
  "Burnout Cookies": { indica: 60, sativa: 40 },
  "Strawberry OG Cookies": { indica: 60, sativa: 40 },
  "Bubblegum Gelato": { indica: 55, sativa: 45 },
  "Moonbeam Gelato": { indica: 55, sativa: 45 },
  "Purple Mandarin Punch": { indica: 60, sativa: 40 },
  "Soap x Purple Punch": { indica: 60, sativa: 40 },
  "Grapple Pie": { indica: 60, sativa: 40 },
  "Nevil's Wreck": { indica: 20, sativa: 80 },
  "Tropicana Banana": { indica: 40, sativa: 60 },
  "Cherry Maui Wowie": { indica: 30, sativa: 70 },
};
...
export const DENSITY: Record<string, DensityEntry> = {
  ...
  // — Batch 6: dense Runtz/Gelato/Punch, OG line, forum cookies, fruity —
  "Platinum OG": { lean: "dense", confidence: "medium", sources: "Dense OG-line nugs" },
  "Face Off OG": { lean: "dense", confidence: "medium", sources: "Dense, gassy OG" },
  "Yoda OG": { lean: "dense", confidence: "medium", sources: "Dense OG-line nugs" },
  "Cherry Punch": { lean: "dense", confidence: "medium", sources: "Dense, Purple Punch line" },
  "LA Kush Cake": { lean: "dense", confidence: "medium", sources: "Dense, frosty cake-line" },
  "Lemon Cherry Gelato": { lean: "dense", confidence: "medium", sources: "Dense, frosty gelato-line" },
  "Obama Runtz": { lean: "dense", confidence: "medium", sources: "Dense, frosty Runtz pheno" },
  "Black Cherry Punch": { lean: "dense", confidence: "medium", sources: "Dense, Punch-line" },
  "Tropicana Cookies": { lean: "dense", confidence: "low", sources: "Correction vs sativa-lean presumed: dense, frosty (Tangie x GSC)" },
  "White Hot Guava": { lean: "dense", confidence: "medium", sources: "Dense, frosty hybrid" },
  "Modified Grapes": { lean: "dense", confidence: "medium", sources: "Dense (GMO x Purple Punch)" },
  "Cherry MAC": { lean: "dense", confidence: "medium", sources: "Dense, frosty MAC-line" },
  "High Octane OG": { lean: "dense", confidence: "medium", sources: "Dense, gassy OG" },
  "Gelato 45": { lean: "dense", confidence: "medium", sources: "Dense, frosty gelato pheno" },
  Guava: { lean: "dense", confidence: "low", sources: "Moderately dense" },
  "Fruity Pebbles OG": { lean: "dense", confidence: "medium", sources: "Dense, frosty" },
  OGKB: { lean: "dense", confidence: "medium", sources: "Dense, very frosty (OG Kush Breath)" },
  "Garlic Juice": { lean: "dense", confidence: "medium", sources: "Dense, gassy GMO-line" },
  "Forum Cookies": { lean: "dense", confidence: "medium", sources: "Dense, frosty (Forum Cut GSC)" },
  "Black Cherry Pie": { lean: "dense", confidence: "medium", sources: "Dense, dark" },
  "Strawberry Runtz": { lean: "dense", confidence: "low", sources: "Dense, frosty Runtz pheno" },
  "Apple Runtz": { lean: "dense", confidence: "low", sources: "Dense, frosty Runtz pheno" },
  "Grape Stomper": { lean: "dense", confidence: "low", sources: "Dense, gassy" },
  "Cherry AK-47": { lean: "dense", confidence: "low", sources: "Moderately dense" },
  "White Widow": { lean: "dense", confidence: "low", sources: "Correction vs balanced presumed: medium-dense, chunky resinous buds" },
  // — Batch 6: fluffy / airy sativas —
  "Purple Haze": { lean: "fluffy", confidence: "medium", sources: "Airy, classic sativa structure" },
  "Chocolate Diesel": { lean: "fluffy", confidence: "medium", sources: "Airy diesel sativa" },
  "Lemon Up": { lean: "fluffy", confidence: "low", sources: "Slightly airy, sativa-leaning" },
  "California Orange": { lean: "fluffy", confidence: "low", sources: "Medium, slightly airy" },
  "Orange Velvet": { lean: "fluffy", confidence: "low", sources: "Medium, slightly airy" },

  // — Batch 7: dense by lineage (cake/cookies/sherb/kush/OG) —
  "Cake Crasher": { lean: "dense", confidence: "low", sources: "Dense cake-line (lineage)" },
  "Georgia Pie": { lean: "dense", confidence: "medium", sources: "Dense, frosty" },
  "Wedding Pie": { lean: "dense", confidence: "low", sources: "Dense cake-line (lineage)" },
  "Mandarin Cookies": { lean: "dense", confidence: "low", sources: "Correction vs sativa-lean: dense cookies-line" },
  "White Tahoe Cookies": { lean: "dense", confidence: "low", sources: "Dense cookies-line (lineage)" },
  "Banana Punch": { lean: "dense", confidence: "medium", sources: "Dense, Punch-line" },
  "Sundae Sherbert": { lean: "dense", confidence: "low", sources: "Dense sherbet-line (lineage)" },
  Sherblato: { lean: "dense", confidence: "low", sources: "Dense sherbet/gelato-line (lineage)" },
  "Blue Sherbert": { lean: "dense", confidence: "low", sources: "Dense sherbet-line (lineage)" },
  "White Gushers": { lean: "dense", confidence: "low", sources: "Dense Gushers-line (lineage)" },
  "Guava Runtz": { lean: "dense", confidence: "low", sources: "Dense Runtz pheno (lineage)" },
  "Mango Runtz": { lean: "dense", confidence: "low", sources: "Dense Runtz pheno (lineage)" },
  "Pink Kush": { lean: "dense", confidence: "medium", sources: "Dense Kush indica" },
  "Platinum Kush": { lean: "dense", confidence: "medium", sources: "Dense Kush indica" },
  "Khalifa Kush": { lean: "dense", confidence: "medium", sources: "Dense OG-line Kush" },
  "Holy Grail Kush": { lean: "dense", confidence: "medium", sources: "Dense OG/Kush-line" },
  "Pakistani Chitral Kush": { lean: "dense", confidence: "medium", sources: "Dense landrace indica" },
  "Triangle Mints": { lean: "dense", confidence: "medium", sources: "Dense, frosty" },
  "Sour OG": { lean: "dense", confidence: "low", sources: "Dense OG-line (lineage)" },
  "Marshmallow OG": { lean: "dense", confidence: "low", sources: "Dense OG-line (lineage)" },
  "White Fire OG": { lean: "dense", confidence: "medium", sources: "Dense OG-line (WiFi)" },
  "Goji OG": { lean: "dense", confidence: "low", sources: "Dense OG-line (lineage)" },
  // — Batch 7: fluffy / airy hazes & diesels —
  "Super Silver Haze": { lean: "fluffy", confidence: "high", sources: "Classic airy haze" },
  Haze: { lean: "fluffy", confidence: "medium", sources: "Original airy haze structure" },
  "Neville's Haze": { lean: "fluffy", confidence: "medium", sources: "Airy haze structure" },
  "Sour Tsunami": { lean: "fluffy", confidence: "low", sources: "Airy, sativa-leaning CBD" },
  "Lemon Diesel": { lean: "fluffy", confidence: "low", sources: "Airy, diesel-leaning" },
  "White Diesel": { lean: "fluffy", confidence: "low", sources: "Airy, diesel-leaning" },
  "Sour Apple": { lean: "fluffy", confidence: "low", sources: "Slightly airy" },
  "Tangie Banana": { lean: "fluffy", confidence: "low", sources: "Airy, Tangie-line" },

  // — Batch 8: dense long-tail by lineage (cake/cookies/mints/Kush/OG) —
  "Layer Cake": { lean: "dense", confidence: "low", sources: "Dense cake-line (lineage)" },
  "Grape Cake": { lean: "dense", confidence: "low", sources: "Dense cake-line (lineage)" },
  "Insane Pound Cake": { lean: "dense", confidence: "low", sources: "Dense cake-line (lineage)" },
  "Cherry Cookies": { lean: "dense", confidence: "low", sources: "Dense cookies-line (lineage)" },
  "Monster Cookies": { lean: "dense", confidence: "low", sources: "Dense (GDP x GSC)" },
  "Zesty Garlic Cookies": { lean: "dense", confidence: "low", sources: "Dense GMO/cookies-line (lineage)" },
  "Foreign Kush Mints": { lean: "dense", confidence: "low", sources: "Dense mints-line (lineage)" },
  "Bubba Mints": { lean: "dense", confidence: "low", sources: "Dense Bubba/mints-line (lineage)" },
  "Cotton Candy Kush": { lean: "dense", confidence: "low", sources: "Dense Kush-line (lineage)" },
  "Cataract Kush": { lean: "dense", confidence: "low", sources: "Dense Kush indica (lineage)" },
  "Durban Kush": { lean: "dense", confidence: "low", sources: "Dense Kush-line (lineage)" },
  "Presidential Kush": { lean: "dense", confidence: "low", sources: "Dense OG/Kush-line (lineage)" },
  "Triple Double OG": { lean: "dense", confidence: "low", sources: "Dense OG-line (lineage)" },
  "OG #18": { lean: "dense", confidence: "low", sources: "Dense OG-line (lineage)" },
  "Nepali OG": { lean: "dense", confidence: "low", sources: "Dense OG-line (lineage)" },
  "Hells OG": { lean: "dense", confidence: "low", sources: "Dense OG-line (lineage)" },
  "Aspen OG": { lean: "dense", confidence: "low", sources: "Dense OG-line (lineage)" },
  "Grape Soda": { lean: "dense", confidence: "low", sources: "Dense, gassy grape indica (lineage)" },
  "Hash Plant": { lean: "dense", confidence: "medium", sources: "Classic dense indica" },
  "Purple Gorilla": { lean: "dense", confidence: "low", sources: "Dense purple indica (lineage)" },
  "Master Bubba": { lean: "dense", confidence: "low", sources: "Dense Bubba-line indica (lineage)" },
  "Sour Grape": { lean: "dense", confidence: "low", sources: "Dense (Sour Diesel x GDP)" },
  "Sour Glue": { lean: "dense", confidence: "low", sources: "Dense-leaning (GG4 x Sour Diesel)" },
  // — Batch 8: fluffy long-tail by lineage (haze/diesel/sativa) —
  "Uptown Haze": { lean: "fluffy", confidence: "low", sources: "Airy haze (lineage)" },
  "Lemon OG Haze": { lean: "fluffy", confidence: "low", sources: "Airy haze (lineage)" },
  "Sapphire Haze": { lean: "fluffy", confidence: "low", sources: "Airy haze (lineage)" },
  "Super Diesel": { lean: "fluffy", confidence: "low", sources: "Airy diesel sativa (lineage)" },
  "Delphi Diesel": { lean: "fluffy", confidence: "low", sources: "Airy, diesel-leaning (lineage)" },
  "California Sour": { lean: "fluffy", confidence: "low", sources: "Airy, sativa-leaning (lineage)" },
  "Purple Dream": { lean: "fluffy", confidence: "low", sources: "Airy (Blue Dream line)" },

  // — Batch 9: dense long-tail by lineage —
  "Gas Face": { lean: "dense", confidence: "low", sources: "Dense, gassy (lineage)" },
  "Hippie Crasher": { lean: "dense", confidence: "low", sources: "Dense crasher-line (lineage)" },
  "Grape Gas": { lean: "dense", confidence: "low", sources: "Dense, gassy grape (lineage)" },
  Sherbanger: { lean: "dense", confidence: "low", sources: "Dense sherbet-line (lineage)" },
  "Lemon Pound Cake": { lean: "dense", confidence: "low", sources: "Dense cake-line (lineage)" },
  "Sherb Crasher": { lean: "dense", confidence: "low", sources: "Dense sherbet-line (lineage)" },
  "Power Sherbet": { lean: "dense", confidence: "low", sources: "Dense sherbet-line (lineage)" },
  "Cherry Cake": { lean: "dense", confidence: "low", sources: "Dense cake-line (lineage)" },
  "OZ Kush": { lean: "dense", confidence: "low", sources: "Dense Kush-line (lineage)" },
  "Orange Cookies": { lean: "dense", confidence: "low", sources: "Dense cookies-line (lineage)" },
  "Jet Fuel Gelato": { lean: "dense", confidence: "low", sources: "Dense, gassy gelato (lineage)" },
  "Rainbow Sherbet": { lean: "dense", confidence: "low", sources: "Dense sherbet-line (lineage)" },
  "Chem's Sister": { lean: "dense", confidence: "low", sources: "Dense, gassy chem (lineage)" },
  "Tres Dawg": { lean: "dense", confidence: "low", sources: "Dense, gassy chem (lineage)" },
  "Alien Kush": { lean: "dense", confidence: "low", sources: "Dense Kush-line (lineage)" },
  "Sour Bubble": { lean: "dense", confidence: "low", sources: "Dense, gassy (lineage)" },
  "Khalifa Mints": { lean: "dense", confidence: "low", sources: "Dense mints-line (lineage)" },
  "Lemon Cherry Pie": { lean: "dense", confidence: "low", sources: "Dense pie-line (lineage)" },
  "Burmese Kush": { lean: "dense", confidence: "low", sources: "Dense Kush indica (lineage)" },
  "Purple Skunk": { lean: "dense", confidence: "low", sources: "Dense purple skunk (lineage)" },
  "Grape Krush": { lean: "dense", confidence: "low", sources: "Dense purple Kush (lineage)" },
  "Big Skunk Korean": { lean: "dense", confidence: "low", sources: "Dense skunk indica (lineage)" },
  "Sweet Skunk": { lean: "dense", confidence: "low", sources: "Dense skunk-line (lineage)" },
  Skunkberry: { lean: "dense", confidence: "low", sources: "Dense, berry skunk (lineage)" },
  "BOG Bubble": { lean: "dense", confidence: "low", sources: "Dense, gassy (lineage)" },
  "Face Mints": { lean: "dense", confidence: "low", sources: "Dense mints-line (lineage)" },
  "Florida Kush": { lean: "dense", confidence: "low", sources: "Dense Kush/OG-line (lineage)" },
  // — Batch 9: fluffy long-tail —
  "High Country Diesel": { lean: "fluffy", confidence: "low", sources: "Airy diesel sativa (lineage)" },
  Grapefruit: { lean: "fluffy", confidence: "low", sources: "Airy, sativa-leaning (lineage)" },
  "Pink Grapefruit": { lean: "fluffy", confidence: "low", sources: "Airy, sativa-leaning (lineage)" },

  // — Batch 10: dense long-tail by lineage —
  "Berry White": { lean: "dense", confidence: "low", sources: "Dense (Blueberry x White Widow) (lineage)" },
  "Cherry Lemonade": { lean: "dense", confidence: "low", sources: "Dense, frosty (lineage)" },
  "Orange Creamsicle": { lean: "dense", confidence: "low", sources: "Dense, frosty (lineage)" },
  "Lemon Cherry Push Pop": { lean: "dense", confidence: "low", sources: "Dense gelato/cookies-line (lineage)" },
  "Sour Dubb": { lean: "dense", confidence: "low", sources: "Dense, gassy (lineage)" },
  "Banana Cream": { lean: "dense", confidence: "low", sources: "Dense, creamy indica-lean (lineage)" },
  "Banana Daddy": { lean: "dense", confidence: "low", sources: "Dense (GDP line) (lineage)" },
  "Honey Banana": { lean: "dense", confidence: "low", sources: "Dense indica-lean (lineage)" },
  "91 Hollywood Pure Kush": { lean: "dense", confidence: "low", sources: "Dense Kush/OG-line (lineage)" },
  "Black Cherry Funk": { lean: "dense", confidence: "low", sources: "Dense, dark (lineage)" },
  "Eddy OG": { lean: "dense", confidence: "low", sources: "Dense OG-line (lineage)" },
  "Lost Coast OG": { lean: "dense", confidence: "low", sources: "Dense OG-line (lineage)" },
  "OG LA Affie": { lean: "dense", confidence: "low", sources: "Dense OG/Afghani-line (lineage)" },
  "South Florida OG": { lean: "dense", confidence: "low", sources: "Dense OG-line (lineage)" },
  "Cherry Cola": { lean: "dense", confidence: "low", sources: "Dense, gassy (lineage)" },
  "Banana Runtz": { lean: "dense", confidence: "low", sources: "Dense Runtz pheno (lineage)" },
  "Cookie Burger": { lean: "dense", confidence: "low", sources: "Dense cookies-line (lineage)" },
  "Cookie Dough": { lean: "dense", confidence: "low", sources: "Dense cookies-line (lineage)" },
  "Cookie Stash": { lean: "dense", confidence: "low", sources: "Dense cookies-line (lineage)" },
  "Cookie Kush": { lean: "dense", confidence: "low", sources: "Dense cookies/Kush-line (lineage)" },
  "Burnout Cookies": { lean: "dense", confidence: "low", sources: "Dense cookies-line (lineage)" },
  "Strawberry OG Cookies": { lean: "dense", confidence: "low", sources: "Dense cookies/OG-line (lineage)" },
  "Bubblegum Gelato": { lean: "dense", confidence: "low", sources: "Dense gelato-line (lineage)" },
  "Moonbeam Gelato": { lean: "dense", confidence: "low", sources: "Dense gelato-line (lineage)" },
  "Purple Mandarin Punch": { lean: "dense", confidence: "low", sources: "Dense Punch-line (lineage)" },
  "Soap x Purple Punch": { lean: "dense", confidence: "low", sources: "Dense Punch-line (lineage)" },
  "Grapple Pie": { lean: "dense", confidence: "low", sources: "Dense pie-line (lineage)" },
  // — Batch 10: fluffy long-tail —
  "Nevil's Wreck": { lean: "fluffy", confidence: "low", sources: "Airy haze-line (lineage)" },
  "Tropicana Banana": { lean: "fluffy", confidence: "low", sources: "Airy, Tangie-line (lineage)" },
  "Cherry Maui Wowie": { lean: "fluffy", confidence: "low", sources: "Airy, Maui-line (lineage)" },
};
