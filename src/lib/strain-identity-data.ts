...
export const IDENTITIES: StrainIdentity[] = [
  ...
  // ── Garlic / funk family ──
  {
    ...
    marketNames: ["Garlic Cookies", "GMO", "Onion and Garlic"],
  ...
  },
  {
    ...
    marketNames: ["Skittlez", "Skittles", "Island Zkittlez", "Zkittlez #1", "The Z"],
  ...
  // ── Pine / spice sativas ──
  {
    ...
    marketNames: ["JH", "The Jack", "Jack", "Premium Jack", "Platinum Jack"],
    breeder: "Sensi Seeds",
    lineage: {
  ...
  // ── Custom / light data ──
  {
    ...
    lineage: {
      cross: "Stardawg × White Hashplant",
    },
    marketNames: ["Hot Guava", "WHG"],
    breeder: "Top Dawg Seeds",
    sensoryFamily: "tropical-fruit",
    phenotypeNotes: ["Guava-forward gas hybrid", "Custom seed entry — limited public lineage data"],
    curatorNote:
  ...
  },
  {
    ...
    breeder: "Backpack Boyz",
    lineage: {
      parents: ["Sunset Sherbet", "Girl Scout Cookies"],
      cross: "Sunset Sherbet × Girl Scout Cookies",
    },
    sensoryFamily: "dessert-cookies",
  ...
  },
  {
    ...
    lineage: {
      ...
      cross: "OG Kush × Master Kush × undisclosed third parent",
    },
    sensoryFamily: "gas-og",
  ...
  },
  {
    ...
    marketNames: ["Motorbreath #15", "Motor Breath", "Motorhead", "Motorbreath #2"],
  ...
  },
  {
    ...
    lineage: {
      parents: ["Mendocino Purps"],
      cross: "Mendocino Purps × undisclosed",
    },
    sensoryFamily: "purple-berry",
  ...
  },
  {
    ...
    marketNames: ["Soma's NYC Diesel", "NYCD", "New York City Diesel"],
    breeder: "Soma Seeds",
    lineage: {
  ...
  },
  {
    ...
    breeder: "Soloud Genetics",
    lineage: {
      parents: ["Kushberries", "White Runtz"],
      cross: "Kushberries × White Runtz",
    },
    sensoryFamily: "candy-exotic",
  ...
  },
  {
    ...
    lineage: {
      ...
      cross: "Sweet Pink Grapefruit × Orange Bud",
    },
    sensoryFamily: "tropical-fruit",
  ...
  },
  {
    ...
    marketNames: ["Trop", "Trop Cherry", "Cherry Trop", "Tropicanna Cherry"],
    lineage: {
  ...
  },
  {
    ...
    lineage: {
      parents: ["Lemon Skunk", "Purple Kush"],
      cross: "Lemon Skunk × Purple Kush",
    },
    sensoryFamily: "tropical-fruit",
  ...
  },
  {
    ...
    lineage: {
      parents: ["Lemon Skunk", "Cheese"],
      cross: "Lemon Skunk × Cheese",
    },
  ...
  },
  {
    ...
    breeder: "Seed Junky Genetics",
    lineage: {
      parents: ["Face Mints", "Biscotti × Sherbet bx"],
      cross: "Face Mints × (Biscotti × Sherbet bx)",
    },
    sensoryFamily: "gas-og",
  ...
  },
  {
    ...
    breeder: "Capulator",
    lineage: {
      parents: ["MAC 1", "Alien Cheese"],
      cross: "MAC 1 × Alien Cheese",
    },
    sensoryFamily: "funky-exotic",
  ...
  },
  {
    ...
    breeder: "Apothecary Genetics",
    lineage: {
      parents: ["Master Kush", "Afghani"],
      cross: "Master Kush × Afghani",
    },
    sensoryFamily: "kush-classic",
  ...
  },
  {
    ...
    lineage: {
      parents: ["Obama Kush", "Runtz"],
      cross: "Obama Kush × Runtz",
    },
    sensoryFamily: "candy-exotic",
  ...
  },
  {
    ...
    lineage: {
      ...
      cross: "Juliet (J3 cut) × Strawberry Diesel",
    },
    sensoryFamily: "dessert-cookies",
  ...
  },
  {
    ...
    lineage: {
      cross: "White Truffle × Pure Michigan",
    },
    sensoryFamily: "garlic-funk",
  ...
  },
  {
    ...
    breeder: "Crockett Family Farms",
    lineage: {
      parents: ["Tangie", "Banana Sherbert"],
      cross: "Tangie × Banana Sherbert",
    },
    sensoryFamily: "tropical-fruit",
  ...
  },
  {
    ...
    lineage: {
      parents: ["Ken's Kush", "Appalachia"],
      cross: "Ken's Kush × Appalachia",
    },
    sensoryFamily: "haze-sativa",
  ...
  },
  {
    ...
    lineage: {
      parents: ["Cherry AK", "Cookies F2"],
      cross: "Cherry AK × Cookies F2",
    },
    sensoryFamily: "dessert-cookies",
  ...
  },
  {
    ...
    breeder: "HBK Genetics",
    lineage: {
      parents: ["Key Lime Pie", "Lavender"],
      cross: "Key Lime Pie × Lavender",
    },
    sensoryFamily: "gas-og",
  ...
  },
  {
    ...
    breeder: "Backpack Boyz",
    lineage: {
      parents: ["Lemon Cherry Gelato", "Push Pop"],
      cross: "Lemon Cherry Gelato × Push Pop",
    },
    sensoryFamily: "candy-exotic",
  ...
  },
  {
    ...
    breeder: "First Class Genetics",
    lineage: {
      parents: ["Black Cherry Funk", "Acai"],
      cross: "Black Cherry Funk × Acai",
    },
    sensoryFamily: "purple-berry",
  ...
  },
  {
    ...
    breeder: "Compound Genetics",
    lineage: {
      parents: ["Gelato 45", "White Diesel × High Octane × Jet Fuel"],
      cross: "Gelato 45 × (White Diesel × High Octane × Jet Fuel)",
    },
    sensoryFamily: "funky-exotic",
  ...
  },
  {
    ...
    lineage: {
      parents: ["Blackberry Kush", "Cherry Pie"],
      cross: "Blackberry Kush × Cherry Pie",
    },
    sensoryFamily: "purple-berry",
  ...
  },
  {
    ...
    lineage: {
      parents: ["Hash Plant", "Hindu Kush", "Burmese"],
      cross: "(Hash Plant × Hindu Kush) × Burmese",
    },
    sensoryFamily: "candy-exotic",
  ...
  },
  {
    ...
    lineage: {
      parents: ["Green Crack", "Trainwreck", "Afghanica", "White Rhino"],
      cross: "Green Crack × Trainwreck × Afghanica × White Rhino",
    },
    sensoryFamily: "sweet-haze",
  ...
  },
  {
    ...
    lineage: {
      ...
      cross: "Lemon OG × Gorilla Haze",
    },
    marketNames: ["Lemonade"],
    breeder: "Growing Passion",
    sensoryFamily: "citrus-haze",
  ...
  },
  {
    ...
    breeder: "Exotic Genetix",
    lineage: {
      parents: ["Gary Payton", "Red Runtz"],
      cross: "Gary Payton × Red Runtz",
    },
    sensoryFamily: "funky-exotic",
  ...
  },
  {
    ...
    lineage: {
      ...
      cross: "Hella Jelly × White Runtz",
    },
    marketNames: ["Jelly Donuts", "Jelly Donut"],
    breeder: "Humboldt Seed Company",
    sensoryFamily: "candy-exotic",
  ...
  },
  {
    ...
    breeder: "Jojorizo",
    lineage: {
      parents: ["Trainwreck", "98 Aloha White Widow"],
      cross: "Trainwreck × 98 Aloha White Widow",
    },
    sensoryFamily: "sweet-haze",
  ...
  },
  {
    ...
    breeder: "Crockett Family Farms",
    lineage: {
      parents: ["Strawberry Banana", "Tangie"],
      cross: "Strawberry Banana × Tangie",
    },
    sensoryFamily: "sweet-haze",
  ...
  },
  {
    ...
    lineage: {
      parents: ["Arcata Trainwreck", "Neville's Haze"],
      cross: "Arcata Trainwreck × Neville's Haze",
    },
  ...
  },
  {
    canonicalName: "Acai",
    lineage: {
      parents: ["Sunset Sherbet", "Thin Mint Cookies"],
      cross: "Sunset Sherbet × Thin Mint Cookies",
    },
  ...
  },
  {
    ...
    breeder: "Barney's Farm",
    lineage: {
      parents: ["Tropicanna", "Banana Kush"],
      cross: "Tropicanna × Banana Kush",
    },
    sensoryFamily: "citrus-haze",
  ...
  },
  {
    ...
    breeder: "Alien Labs",
    lineage: {
      parents: ["Zookies", "Biscotti #6"],
      cross: "Zookies × Biscotti #6",
    },
    sensoryFamily: "gelato-exotic",
  ...
  },
  {
    ...
    breeder: "Seed Junky Genetics",
    lineage: {
      parents: ["Sunset Sherbert", "Kush Mints #11"],
      cross: "Sunset Sherbert × Kush Mints #11",
    },
    sensoryFamily: "gelato-exotic",
  ...
  },
  {
    ...
    breeder: "Alien Genetics",
    lineage: {
      parents: ["Gelato #33", "Sour Apple IBL"],
      cross: "Gelato #33 × Sour Apple IBL",
    },
    sensoryFamily: "gelato-exotic",
  ...
  },
  {
    ...
    breeder: "Gage Green Genetics",
    lineage: {
      parents: ["California Orange", "Joseph OG"],
      cross: "California Orange × Joseph OG",
    },
    sensoryFamily: "citrus-haze",
  ...
  },
  {
    ...
    lineage: {
      ...
      cross: "BOG Bubble × Northern Lights #5",
    },
    sensoryFamily: "candy-exotic",
  ...
  },
  {
    ...
    breeder: "Compound Genetics",
    lineage: {
      parents: ["Jet Fuel Gelato", "Chem D × Triangle Kush"],
      cross: "Jet Fuel Gelato × (Chem D × Triangle Kush)",
    },
    sensoryFamily: "gas-og",
  ...
  },
  {
    ...
    breeder: "Compound Genetics",
    lineage: {
      parents: ["Khalifa Kush", "The Menthol"],
      cross: "Khalifa Kush × The Menthol",
    },
    sensoryFamily: "gas-og",
  ...
  },
  {
    ...
    breeder: "LIT Farms",
    lineage: {
      parents: ["Velvet Pie", "Lemon Cherry Gelato"],
      cross: "Velvet Pie × Lemon Cherry Gelato",
    },
    sensoryFamily: "candy-exotic",
  ...
  },
  {
    ...
    breeder: "Sensi Seeds",
    lineage: {
      parents: ["Skunk #1", "Old World Purple"],
      cross: "Skunk #1 × Old World Purple",
    },
    sensoryFamily: "purple-berry",
  ...
  },
  {
    ...
    lineage: {
      ...
      cross: "Ed Rosenthal Super Bud F2 selection",
    },
    sensoryFamily: "sweet-haze",
  ...
  },
  {
    ...
    lineage: {
      parents: ["Lemon Glue", "Girl Scout Cookies"],
      cross: "Lemon Glue × Girl Scout Cookies",
    },
  ...
  },
  {
    ...
    lineage: {
      parents: ["Blueberry"],
      cross: "DJ Short Blueberry-line selection",
    },
  ...
  },
  {
    ...
    breeder: "Spice of Life Seeds",
    lineage: {
      parents: ["Sweet Tooth", "P19"],
      cross: "Sweet Tooth × P19",
    },
    sensoryFamily: "sweet-haze",
  ...
  },
  {
    ...
    marketNames: ["MLB"],
    lineage: {
      parents: ["William's Wonder"],
      cross: "William's Wonder selection/synonym",
    },
    sensoryFamily: "kush-classic",
  ...
  },
  {
    ...
    lineage: {
      cross: "Afghani landrace (clone-only selection)",
    },
    breeder: "Alien Genetics",
    sensoryFamily: "gas-og",
  ...
  },
  {
    ...
    lineage: {
      parents: ["Wedding Cake", "Gelato #45"],
      cross: "Wedding Cake × Gelato #45",
    },
    sensoryFamily: "dessert-cookies",
  ...
  },
  {
    ...
    lineage: {
      cross: "Banana OG × Cookies and Cream",
    },
  ...
  },
  {
    canonicalName: "Pez",
    lineage: {
      parents: ["Afghani", "Pakistani"],
      cross: "Afghani × Pakistani landrace",
    },
    sensoryFamily: "candy-exotic",
  ...
  },
  {
    ...
    breeder: "Soma Seeds",
    lineage: {
      parents: ["Big Bud", "Skunk #1", "Korean"],
      cross: "Big Bud × Skunk #1 × Korean",
    },
    sensoryFamily: "kush-classic",
  ...
  },
  {
    ...
    breeder: "Spice of Life Seeds",
    lineage: {
      parents: ["Big Skunk", "Sweet Pink Grapefruit"],
      cross: "Big Skunk × Sweet Pink Grapefruit",
    },
    sensoryFamily: "sweet-haze",
  ...
  },
  {
    ...
    breeder: "Landrace",
    lineage: {
      parents: ["Angola landrace"],
      cross: "Angola landrace",
    },
    sensoryFamily: "pine-spice",
  ...
  },
  {
    ...
    lineage: {
      parents: ["Gelato #41", "Gushers"],
      cross: "Gelato #41 × Gushers",
    },
    sensoryFamily: "gelato-exotic",
  ...
  },
  {
    ...
    lineage: {
      ...
      cross: "Strawberry Banana × Honey Boo Boo",
    },
    sensoryFamily: "gelato-exotic",
  ...
  },
  {
    ...
    lineage: {
      parents: ["Neville's Haze", "Super Silver Haze", "Laos"],
      cross: "Neville's Haze × Super Silver Haze × Laos",
    },
    breeder: "Green House Seed Co",
    sensoryFamily: "citrus-haze",
  ...
  },
  {
    ...
    breeder: "Landrace",
    lineage: {
      parents: ["Guatemala landrace"],
      cross: "Guatemala highland landrace",
    },
    sensoryFamily: "pine-spice",
  ...
  // ── MISSING PARENT STRAINS (catalog-expansion #24) ──
  {
    ...
    lineage: {
      parents: ["Chemdawg 91", "Hollywood Pure Kush"],
      cross: "Chemdawg 91 × Hollywood Pure Kush",
    },
    sensoryFamily: "gas-og",
  ...
  },
  {
    ...
    lineage: {
      parents: ["Black Cherry Soda", "DJ Short's Blueberry"],
      cross: "Black Cherry Soda × DJ Short's Blueberry",
    },
    sensoryFamily: "purple-berry",
  ...
  },
  {
    ...
    breeder: "Landrace",
    lineage: {
      cross: "Mexico × Afghanistan landrace",
    },
    sensoryFamily: "diesel-chem",
  ...
  },
  {
    ...
    breeder: "Seed Junky Genetics",
    lineage: {
      parents: ["Animal Face", "Kush Mints #11"],
      cross: "Animal Face × Kush Mints #11",
    },
    sensoryFamily: "funky-exotic",
  ...
  },
  {
    ...
    breeder: "Jungle Boys",
    lineage: {
      cross: "LA Kush Cake × Triangle Kush",
    },
    sensoryFamily: "gas-og",
  ...
  },
  {
    ...
    lineage: {
      ...
      cross: "Grateful Breath × Cherry Puff",
    },
    sensoryFamily: "funky-exotic",
  ...
  },
  {
    ...
    marketNames: ["Fruity Juice", "Juicy Fruit Thai", "Juice Fruit"],
    breeder: "Sensi Seeds",
    lineage: {
  ...
  },
  {
    ...
    lineage: {
      cross: "Lemon Skunk × Pineapple Joy",
    },
    sensoryFamily: "sweet-haze",
  ...
  },
  {
    ...
    lineage: {
      parents: ["Chemdawg #4", "Pakistani Kush", "Lemon Thai"],
  ...
  },
  {
    ...
    breeder: "DNA Genetics",
    lineage: {
      cross: "Afghani clone-only selection",
    },
    sensoryFamily: "kush-classic",
  ...
  },
  {
    ...
    breeder: "Mr. Nice Seeds",
    lineage: {
      cross: "Northern Lights #1 × Northern Lights #5",
    },
    sensoryFamily: "kush-classic",
  ...
  },
  {
    ...
    breeder: "Humboldt Seed Company",
    lineage: {
      cross: "Raspberry Kush × Purple Kush",
    },
    sensoryFamily: "purple-berry",
  ...
  },
  {
    ...
    breeder: "Sunshine State Seed Company",
    lineage: {
      cross: "Tampa Crippie × Pakistani Blue Kush",
    },
    sensoryFamily: "gas-og",
  ...
  },
  {
    ...
    lineage: {
      parents: ["Girl Scout Cookies", "Cherry Pie"],
      cross: "Girl Scout Cookies × Cherry Pie",
    },
    sensoryFamily: "dessert-cookies",
  ...
  },
  {
    ...
    breeder: "Find",
    lineage: {
      parents: ["Half Moon Bay Gelato", "Strawberry Banana"],
      cross: "Half Moon Bay Gelato × Strawberry Banana",
    },
    sensoryFamily: "tropical-fruit",
  ...
  },
  {
    ...
    breeder: "Grassroots",
    lineage: {
      parents: ["Frosted Motorbreath", "Modified Muffins #10"],
      cross: "Frosted Motorbreath × Modified Muffins #10",
    },
    sensoryFamily: "gas-og",
  ...
  },
  {
    ...
    lineage: {
      parents: ["Platinum Lemon Cherry Gelato", "Oreoz"],
      cross: "Platinum Lemon Cherry Gelato × Oreoz",
    },
    sensoryFamily: "dessert-cookies",
  ...
  },
  {
    ...
    breeder: "Archive Seed Bank",
    lineage: {
      parents: ["White Fire #3", "Face Off OG BX2"],
      cross: "White Fire #3 × Face Off OG BX2",
    },
    sensoryFamily: "diesel-chem",
  ...
  },
  {
    ...
    lineage: {
      ...
      cross: "Strawberry Nuggets × Iced 'n' Baked",
    },
    sensoryFamily: "purple-berry",
  ...
  },
  {
    ...
    breeder: "Grocery",
    lineage: {
      parents: ["Papaya", "Slapz"],
      cross: "Papaya × Slapz",
    },
    sensoryFamily: "tropical-fruit",
    phenotypeNotes: ["Tropical papaya-sweet fruit over a light gas funk; name-driven consensus"],
    curatorNote:
  ...
  },
  {
    ...
    breeder: "Preferred Gardens",
    lineage: {
      parents: ["Permanent Marker", "Lazer Gun"],
      cross: "Permanent Marker × Lazer Gun",
    },
    sensoryFamily: "gas-og",
    phenotypeNotes: ["Reported as Permanent Marker x Lazer Gun, a dessert-gas cross"],
    curatorNote:
      "Glacier earns its name with a snow-blind coat of frost and a nose that opens gassy before melting into candied citrus and clean pine. The body settles in quietly, heavy and unhurried, like a slow thaw. A nightcap cultivar for those who like their gas wrapped in dessert.",
    tagline: "Frosty gas, candied citrus chill",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Peach Fuzz",
    breeder: "Masonic Smoker",
    lineage: {
      parents: ["Triangle Kush 91", "Peach 02", "Wilson"],
      cross: "Triangle Kush 91 × Peach 02 × Wilson",
    },
    sensoryFamily: "tropical-fruit",
    phenotypeNotes: ["Indica-leaning calm with a soft, fuzzy fruit nose"],
    curatorNote:
      "Peach Fuzz leads with the downy sweetness of ripe stone fruit, all peach skin and creamy candy. The effect is gentle and rounded, easing tension without flattening you. A soft-focus indica for unwinding into the evening.",
    tagline: "Soft peach candy calm",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Frozen Lemon",
    marketNames: ["Frozen Lemonade"],
    breeder: "Capulator",
    lineage: {
      parents: ["Freezer Burn", "Lemon Fire"],
      cross: "Freezer Burn × Lemon Fire",
    },
    sensoryFamily: "citrus-haze",
    phenotypeNotes: ["Limonene-forward, sativa-leaning citrus profile"],
    curatorNote:
      "Frozen Lemon snaps with cold lemon-drop brightness, a candied citrus edge cut by a whisper of diesel. The high is clear and lifted, sparking creative momentum without the crash. A daytime citrus cultivar built for motion.",
    tagline: "Icy lemon-drop cerebral lift",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Zerbert",
    marketNames: ["Zerbet"],
    breeder: "Seed Junky Genetics",
    lineage: {
      parents: ["Blue Sherbert", "Zkittlez"],
      cross: "Blue Sherbert × Zkittlez",
    },
    sensoryFamily: "candy-exotic",
    phenotypeNotes: ["Widely credited to Backpack Boyz as Blue Sherbert x Zkittlez", "Frosty, dense buds with loud fruit-candy nose"],
    curatorNote:
      "Zerbert pours out like its namesake: a creamy sherbet swirl of berry and tropical candy with a sugary lift. The effect is sociable and warm, melting into giggles and a sharp case of the munchies. A dessert-candy hybrid that lives up to the hype.",
    tagline: "Creamy berry sherbet candy",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Pink Grapefruit",
    marketNames: ["SPG"],
    breeder: "Flav",
    lineage: {
      parents: ["Cinderella 99", "Burmese Kush"],
      cross: "Cinderella 99 × Burmese Kush",
    },
    sensoryFamily: "citrus-haze",
    phenotypeNotes: ["Name nods to the classic Sweet Pink Grapefruit clone; limonene-dominant juicy citrus profile"],
    curatorNote:
      "Pink Grapefruit captures the real fruit: sweet juicy flesh edged with a bitter-peel bite. It opens bright and mood-lifting before settling into a relaxed, easy calm. A citrus cultivar that tastes as cheerful as it feels.",
    tagline: "Juicy pink citrus zing",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Butterscotch Biscotti",
    breeder: "Flav",
    lineage: {
      parents: ["Gelato #25", "South Florida OG"],
      cross: "Gelato #25 × South Florida OG",
    ...
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Reads as a butterscotch-leaning Biscotti pheno (Biscotti = Gelato #25 x South Florida OG)"],
    curatorNote:
      "Butterscotch Biscotti folds warm caramel and cookie-dough sweetness into a creamy, gas-touched exhale. The effect lands heavy and euphoric, melting tension and stoking the appetite. A rich dessert hybrid for the deep end of the evening.",
    tagline: "Warm butterscotch cookie indulgence",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Grape Ice",
    breeder: "Flav",
    sensoryFamily: "purple-berry",
    phenotypeNotes: ["House-brand (Flav) — pedigree unverified", "Myrcene-leaning, sedating grape-soda profile"],
    curatorNote:
      "Grape Ice tastes like frozen grape soda: candied purple sweetness with a dark berry undertow. The body sinks into a cool, heavy calm that drifts toward sleep. A frosty purple cultivar for shutting the day down.",
    tagline: "Frozen grape-soda nightcap",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Pineapple Dream",
    breeder: "Flav",
    lineage: {
      parents: ["Pineapple", "Blue Dream"],
      cross: "Pineapple × Blue Dream",
    },
    sensoryFamily: "tropical-fruit",
    phenotypeNotes: ["Flav brand cut; Pineapple x Blue Dream sativa-leaning hybrid"],
    curatorNote:
      "Crack the jar and ripe pineapple spills out, sugared and sunlit. A whisper of pine keeps it crisp while the high floats you into easy, conversational creativity. A daytime daydream in flower form.",
    tagline: "Sunlit pineapple daydream",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Tropical Trainwreck",
    breeder: "Flav",
    lineage: {
      parents: ["Pineapple Express", "Trainwreck"],
      cross: "Pineapple Express × Trainwreck",
    },
    sensoryFamily: "tropical-fruit",
    phenotypeNotes: ["Flav brand cut; Pineapple Express x Trainwreck", "Trainwreck adds spicy bite and racing cerebral energy"],
    curatorNote:
      "Tropical fruit hits first, all apricot and pineapple candy, then the Trainwreck heritage barrels in with a peppery kick. The lift is fast and electric before settling into a tingly, full-body calm. Sweet chaos, beautifully derailed.",
    tagline: "Sweet tropical derailment",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    ...
    breeder: "Mintz",
    lineage: {
      parents: ["Lemon Fuel OG", "Zookies"],
      cross: "Lemon Fuel OG × Zookies",
    },
    sensoryFamily: "diesel-chem",
    phenotypeNotes: ["Real exotic strain; Lemon Fuel OG x Zookies", "Distributed under the Mintz brand; resin-rich"],
    curatorNote:
      "Tart sour-candy citrus leaps out of the jar, wrapped in a fuel-station gassiness that means business. The Zookies backbone lends weight, melting an electric euphoria into a heavy, contented calm. Loud, frosty, and unapologetically exotic.",
    tagline: "Sour candy gas bomb",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Bubblegum Gelato",
    breeder: "Mintz",
    lineage: {
      parents: ["Gelato 45", "Indiana Bubblegum"],
      cross: "Gelato 45 × Indiana Bubblegum",
    },
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Real strain; Gelato 45 x Indiana Bubblegum", "Sold under the Mintz brand; ~60/40 indica-dominant"],
    curatorNote:
      "It smells exactly like pink bubblegum dipped in gelato, sugary and creamy at once. A gentle cerebral lift drifts into a soothing, melting body ease. Pure dessert-jar nostalgia with a frosty, indica finish.",
    tagline: "Creamy bubblegum dessert",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Purple Dream",
    breeder: "Mintz",
    lineage: {
      parents: ["Granddaddy Purple", "Blue Dream"],
      cross: "Granddaddy Purple × Blue Dream",
    },
    sensoryFamily: "purple-berry",
    phenotypeNotes: ["Real strain; Granddaddy Purple x Blue Dream", "Sold under the Mintz brand; calm without couch-lock"],
    curatorNote:
      "Deep grape and dark berry pour out of the GDP heritage, sweet as candy. Blue Dream threads a bright citrus clarity through the haze, keeping the body ease from tipping into couch-lock. Calm, colorful, and dreamily balanced.",
    tagline: "Grape-candy dream balance",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Simple Syrup",
    breeder: "Binske",
    sensoryFamily: "candy-exotic",
    phenotypeNotes: ["House-brand (Binske) — pedigree unverified", "Binske proprietary genetics; limonene-dominant"],
    curatorNote:
      "Cracking sweet, sugary citrus pours out like liquid candy over ice. The limonene-forward profile keeps everything bright and clean before a smooth, syrupy calm settles in. A polished, dessert-bar pour from Binske's vault.",
    tagline: "Sugary citrus syrup pour",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Golden Goat",
    breeder: "Mr. Dank",
    lineage: {
      parents: ["Hawaiian-Romulan", "Island Sweet Skunk"],
      cross: "Hawaiian-Romulan × Island Sweet Skunk",
    },
    sensoryFamily: "citrus-haze",
    phenotypeNotes: ["Classic strain; accidental cross discovered in Topeka, Kansas", "Terpinolene-dominant; ~65/35 sativa-leaning"],
    curatorNote:
      "A burst of tropical citrus and sweet-sour skunk announces itself loudly from the jar. Terpinolene lends a spicy, almost floral sharpness while the high sparks energetic, talkative creativity. A legendary daytime classic with real shine.",
    tagline: "Bright tropical skunk classic",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Bubblegum Gushers",
    breeder: "The Botanist",
    lineage: {
      parents: ["Bubblegum", "Gushers"],
      cross: "Bubblegum × Gushers",
    },
    sensoryFamily: "candy-exotic",
    phenotypeNotes: ["Candy-forward bubblegum nose with Gushers fruit", "Balanced hybrid effect, functional at low doses"],
    curatorNote:
      "A confection in flower form, this one leads with nostalgic pink bubblegum then folds in the juicy berry-tropical burst of its Gushers parent. The high is bright and social before settling into easy relaxation. Pure candy-shop indulgence.",
    tagline: "Pink candy meets juicy fruit",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Delphi Diesel",
    breeder: "Dark Heart Nursery",
    lineage: {
      parents: ["Sour Diesel"],
      cross: "Sour Diesel × undisclosed",
    },
    sensoryFamily: "diesel-chem",
    phenotypeNotes: ["Diesel-Chem-OG organoleptic profile, Sour Diesel-style nose"],
    curatorNote:
      "A fuel-forward daytime sativa that ignites the senses with sharp diesel and lemon-lime zest. Energetic and mentally clarifying, it cuts through fatigue and sparks focus. Classic East-Coast gas with a citrus edge.",
    tagline: "High-octane citrus fuel",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Lemon Venom",
    breeder: "Leal",
    lineage: {
      parents: ["Sensi Star", "Big Bud", "Mega Lemon"],
      cross: "Sensi Star × Big Bud × Mega Lemon",
    },
    sensoryFamily: "citrus-haze",
    phenotypeNotes: ["Limonene-dominant lemon nose over earthy pine", "Indica-leaning body relaxation with uplifting clarity"],
    curatorNote:
      "A bright burst of sour-sweet lemon zest greets you before earthy, piney depth grounds the experience. The body melts into relaxation while the mind stays clear and lifted. Citrus comfort with an indica embrace.",
    tagline: "Sour lemon body calm",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Galactic Jack",
    breeder: "TGA Subcool Seeds",
    lineage: {
      parents: ["Jack Herer", "Space Queen"],
      cross: "Jack Herer × Space Queen",
    },
    sensoryFamily: "citrus-haze",
    phenotypeNotes: ["TGA Subcool genetics heritage", "Limonene-led with pinene and fruity Space Queen undertones"],
    curatorNote:
  ...
  {
    canonicalName: "Monster Cookies",
    breeder: "Big Worm Genetics",
    lineage: {
      parents: ["Granddaddy Purple", "Girl Scout Cookies"],
      cross: "Granddaddy Purple × Girl Scout Cookies",
    },
    sensoryFamily: "purple-berry",
    phenotypeNotes: ["80% indica, GDP grape over GSC dessert complexity", "Caryophyllene/myrcene-driven heavy body finish"],
    curatorNote:
      "This indica fuses Granddaddy Purple's deep grape sweetness with Girl Scout Cookies' dessert-dough richness. A brief euphoric lift gives way to a heavy, blanketing calm built for restful evenings. Grape-candy decadence with serious weight.",
    tagline: "Grape-candy evening sedation",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Durban Kush",
    breeder: "Revert Cannabis",
    lineage: {
      parents: ["OG Kush", "Durban Poison"],
      cross: "OG Kush × Durban Poison",
    },
    sensoryFamily: "pine-spice",
    phenotypeNotes: ["Durban Poison spice meets OG Kush gas", "Terpinolene/caryophyllene-forward, energizing then grounding"],
    curatorNote:
      "A spirited sativa-leaning hybrid pairing Durban Poison's anise-spiced pine with the gassy backbone of OG Kush. It hits energizing and focused before a gentle grounding settles in. Old-world spice wrapped in modern gas.",
    tagline: "Piney spice with gas",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "WoMAC",
    marketNames: ["Watermelon MAC"],
    breeder: "LivWell",
    lineage: {
      parents: ["Watermelon", "MAC"],
      cross: "Watermelon × MAC",
    },
    sensoryFamily: "candy-exotic",
    phenotypeNotes: ["House cross of a Watermelon type with MAC (Miracle Alien Cookies)", "Terpinolene/caryophyllene-led, citrus-piney with watermelon sweetness"],
    curatorNote:
      "A bright, fruit-forward hybrid where juicy watermelon and citrus meet the gassy elegance of MAC. The high is clear-headed and uplifting, perfect for daytime creativity and easy social moments. Summer-fruit candy with a designer edge.",
    tagline: "Juicy watermelon MAC lift",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Berry Zest",
    breeder: "LivWell",
    lineage: {
      parents: ["Orange Tsunami", "Blueberry Cookies"],
      cross: "Orange Tsunami × Blueberry Cookies",
    },
    sensoryFamily: "purple-berry",
    phenotypeNotes: ["Myrcene-dominant with pinene support"],
    curatorNote:
      "A jar that opens like crushed summer berries dusted in lemon peel. The sweetness rounds into damp earth as the body sinks low and slow. An evening strain built for quiet unwinding.",
    tagline: "Berries, zest, and calm",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Papaya Juice",
    breeder: "Nirvana Seeds",
    sensoryFamily: "tropical-fruit",
    phenotypeNotes: ["Papaya parent traces to Citral #13 x Ice #2 (Nirvana lineage)", "CAM batch tested ~25.7% THC with limonene, caryophyllene, and linalool dominant"],
    curatorNote:
      "Crack the jar and tropical esters pour out like fresh-cut papaya and ripe pineapple. A whisper of sage and lime peel keeps it from cloying before turning earthy. The lift is fast, talkative, and creatively open.",
    tagline: "Tropical juice, creative lift",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Roasted Garlic Margy",
    marketNames: ["RGM"],
    breeder: "Cannarado Genetics",
    lineage: {
      parents: ["GMO", "Frozen Margy"],
      cross: "GMO × Frozen Margy",
    },
    sensoryFamily: "garlic-funk",
    phenotypeNotes: ["GMO contributes garlic-diesel-rubber funk; Frozen Margy adds structure and resin", "Long flowering pheno, larger flowers than typical Cookies hybrids"],
    curatorNote:
      "This is savory cannabis in full force: roasted garlic, sauteed onion, and chemical diesel coil up from the jar. The funk is loud and unapologetic, with a rubbery earthen backbone. The body sink lands hard and lingers.",
    tagline: "Savory garlic diesel funk",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Datura",
    breeder: "The Botanist",
    sensoryFamily: "citrus-haze",
    phenotypeNotes: ["House-brand (The Botanist) — pedigree unverified", "Fluffy lime-green trichome-heavy flowers; reported ~15% THC daytime sativa"],
    curatorNote:
      "Bright and zesty, Datura snaps with tropical citrus and fresh pine sap. The effect is mentally electric, tuned for focus and forward motion. A clear-headed daytime sativa with energetic edges.",
    tagline: "Citrus-pine daytime spark",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Memory Loss",
    marketNames: ["Memory Loss OG"],
    breeder: "Archive Seed Bank",
    lineage: {
      parents: ["Face Off OG", "Amnesia Haze"],
      cross: "Face Off OG × Amnesia Haze",
    },
    sensoryFamily: "haze-sativa",
    phenotypeNotes: ["Amnesia-type lineage; terpinolene, caryophyllene, and myrcene forward", "Named for the mind-warping, forgetful high; THC frequently 18-26%", "Also sold as Memory Loss OG"],
    curatorNote:
      "True to its name, this Amnesia-descended sativa hits the temples first and scatters the train of thought. Terpinolene brings piney-floral lift over a peppery earthen base. Fast, giddy, and wonderfully unfocused.",
    tagline: "Hazy, racy, forgetful high",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Purple Trainwreck",
    marketNames: ["Purple Wreck", "Granddaddy Wreck"],
    breeder: "Humboldt Seed Organization",
    lineage: {
      parents: ["Trainwreck", "Granddaddy Purple"],
      cross: "Trainwreck × Granddaddy Purple",
    },
    sensoryFamily: "pine-spice",
    phenotypeNotes: ["Original cut commonly Trainwreck x Mendo Purps; sold here as Trainwreck x GDP", "Terpinolene, myrcene, and caryophyllene driven; head-rush over body relaxation"],
    curatorNote:
      "Trainwreck's bright piney bite meets a grape-soda purple sweetness from its GDP side. The rush comes on fast and cerebral before settling into a soothing, non-couch-locking calm. Wood, citrus, and damp soil round the nose.",
    tagline: "Piney rush, purple calm",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Toasted Marshmallow",
    breeder: "Her Highness",
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["House-brand (Her Highness) — pedigree unverified", "Dessert-leaning profile sold as infused ground flower"],
    curatorNote:
      "Soft and confectionery, this one smells like vanilla cream toasting over a campfire. A subtle gassy edge keeps the sweetness grounded. The lift is bright and sociable rather than heavy.",
    tagline: "Toasted vanilla cream lift",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "French Tartz",
    marketNames: ["French Tarts"],
    breeder: "Her Highness",
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["House-brand (Her Highness) — pedigree unverified", "Sold as infused ground flower; name evokes a fruit-tart dessert profile"],
    curatorNote:
      "Like biting into a glazed French berry tart dusted with sugar. The sweetness rolls forward first, then a whisper of gas keeps it from feeling one-note. A playful, dessert-forward smoke for unwinding.",
    tagline: "Sweet berry pastry funk",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Grape Canyon Z",
    marketNames: ["Grape Canyon Zkittlez"],
    breeder: "Binske",
    lineage: {
      parents: ["Grape Pie", "Topanga Canyon", "Zkittlez"],
      cross: "(Grape Pie × Topanga Canyon) × Zkittlez",
    },
    sensoryFamily: "purple-berry",
    phenotypeNotes: ["Dominant terpenes: myrcene, linalool, beta-caryophyllene", "Tests around 28% THC; refined take on the Zkittlez profile"],
    curatorNote:
      "A bowl of crushed grapes and mixed berries with a candy-sweet finish. The Zkittlez heritage brings bright fruit while Grape Pie lends a rich, jammy depth. Smooth, euphoric, and deeply relaxing.",
    tagline: "Jammy grape candy euphoria",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Lemon Pepper",
    breeder: "Binske",
    lineage: {
      parents: ["Lemon Pebblez", "Lemon Cooler"],
      cross: "Lemon Pebblez × Lemon Cooler",
    },
    sensoryFamily: "citrus-haze",
    phenotypeNotes: ["Profile traces to the Cookies/Lemonnade lineage; Binske runs its own pheno", "Pinene and limonene most prevalent; sativa-leaning effect"],
    curatorNote:
      "Fresh-squeezed lemon meets a crack of black pepper. The citrus is loud and clean while the peppery spice adds a savory twist most lemon strains lack. An energizing, clear-headed daytime sativa.",
    tagline: "Zesty lemon pepper lift",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Azure Apricot",
    breeder: "Binske",
    sensoryFamily: "tropical-fruit",
    phenotypeNotes: ["House-brand (Binske) — pedigree unverified", "Name evokes blue-purple hues and a juicy apricot stone-fruit nose; sativa-leaning"],
    curatorNote:
      "Ripe apricot and honeysuckle bloom on the inhale, sweet and sun-warmed. The fruit stays bright and clean through to a soaring, clear-headed high. A cheerful, creativity-sparking sativa.",
    tagline: "Sun-ripe apricot sativa",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Zesty Garlic Cookies",
    breeder: "Grassroots Dark Heart",
    lineage: {
      parents: ["GMO", "Chemdawg", "Girl Scout Cookies"],
      cross: "GMO (Chemdawg × GSC) lineage",
    },
    sensoryFamily: "garlic-funk",
    phenotypeNotes: ["Built on the GMO/Garlic Cookies funk and dialed up with citrus brightness", "Indica-dominant; knockout body effect with savory garlic-mushroom backbone"],
    curatorNote:
      "Roasted garlic and diesel hit first, savory and unapologetically funky. A squeeze of citrus keeps the nose lively before the heavy indica body settles in. Pure connoisseur funk for couch-bound evenings.",
    tagline: "Savory garlic gas funk",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Triple Stack",
    breeder: "Grassroots Dark Heart",
    lineage: {
      parents: ["Red Bullz", "The Menthol"],
      cross: "Red Bullz × The Menthol",
    },
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Name implies a three-parent 'stack'; reported Cookies/Gelato x OG/Triangle x Chem/GMO; 20%+ THC"],
    curatorNote:
      "A layered build of sweet cookie cream, gassy OG, and a chem-funk underbelly. Each pull stacks dessert richness onto a heavy, resinous base. A potent, indica-leaning nightcap.",
    tagline: "Stacked cookie gas richness",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "The Prism",
    breeder: "Binske",
    lineage: {
      parents: ["Orange Cookies", "Lime Skunk"],
      cross: "Orange Cookies × Lime Skunk",
    },
    sensoryFamily: "gas-og",
    phenotypeNotes: ["Resin-drenched buds with blue, purple, and red hues", "Aromas of gas, dough, and cream; flavors of candy, petrol, and baked goods"],
    curatorNote:
      "Sweet bakery dough and cream refract through a bright gassy core, with a citrus-skunk edge from the Lime Skunk side. Glittering, resin-coated buds deliver a smooth, euphoric calm. A balanced, dessert-meets-gas indica.",
    tagline: "Candy cream gas spectrum",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Tangerine Twist",
    breeder: "Binske",
    lineage: {
      parents: ["Skunk #1", "Dead Head OG"],
      cross: "Skunk #1 × Dead Head OG",
    },
    sensoryFamily: "citrus-haze",
    phenotypeNotes: ["Citrus-forward sativa expression driven by limonene and terpinolene", "Clear-headed, daytime-leaning profile"],
    curatorNote:
      "Peel back the bud and you get a wash of sun-warmed tangerine and mango skin. Sweet garden herbs ride beneath the citrus, with a faint pine resin keeping it grounded. It drinks like a creative morning in a glass.",
    tagline: "Bright citrus daytime lift",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Jungle Pie",
    breeder: "Jungle Boys",
    lineage: {
      parents: ["Jungle Cake", "Wedding Pie"],
      cross: "Jungle Cake × Wedding Pie",
    },
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Dessert-pastry profile with vanilla-frosted dough and black-pepper spice", "Balanced body-first effect creeping into hazy happiness"],
    curatorNote:
      "Crack a jar and it's warm vanilla pastry dusted with black pepper. The smoke deepens into toasted nut and earthy funk, like dessert at the end of a long meal. It settles the body before lulling the mind into easy contentment.",
    tagline: "Vanilla pastry with spice",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Moonbeam Gelato",
    breeder: "Grassroots Dark Heart",
    lineage: {
      parents: ["Half Moon Bay Gelato", "Strawberry Banana"],
      cross: "Half Moon Bay Gelato × Strawberry Banana",
    ...
    sensoryFamily: "gelato-exotic",
    phenotypeNotes: ["Dark-purple buds with blueberry, grape, and fermented-cheese funk", "Evening-leaning Gelato cross with floaty, calming body effects"],
    curatorNote:
      "Snap a dark-purple nug and out spill muddled berries, overripe grape, and a swirl of whipped cream. A faint funky cheese rind keeps the sweetness from going flat. It floats you into a calm, euphoric evening headspace.",
    tagline: "Berry cream evening exotic",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Titan Express",
    breeder: "Grassroots Dark Heart",
    lineage: {
      parents: ["Citradelic Sunset", "Modified Muffins"],
      cross: "Citradelic Sunset RV06 × Modified Muffins #10",
    },
    sensoryFamily: "diesel-chem",
    phenotypeNotes: ["Terpinolene-driven Haze-leaning rush with bold wake-up energy", "Savory fuel-and-garlic edge over sharp citrus"],
    curatorNote:
      "This one opens loud: lemon popsicle slamming into burnt tires and savory garlic-pine. The terpinolene rush hits fast and mentally electric. A summer's-day brightness wrapped around a fuel core.",
    tagline: "Fast citrus fuel rush",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Devil Driver",
    breeder: "Tiki Madman",
    lineage: {
      parents: ["Melonade", "Sundae Driver"],
      cross: "Melonade × Sundae Driver",
    },
    sensoryFamily: "tropical-fruit",
    phenotypeNotes: ["Limonene/myrcene-dominant with linalool and ocimene support", "Bright citrus-melon engine over creamy Sundae Driver depth"],
    curatorNote:
      "A bright collision of watermelon rind and lemon zest rolling over creamy grape dessert. Peppery, faintly toasted depth keeps it from reading as candy. It lifts fast and euphoric, made for daytime momentum.",
    tagline: "Melon citrus creamy lift",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Purple Gorilla",
    breeder: "Revert Cannabis",
    sensoryFamily: "purple-berry",
    phenotypeNotes: ["Purple-leaning cross tied to Gorilla family genetics; pedigree debated", "Milky-trichome dense buds with grape-candy nose"],
    curatorNote:
      "Glistening purple-tinged buds breathe out sweet berry and grape candy over damp earth. The smoke is sugary and smooth with a faint herbal twist. It opens cerebral and uplifting before melting into a full-bodied calm.",
    tagline: "Sweet purple berry candy",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Presidential Kush",
    marketNames: ["Presidential OG"],
    breeder: "Revert Cannabis",
    lineage: {
      parents: ["OG Kush", "Bubble Gum"],
      cross: "OG Kush × Bubble Gum",
    },
    sensoryFamily: "kush-classic",
    phenotypeNotes: ["Presidential OG / OG Kush phenotype with sedative, full-bodied character"],
    curatorNote:
      "Old-school Kush authority: fresh pine and earthy diesel laced with citrus zest. The smoke runs smooth and full, finishing on warm spice. It eases body and mind into a deep, evening sedation.",
    tagline: "Classic sedative Kush evening",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Super Diesel",
    breeder: "Seedmakers Seeds",
    sensoryFamily: "diesel-chem",
    phenotypeNotes: ["Sativa-dominant diesel cut; dense frosted buds with sticky resin sheen", "Exact cross not publicly documented"],
    curatorNote:
      "Crack the jar and a wave of lemon-soaked diesel floods the room, riding on dry pine and warm earth. The high arrives almost instantly, all clarity and forward motion, sparking focus that runs for hours. A daytime workhorse for the fuel-chasers.",
    tagline: "Fuel-bright daytime sativa rush",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Super Yuzu",
    marketNames: ["Super Yuzu Sour"],
    breeder: "Curio Wellness",
    lineage: {
      parents: ["Sour Tangie", "EZBake AF"],
      cross: "Sour Tangie × EZBake AF",
    },
    sensoryFamily: "citrus-haze",
    phenotypeNotes: ["Named for yuzu citrus; limonene-forward profile"],
    curatorNote:
      "Pure yuzu in a jar: tart lemon and grapefruit laced with sharp orange and a candied sweetness. The citrus blast leads into an easy, smiling calm that loosens the body without pinning it down. A bright, mouth-watering treat for citrus heads.",
    tagline: "Tart yuzu citrus calm",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Black Widow",
    ...
    sensoryFamily: "skunk-funk",
    phenotypeNotes: ["Shantibaba's High Times Cannabis Cup 1995 classic; legendary resin production", "Brazilian sativa drives the cerebral lift; South Indian indica builds the crystalline frost"],
    curatorNote:
      "A 90s Cup legend that earned its name in pure white resin. Sweet fruit and skunky earth open into a bright, talkative euphoria laced with creative spark, before the indica side settles the body. History you can taste.",
    tagline: "Resin-soaked Cup-winning classic",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Foreign Kush Mints",
    marketNames: ["Foreign Kush Mintz"],
    breeder: "Grassroots Dark Heart",
    lineage: {
      parents: ["Foreign Kush", "Kush Mints"],
      cross: "Foreign Kush × Kush Mints",
    },
    sensoryFamily: "kush-classic",
    phenotypeNotes: ["Dark Heart pheno-hunt selection in the Kush Mints family", "Kush Mints lineage traces to Animal Mints x Bubba Kush; heavy indica THC frequently testing in the low-to-mid 30s"],
    curatorNote:
      "A heavyweight Kush Mints expression that leads with cool mint and creamy dough over a deep gas-and-earth base. The pull is dense and frosted, the comedown a slow, full-body sink into the couch. Lights-out indica for the night owls.",
    tagline: "Cool mint gassy knockout",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Sour Amnesia",
    marketNames: ["Sour Amnesia Haze"],
    breeder: "HortiLab Seeds",
    lineage: {
      parents: ["Sour Diesel", "Amnesia Haze"],
      cross: "Sour Diesel × Amnesia Haze",
    },
    sensoryFamily: "citrus-haze",
    phenotypeNotes: ["Heavily sativa-leaning (roughly 85/15); terpinolene and limonene forward", "Marries Sour Diesel's fuel-citrus punch with Amnesia Haze's floral lift"],
    curatorNote:
      "Two legends collide: Sour Diesel's lemony fuel laced through Amnesia Haze's floral, soaring brightness. The onset is fast and electric, a clear-headed euphoria that keeps you talking and creating for hours. A connoisseur's daytime haze.",
    tagline: "Electric citrus-fuel haze lift",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Zen Crusher",
    breeder: "Binske",
    lineage: {
      parents: ["Krylon", "Tahoe OG"],
      cross: "Krylon × Tahoe OG",
    },
    sensoryFamily: "tropical-fruit",
    phenotypeNotes: ["Well-balanced hybrid built on a Tahoe OG backbone", "Caryophyllene, limonene and linalool lead; cherry-citrus nose"],
    curatorNote:
      "Sweet-and-sour cherries meet zesty citrus in a fast-hitting, balanced hybrid. The lift is immediate and bright, melting into a warm euphoria and easy calm. A fruity crowd-pleaser that crushes stress without crushing the day.",
    tagline: "Sour cherry citrus euphoria",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Chrome Berry",
    breeder: "Binske",
    lineage: {
      parents: ["Cherry Pie", "DJ Short Blueberry"],
      cross: "Cherry Pie × DJ Short Blueberry",
    },
    sensoryFamily: "purple-berry",
    phenotypeNotes: ["Binske proprietary genetics; berry-and-gas dessert profile"],
    curatorNote:
      "Glittering chrome-like frost over berry-sweet flower with a kushy gas undertone and a zest of lemon. The effect lands warm and uplifting before easing into a mellow, contented calm. A glossy dessert hybrid built to relax and glow.",
    tagline: "Frosty berry kush gas",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Lemonberry Parfait",
    breeder: "Binske",
    lineage: {
      parents: ["Lemonnade", "Parfait"],
      cross: "Lemonnade × Parfait",
    },
    sensoryFamily: "candy-exotic",
    phenotypeNotes: ["Binske proprietary genetics; cross of Lemonnade and Parfait"],
    curatorNote:
      "Crack the jar and a wave of candied lemon zest meets sun-warmed berries. The palate softens into a creamy, layered sweetness that lingers like the last spoonful of dessert. Balanced and bright, it lifts the mind before easing the body.",
    tagline: "Citrus-berry dessert in bloom",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Bubba's Girl",
    breeder: "CAM",
    lineage: {
      parents: ["'98 Bubba Kush", "Girl Scout Cookies"],
      cross: "'98 Bubba Kush × Girl Scout Cookies",
    },
    sensoryFamily: "kush-classic",
    phenotypeNotes: ["Indica-leaning hybrid; frosty conical nugs with long orange hairs and heavy trichome coating"],
    curatorNote:
      "This is heritage Kush dressed in cookie sweetness, all spicy earth and dank florals. The high creeps in slow, settling warm pressure across the body until tension simply dissolves. A classic indica embrace for the end of the day.",
    tagline: "Spicy Kush, cookie heart",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Burnout Cookies",
    breeder: "LivWell",
    lineage: {
      parents: ["Chem D", "Headband", "Mandarin Cookies", "California Black Rose"],
      cross: "(Chem D × Headband) × (Mandarin Cookies × California Black Rose)",
    },
    sensoryFamily: "diesel-chem",
    phenotypeNotes: ["Sativa-dominant hybrid; high-THC batches with skunky rubbery undertones"],
    curatorNote:
      "Pungent diesel and skunk announce themselves the moment the bag opens. Behind the fuel sits earthy pine and a whisper of cookie dough sweetness. Energizing and bright, it sparks creativity and conversation alike.",
    tagline: "Diesel-fueled cookie energy",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Cookie Kush",
    marketNames: ["Cookies Kush"],
    breeder: "Barney's Farm",
    lineage: {
      parents: ["Girl Scout Cookies", "OG Kush"],
      cross: "Girl Scout Cookies × OG Kush",
    },
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Indica-dominant hybrid; 1st place Best Coffeeshop Strain, 2014 High Times Amsterdam Cannabis Cup"],
    curatorNote:
      "Warm cinnamon and baked cookie dough lead, grounded by OG's gassy, earthy backbone. The smoke is rich and dessert-like with a lingering nutty finish. Deeply relaxing with a euphoric, smiling onset.",
    tagline: "Baked cookie meets gassy OG",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Hawaiian Haze",
    breeder: "Revert Cannabis",
    lineage: {
      parents: ["Hawaiian", "Haze"],
      cross: "Hawaiian × Haze",
    ...
    sensoryFamily: "tropical-fruit",
    phenotypeNotes: ["Sativa; landrace Hawaiian crossed with classic Haze lineage"],
    curatorNote:
      "A tropical postcard in flower form: ripe pineapple and mango wrapped in floral citrus. The high soars clear and bright, sparking creativity and easy sociability. Pure daytime sunshine for the senses.",
    tagline: "Tropical island daydream",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Purple Mandarin Punch",
    marketNames: ["Purple Mandarin Punch #1"],
    breeder: "Matter",
    lineage: {
      parents: ["Purple Punch", "Mandarin Sunset"],
      cross: "Purple Punch × Mandarin Sunset",
    },
    sensoryFamily: "purple-berry",
    phenotypeNotes: ["Indica-dominant; the '#1' designates a pheno selection", "Purple Punch parent lends grape-vanilla color; Mandarin line brings tangerine terpenes"],
    curatorNote:
      "Sweet grape soda collides with juicy mandarin peel for an irresistibly candied nose. The first pull is bright and euphoric before the indica weight settles softly over the body. A flavorful nightcap that rewards a slow burn.",
    tagline: "Grape candy, mandarin zest",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
  ...
  },
  {
    ...
    breeder: "Find",
    lineage: {
      parents: ["GMO", "Blueberry Muffins"],
      cross: "GMO × Blueberry Muffins",
    },
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Dessert-diesel hybrid expression"],
    curatorNote:
  ...
  },
  {
    ...
    lineage: {
      parents: ["Roadkill Skunk", "Deep Chunk"],
      cross: "Roadkill Skunk × Deep Chunk",
    },
    sensoryFamily: "skunk-funk",
    phenotypeNotes: ["Heritage skunk preservation project leaning indica-dominant with very high THC potential"],
    curatorNote:
      "Open the jar and old-school roadkill skunk barrels out, lacquered in spice and damp forest floor. The smoke is heavy, herbal, almost chewy. It settles in like a slow highway sunset.",
    tagline: "Old-school skunk highway funk",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Baby Yoda",
    marketNames: ["Grogu"],
    breeder: "Compound Genetics",
    lineage: {
      parents: ["The Menthol", "Khalifa Kush"],
      cross: "The Menthol × Khalifa Kush",
    },
    sensoryFamily: "gas-og",
    phenotypeNotes: ["Bright green calyxes with orange pistils and a heavy trichome blanket; high-THC modern OG/menthol hybrid"],
    curatorNote:
      "First a bright spritz of lemon candy, then a clean menthol wash that cools the palate. The finish hums with kushy gas and lifts the head before settling shoulders. Small, mighty, frosty.",
    tagline: "Lemon candy, menthol kick",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Beautiful Mintz",
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Sits inside the Mintz/Kush Mints dessert family by aroma profile"],
    curatorNote:
      "Cool mint and sweet cookie cream lead the nose, like a chocolate-mint cookie just unwrapped. Smoke is rounded, creamy, almost dessert-like. The body softens; the mood lifts.",
    tagline: "Creamy cookie mint dessert",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Dark Secret",
    sensoryFamily: "purple-berry",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Dark-leaning purple phenotype with gassy berry character"],
    curatorNote:
      "There's a hush to this one — purple grape and damp soil under a low hum of fuel. The smoke is dense and a touch sweet, then the room gets warm and the eyelids get heavy. A late-night strain.",
    tagline: "Purple grape, midnight gas",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "El Padrino",
    marketNames: ["Godfather OG"],
    breeder: "California Herbal Remedies",
    lineage: {
      parents: ["XXX OG", "Alpha OG"],
      cross: "XXX OG × Alpha OG",
    },
    sensoryFamily: "kush-classic",
    phenotypeNotes: ["High-THC OG kush phenotype, 2013 LA Cannabis Cup Best Indica winner under the Godfather OG name"],
    curatorNote:
      "Kushy pine and warm black-pepper spice open the nose, with a quiet grape lift underneath. The smoke is dense, almost oily; the body sinks fast. Old-world OG with a heavy hand.",
    tagline: "Heavy-handed kush patriarch",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Gold Dust",
    marketNames: ["Goldust"],
    breeder: "Exotic Genetix",
    lineage: {
      parents: ["Rainbow Runtz", "Scotty 2 Hotty"],
      cross: "Rainbow Runtz × Scotty 2 Hotty",
    },
    sensoryFamily: "citrus-haze",
    phenotypeNotes: ["Sativa-leaning hybrid loaded with caryophyllene, limonene and linalool; vivid bag appeal"],
    curatorNote:
  ...
  },
  {
    ...
    breeder: "Seed Junky Genetics",
    lineage: {
      parents: ["Animal Mints Bx1 #5"],
      cross: "Animal Mints Bx1 #5 phenotype",
    },
    sensoryFamily: "gelato-exotic",
    phenotypeNotes: ["White/frost-leaning pheno; aroma sits in the cream-and-cookies exotic lane"],
    curatorNote:
      "Ghost-pale buds caked in trichomes give the name away. The nose is whipped vanilla, soft florals, a whisper of citrus zest. The smoke is silky and rounds the edges of the day.",
    tagline: "Whipped vanilla, frosted petals",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Purple Prince",
    sensoryFamily: "purple-berry",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Deep violet calyxes typical of anthocyanin-heavy purple lines"],
    curatorNote:
      "Pour this into the glass and the room turns into a velvet booth lined with crushed grapes. The body settles like a heavy curtain, eyelids next, and the last note hanging in the air is faint sugared violet.",
    tagline: "Royal grape velvet, heavy crown",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Smokey and Craig",
    sensoryFamily: "funky-exotic",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Named for the Friday-film duo; positioned as a fun, social-time exotic"],
    curatorNote:
      "Crack the jar and it is South Central in summer — pungent fruit, blacktop fuel, and a laugh that won't quit. It is a porch-step strain that rolls easy and lands silly, with the munchies arriving right on cue.",
    tagline: "Loud, fruity, friendly funny",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Uptown Ice Cream",
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Reads as an Ice Cream Cake-family selection emphasizing vanilla and cream"],
    curatorNote:
      "Imagine a dessert cart wheeled in from a midtown hotel — vanilla bean, baked cake, a whisper of berry coulis. The body sinks slow, the mind glazes over, and the night politely ends in bed.",
    tagline: "Vanilla nightcap, downtown soft",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Crookiez",
    breeder: "Battenkill Buds",
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Dessert-forward Cookies-family profile per retail descriptions"],
    curatorNote:
      "Snap a piece off the jar and it crumbles like a buttery shortbread, sugar and dough rolling out warm. The high is generous and a little mischievous, melting tension out of the shoulders without slamming the lights.",
    tagline: "Sweet dough, calm crooked smile",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Pa's Pie",
    marketNames: ["Payton Pie"],
    breeder: "Cookies",
    lineage: {
      parents: ["Gary Payton", "Georgia Pie"],
      cross: "Gary Payton × Georgia Pie",
    },
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Commonly reported alt-cross: Gary Payton x Wedding Pie", "Early-2020s dessert-forward Cookies-fam selection"],
    curatorNote:
      "First whiff is grandma's kitchen — stone-fruit cobbler cooling on the sill — then a mint draft slides in through the screen door. It lifts the mood like a sugar rush and lands soft enough to keep the conversation going.",
    tagline: "Peach cobbler with mint diesel",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "F1 Mintz",
    marketNames: ["F1 Mints"],
    lineage: {
      parents: ["Kush Mints", "F1 Durb"],
      cross: "Kush Mints × F1 Durb",
    },
    sensoryFamily: "kush-classic",
    phenotypeNotes: ["F1 Durb is a Cookies-family breeding line foundational to Gush Mints-type hybrids"],
    curatorNote:
      "Cold mint hits first, like biting a wintergreen leaf, then the kush warmth blooms underneath — diesel, dough, a little black pepper. The body softens fast and the mind clears, the kind of stone that turns evenings into quiet pleasure.",
    tagline: "Cool mint over kush fuel",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Fruit Stand",
    breeder: "Savage Genetics",
    lineage: {
      parents: ["Apples and Bananas", "Gelonade"],
      cross: "Apples and Bananas × Gelonade",
    },
    sensoryFamily: "tropical-fruit",
    phenotypeNotes: ["An alt 'Fruit Stand' exists from In House Genetics (Purple Punch x Allen Wrench)"],
    curatorNote:
      "Open the bag and a wave of summer fruit hits — Honeycrisp skin, banana candy, a squeeze of lemonade. The high is bright and bouncy, the kind that sends you outside grinning before settling into easy, warm body relief.",
    tagline: "Whole orchard in one inhale",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Dead Ass",
    breeder: "Masonic Smoker",
    lineage: {
      parents: ["East Coast Sour Diesel", "Wilson"],
      cross: "ECSD × Wilson",
    },
    sensoryFamily: "diesel-chem",
    phenotypeNotes: ["Myrcene-dominant per Leafly reports", "Balanced 50/50 hybrid expression"],
    curatorNote:
  ...
  {
    canonicalName: "Don Lemon",
    breeder: "Solfire Gardens",
    lineage: {
      parents: ["Lemon Tree", "The Don Mega"],
      cross: "Lemon Tree × The Don Mega",
    },
    sensoryFamily: "citrus-haze",
    phenotypeNotes: ["Citrus dominance inherited from Lemon Tree paired with GMO-driven funk from Don Mega"],
    curatorNote:
      "A wedge of fresh-cut lemon laid across a leaking diesel rag. Bright herbaceous top notes give way to a savory, almost garlicky funk that lingers on the palate. Balanced enough for daylight, weighted enough for the couch.",
    tagline: "Lemon rind meets greasy funk",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Eucalypto",
    breeder: "Solfire Gardens",
    lineage: {
      parents: ["White Truffle", "Bitties"],
      cross: "White Truffle × Bitties",
    },
    sensoryFamily: "purple-berry",
    phenotypeNotes: ["Aggressive stretcher; flashes deep purple under cool nights; 55-65 day flower"],
    curatorNote:
      "Cracking the jar releases a wave of cool eucalyptus-leaf vapor before the grape jam underneath shows itself. The smoke carries a peppery pine bite and finishes with that signature mentholated chill. Drifts toward the pillow.",
    tagline: "Menthol breeze over grape jam",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Strain Gretzky",
    marketNames: ["Gretzky"],
    sensoryFamily: "funky-exotic",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Likely regional dispensary-exclusive release with no catalogued genetics"],
    curatorNote:
      "A mystery jar with hockey-rink swagger. Opens loud and gassy with a sugary candied undertone, the kind of mid-palate that rewards a slow draw. The finish hangs on like a long shift on the ice.",
    tagline: "Mystery exotic, gas swagger",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Black Maple",
    marketNames: ["Black Maple #22"],
    breeder: "Bloom Seed Co.",
    lineage: {
      parents: ["Dulce de Uva", "Sherbanger"],
      cross: "Dulce de Uva × Sherbanger",
    },
    sensoryFamily: "purple-berry",
    phenotypeNotes: ["Black Maple #22 is the dominant commercial pheno", "Exceptional resin production prized for extraction", "Beta-caryophyllene dominant with limonene and myrcene support"],
    curatorNote:
      "Pour of dark grape syrup over warm maple butter, with a soft fuel curl rising off the top. The first pull is lush and sugary, the second settles into spiced earth. Cerebral lift gives way to a long, weighted body calm.",
    tagline: "Grape syrup over warm maple",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Bread & Butter",
    marketNames: ["Bread and Butter"],
    breeder: "Exotic Genetix",
    lineage: {
      parents: ["Donkey Butter", "Baker's Dozen"],
      cross: "Donkey Butter × Baker's Dozen",
    },
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["8-10 week flower indoors", "Caryophyllene/limonene/nerolidol terpene stack"],
    curatorNote:
      "Imagine a still-warm vanilla glaze with a curl of lemon peel and a quiet gas note from the kitchen out back. The smoke rolls in soft and creamy, then settles thick across the shoulders. A nightcap strain dressed in dessert clothes.",
    tagline: "Vanilla donuts dipped in diesel",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Arancio Loco",
    breeder: "6 Point Cannabis",
    sensoryFamily: "citrus-haze",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Indoor-grown NY craft release; dense resin-rich buds with strong terpene expression"],
    curatorNote:
      "Pop the jar and a fistful of fresh orange peel comes flying out. Sweet and zesty up front, with a quiet herbal hum underneath that keeps it from going one-note. Daytime energy with a clean, mood-bright finish.",
    tagline: "Bright orange, a little wild",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Krazy Maddness",
    marketNames: ["Krazy Madness"],
    breeder: "6 Point Cannabis",
    sensoryFamily: "candy-exotic",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Possible Runtz-family connection inferred from breeder's adjacent SKUs; not confirmed"],
    curatorNote:
      "Cracks open like an orange creamsicle wrapper with a faint gas hiss behind it. The pull is plush and candy-sweet, riding into a smooth, layered finish. Cerebral lift wrapped in soft body warmth.",
    tagline: "Orange creamsicle on slow gas",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Lemon Sorbet",
    marketNames: ["Lemon Sorbet #3"],
    breeder: "Gabriel Cannabis",
    lineage: {
      parents: ["Lemon OG", "Sunset Sherbet"],
      cross: "Lemon OG × Sunset Sherbet",
    },
    sensoryFamily: "gelato-exotic",
    phenotypeNotes: ["LS3 is the dominant retail pheno", "Limonene-dominant with myrcene, caryophyllene, linalool support"],
    curatorNote:
      "A bright lemon-bar nose folded into sherbet cream, with the smallest spark of fuel on the back end. The smoke is plush and confectionary, finishing with a head-rush of euphoria that settles into a tingly, slow exhale of an evening.",
    tagline: "Lemon gelato, fuel finish",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Midas Touch",
    lineage: {
      parents: ["Permanent Marker", "Apples and Bananas"],
      cross: "Permanent Marker × Apples and Bananas (rumored)",
    },
    sensoryFamily: "funky-exotic",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Gold-themed exotic associated with the Doja Pak / Compound circle"],
    curatorNote:
      "Opening the jar is like cracking a foil-wrapped truffle: ripe orchard fruit melts into kerosene shimmer. The smoke is plush and candied, lingering with a glossy floral sweetness. A trophy-shelf exotic that wears its hype loudly.",
    tagline: "Gilded gas, candied bloom",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Sherb Cake",
    breeder: "Seed Junky Genetics",
    lineage: {
      parents: ["Sunset Sherbet", "Wedding Cake"],
      cross: "Sunset Sherbet × Wedding Cake",
    },
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Indica-leaning dessert hybrid testing 22-28% THC", "Limonene/linalool/caryophyllene-forward terpene stack"],
    curatorNote:
      "First inhale lands like sherbet over a slice of frosted cake — bright citrus skin folded into vanilla cream. As the exhale settles, a soft mint coolness drifts in, sealed with a peppery floral hum. The body sinks slowly, the mind floats.",
    tagline: "Citrus cream over vanilla bake",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Wedding Mintz",
    marketNames: ["Wedding Mints"],
    breeder: "Seed Junky Genetics",
    lineage: {
      parents: ["Wedding Cake", "Kush Mints"],
      cross: "Wedding Cake × Kush Mints",
    },
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Jungle Boys popularized the cut in retail flower", "Limonene/caryophyllene-dominant, often 24-28% THC"],
    curatorNote:
      "The nose is wedding-day frosting laced with a cool mint sprig — sweet and indulgent before a peppery kush base anchors it. Smoke is creamy and rolling, with mint racing across the tongue on exhale. Settles into a velvet body calm that quietly pulls you under.",
    tagline: "Mint-frosted kush opulence",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Pow-Yao",
    breeder: "Jungle Boys",
    sensoryFamily: "funky-exotic",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Listed within Jungle Boys' rotating exotic library"],
    curatorNote:
      "It struts in fruit-forward and loud, with candied sweetness laced over a quiet gas hum. The smoke rolls creamy and rounded, finishing with a flash of citrus pepper. A snappy euphoria gives way to easy-shouldered calm.",
    tagline: "Loud candy, quiet gas",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Platinum Life Breath",
    breeder: "Microbe Bros",
    lineage: {
      parents: ["Platinum Kush Breath Remix", "Lifehack"],
      cross: "Platinum Kush Breath Remix × Lifehack",
    },
    sensoryFamily: "gelato-exotic",
    phenotypeNotes: ["Caryophyllene/limonene-led terpene profile", "OGKB and Mendo Breath ancestry through the Platinum Kush Breath line"],
    curatorNote:
      "The jar breathes out syrupy vanilla and warm dough, then a slick of platinum gas cuts through. On the palate it turns chem-forward and earthy, dusted with cracked pepper. Relaxation rolls in with a creative edge still flickering above the surface.",
    tagline: "Syrupy gas, peppered calm",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Blue Nerds",
    marketNames: ["Blue Nerdz"],
    breeder: "Global Genetics LA",
    lineage: {
      parents: ["Runtz", "Zkittlez"],
      cross: "Runtz × Zkittlez",
    },
    sensoryFamily: "candy-exotic",
    phenotypeNotes: ["Widely circulated under Wizard Trees-adjacent exotic drops", "Myrcene/pinene/limonene dominant"],
    curatorNote:
      "It pops from the jar like a torn pack of blue candy — sugared berries and a flash of citrus zest. The smoke is plush and fruit-syrup sweet, with a faint tropical curl underneath. Lift is bright and social before easing into a soft-bodied glow.",
    tagline: "Blue candy, ripe berry rush",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Sub Zero",
    breeder: "GrowMoreFire Genetics",
    lineage: {
      parents: ["Super Boof", "Oreoz"],
      cross: "Super Boof × Oreoz",
    },
    sensoryFamily: "gas-og",
    phenotypeNotes: ["Trichome-saturated, often blocky deep-purple buds", "Tests 22%+ THC; circulated through boutique exotic channels"],
    curatorNote:
      "The bag opens cold and loud — diesel, creamsicle, and a wisp of dark cocoa. Smoke coats the tongue with creamy citrus before a thick gas finish settles in. A high-definition euphoria slides into a slow, heavy body wind-down.",
    tagline: "Frozen gas, creamsicle finish",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Brain Wash",
    breeder: "Alien Labs",
    lineage: {
      parents: ["OZ Kush", "Zkittlez"],
      cross: "OZ Kush × Z #18",
    },
    sensoryFamily: "citrus-haze",
    phenotypeNotes: ["Collaboration release with Talking Terps", "Limonene/caryophyllene/myrcene-forward profile"],
    curatorNote:
      "First whiff is a cold splash of lemon-lime peel chased by a torn mint leaf. The smoke turns spicy and softly buttery before settling earthy and tangy on exhale. A clean head-rush opens up, then a warm easy calm slips in behind it.",
    tagline: "Citrus-mint mind rinse",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Permanent Shade",
    breeder: "Alien Labs",
    lineage: {
      parents: ["Permanent Marker", "Nightshade"],
      cross: "Permanent Marker × Nightshade",
    },
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Dark green to deep-purple tree-shaped colas glazed in trichomes", "Terp totals reported 2.7-3.1%"],
    curatorNote:
      "First whiff is permanent-marker ink dipped in vanilla frosting, then a slow exhale of cool nightshade berry. The body folds inward as a velvet hush settles over the shoulders. A connoisseur nightcap with a fashion-forward purple swagger.",
    tagline: "Inked velvet, lights-out indica",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    ...
    lineage: {
      parents: ["Zkittlez", "Kush Mints"],
      cross: "Zkittlez × Kush Mints",
    },
    sensoryFamily: "gelato-exotic",
    phenotypeNotes: ["Dominant terpenes: D-limonene, beta-caryophyllene, linalool", "Alien Labs release"],
    curatorNote:
      "Crack the jar and a UFO of grapefruit, apricot and chilled spearmint hovers out. The palate swings between Zkittlez candy and a Kush Mints gasoline kiss. Lift-off is bright; landing is plush and grinning.",
    tagline: "Candy fruit, alien gas chill",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Banaffy Taffy",
    marketNames: ["Banana Taffy"],
    breeder: "Team Elite Genetics",
    lineage: {
      parents: ["Watermelon Zkittlez", "Banana"],
      cross: "Watermelon Zkittlez × Banana",
    },
    sensoryFamily: "candy-exotic",
    phenotypeNotes: ["Flavor-first cluster; some cuts trace to Banana OG x Sour Taffy"],
    curatorNote:
      "The first inhale is a Laffy Taffy wrapper torn open in a tropical fruit stand. Mid-palate the banana goes full Foster's, browned and buttery. Comedown is giggly munchies on a beach chair.",
    tagline: "Banana candy beach taffy",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    ...
    breeder: "Backpack Boyz",
    sensoryFamily: "gelato-exotic",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Falls within Backpack Boyz's gelato/cookies-leaning exotic catalog"],
    curatorNote:
      "BOOV opens like a fistful of mixed berry gummies dropped into a pump-jockey's glove. The middle goes creamy and round, almost sherbet. Effect is bright-eyed and chatty before a warm seat-belt of calm.",
    tagline: "Loud fruit gas exotic",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Chili Azul",
    marketNames: ["Chile Azul"],
    breeder: "Made Men Genetics",
    lineage: {
      parents: ["Chili Verde", "Blue Cookies"],
      cross: "Chili Verde × Blue Cookies",
    },
    sensoryFamily: "pine-spice",
    phenotypeNotes: ["Beta-caryophyllene-forward profile drives the pepper-chili bite", "Indica-leaning with dense colas and purple flashes"],
    curatorNote:
      "First crack of the jar is a Hatch chile roaster on a high-desert morning. The cookie sweetness lays underneath like a warm tortilla. Body sinks slowly, like sun setting over an adobe wall.",
    tagline: "Roasted chile, blue cookie calm",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Garlic Crusher",
    breeder: "3rd Coast Genetics",
    lineage: {
      parents: ["GMO", "Pure Michigan"],
      cross: "GMO × Pure Michigan",
    },
    sensoryFamily: "garlic-funk",
    phenotypeNotes: ["Lime to deep-forest hues under a frosty white jacket", "Beta-caryophyllene leads with limonene and myrcene; ~20-25% THC"],
    curatorNote:
  ...
  {
    canonicalName: "John Truffolta",
    breeder: "Blockhead Buds",
    lineage: {
      parents: ["Truffaloha", "Blueberry Sugar"],
      cross: "Truffaloha S1 × Blueberry Sugar",
    },
    sensoryFamily: "tropical-fruit",
    phenotypeNotes: ["Tested 31-33% THC; heavy resin production"],
    curatorNote:
      "Open the bag and pineapple, blueberry pancakes and a wisp of pump-jockey gas come dancing out. The exhale is cocoa-truffle smooth, slick as a white suit on a disco floor. Buzz struts in giggly, then settles into a warm, hip-swaying calm.",
    tagline: "Tropical truffle disco swagger",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Lituya Bay",
    breeder: "Mainely Genetics",
    lineage: {
      parents: ["Animal Tsunami", "Platinum Cherry Gelato"],
      cross: "Animal Tsunami × Platinum Cherry Gelato",
    },
    sensoryFamily: "tropical-fruit",
    phenotypeNotes: ["Myrcene-led with strong limonene and caryophyllene support", "Alpine Agronomy cut documents the parentage"],
    curatorNote:
  ...
  {
    canonicalName: "Permanent Chimera",
    breeder: "Seed Junky Genetics",
    lineage: {
      parents: ["Permanent Marker", "Chimera"],
      cross: "Permanent Marker × Chimera #2",
    },
    sensoryFamily: "funky-exotic",
    phenotypeNotes: ["Permanent Marker = (Biscotti x Jealousy) x Sherb B", "Chimera #2 = White Truffle x The Creature", "Slightly indica-leaning (~60/40) with cerebral lift"],
    curatorNote:
      "Crack the jar and you get sharpie ink wrapped around black cherry and jet fuel. The smoke is creamy at first, then turns into a creative buzz that hums behind the eyes before settling the shoulders.",
    tagline: "Inky fuel, dark cherry, lift",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Lemon Vuitton",
    marketNames: ["Lemon Vuiton"],
    breeder: "Swamp Boys Seeds",
    lineage: {
      parents: ["Lemon Tree", "Leopard Head Kush"],
      cross: "Lemon Tree × Leopard Head Kush",
    },
    sensoryFamily: "citrus-haze",
    phenotypeNotes: ["Limonene-dominant with caryophyllene/myrcene support", "Greasy resin production; total terpenes can exceed 5%"],
    curatorNote:
      "Lemon Pledge and gasoline in a designer bottle — bright, almost squeaky citrus with a slick OG body. The high is clear and motivated, perfect for daytime errands that you actually want to do.",
    tagline: "Designer lemon, fuel finish",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Rainbow Chips",
    marketNames: ["Rainbow Chip"],
    breeder: "Exotic Genetix",
    lineage: {
      parents: ["Sunset Sherbert", "Mint Chocolate Chip"],
      cross: "Sunset Sherbert × Mint Chocolate Chip",
    },
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Balanced 50/50 hybrid", "Limonene/myrcene/caryophyllene/pinene blend"],
    curatorNote:
      "It smells like the bottom of a Halloween bag — sour fruit candy laced with cool chocolate mint. The smoke is creamy and slightly piney, and the high tilts giggly before easing into a warm body buzz.",
    tagline: "Candy mint, creamy lift",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Beach Day",
    sensoryFamily: "tropical-fruit",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Marketed as a daytime tropical exotic"],
    curatorNote:
      "Picture salt air, sliced pineapple, and a squeeze of lime over coconut cream. The high is light and chatty, the kind that makes a flat afternoon feel like a vacation postcard.",
    tagline: "Pineapple, lime, sunshine",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Bonfire",
    sensoryFamily: "gas-og",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Market-adjacent Bonfire OG = The White x (Chemdog D x Sour Diesel IBL)"],
    curatorNote:
      "It smokes like a campfire jar — pine sap, blackened cedar, and a curl of diesel smoke. The body softens fast, head settles soon after, and the room goes quiet in the good way.",
    tagline: "Cedar smoke, diesel embers",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Pool Party",
    sensoryFamily: "candy-exotic",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Positioned alongside Lemonnade-style daytime fruity hybrids"],
    curatorNote:
      "Like cracking open a can of fruit punch in the sun — citrus zest, ripe berry, a swirl of pool-float coconut. The high is buoyant and social, more cannonball than couch.",
    tagline: "Fruit punch, sunny lift",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
  ...
  {
    canonicalName: "Afternoon Delight #4",
    marketNames: ["AD #4"],
    lineage: {
      parents: ["GMO", "Trophy Wife"],
      cross: "GMO × Trophy Wife",
    },
    sensoryFamily: "garlic-funk",
    phenotypeNotes: ["#4 pheno selected for heavy gas and resin", "Garlic-and-diesel forward GMO expression"],
    curatorNote:
      "This is a loud, savory-gas cultivar that leans on its GMO parentage for that signature garlic-and-fuel punch. The Trophy Wife influence sands the edges with a whisper of sweet cake, but make no mistake, this is a gas-first experience. Expect a euphoric head rush that melts into a hungry, relaxed glow.",
    tagline: "Garlic gas with cake",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Ameretto Di Limon",
    marketNames: ["Amaretto Di Limon", "ADL"],
    breeder: "Don Merfos Exotics",
    lineage: {
      parents: ["Lemon Cherry Gelato"],
      cross: "Lemon Cherry Gelato #7 phenotype",
    },
    sensoryFamily: "gelato-exotic",
    phenotypeNotes: ["Phenotype of Lemon Cherry Gelato (LCG #7)", "Purple-tinged bag appeal with fruity-fuel nose"],
    curatorNote:
      "Ameretto Di Limon is a dessert-exotic standout that reads like almond brittle dipped in lemon candy. The Gelato backbone keeps it creamy and smooth while the citrus brightness gives it a lively, mouthwatering lift. It opens with buoyant mental clarity before easing into a warm, unhurried body calm.",
    tagline: "Almond candy lemon cream",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "ATF",
    marketNames: ["Alaskan Thunder Fuck", "Matanuska Thunder Fuck"],
    lineage: {
      parents: ["Northern California Sativa", "Afghani"],
      cross: "Northern California Sativa × Afghani",
    },
    sensoryFamily: "pine-spice",
    phenotypeNotes: ["Heirloom Matanuska Valley landrace-influenced lineage", "Menthol-pine 'chilly forest' aromatic signature"],
    curatorNote:
      "ATF is an old-school sativa heavyweight that smells like a frosty pine forest with a squeeze of lemon. The high is a slow creeper that builds into bright, creative euphoria and a clean energetic lift rather than sedation. It's a daytime classic that also delivers a notable appetite kick.",
    tagline: "Frosty pine and lemon",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Black Magic",
    marketNames: ["Black Magic Kush"],
    breeder: "Andromeda Strains",
    lineage: {
      parents: ["Buckeye Purple", "Cherry Sauce"],
      cross: "Buckeye Purple × Cherry Sauce",
    },
    sensoryFamily: "purple-berry",
    phenotypeNotes: ["Multiple breeders use the name; purple Cookies-leaning cuts most common"],
    curatorNote:
      "Black Magic is a shadowy, dessert-forward hybrid with a nose of dark berries, cocoa, and earthy spice. Purple-leaning cuts push blackberry jam while Cookie phenos add a cool mint lift. It tends to open with gentle mental uplift before settling into deep, easy physical relaxation.",
    tagline: "Dark berry cocoa spice",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Blue Magic",
    sensoryFamily: "purple-berry",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Umbrella name; Blueberry x Haze-leaning hypothesis most consistent"],
    curatorNote:
      "Blue Magic is an umbrella name for berry-driven, sativa-leaning chemotypes rather than one fixed pedigree. Expect blueberry preserves and sugared citrus up front with a peppery-pine edge underneath. The effect keeps you alert, motivated, and mentally sharp without weighing the body down.",
    tagline: "Berry buzz cerebral lift",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Blue Ribbon",
    sensoryFamily: "diesel-chem",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Name shared across breeders; Chem-91-adjacent cuts most cited"],
    curatorNote:
      "Blue Ribbon circulates as a Chem-leaning name with no single verified pedigree across the market. The most-cited cuts deliver a pure Chem experience with loud, fuel-forward terpenes and a thick frost of trichomes. Effects run relaxed and euphoric, balanced enough for broad daytime or evening use.",
    tagline: "Loud Chem fuel frost",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Blue Zlushie",
    marketNames: ["Blue Slushie", "Blueberry Zlushie"],
    breeder: "Raw Genetics",
    lineage: {
      parents: ["Blue Cookies", "Georgia Pie"],
      cross: "Blue Cookies × Georgia Pie",
    },
    sensoryFamily: "candy-exotic",
    phenotypeNotes: ["Boutique profile with phenotype variation under the name", "Mixed-berry 'slushy' nose with citrus-soda lift"],
    curatorNote:
      "Blue Zlushie is a candy-forward exotic that nails the frozen blue-slushie fantasy with mixed berries, citrus soda, and a sugary finish. A subtle peppery spice interacts with the fruit esters for a 'blueberry muffin in a candy shop' effect. It runs euphoric and creatively uplifting with a soothing relaxation that stops short of couch-lock.",
    tagline: "Frozen blue berry candy",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Brownie Scout",
    lineage: {
      parents: ["Platinum Girl Scout Cookies", "Kosher Kush"],
      cross: "Platinum GSC × Kosher Kush",
    },
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Cookies-lineage dessert-and-gas profile", "Sources differ on second parent (Kosher Kush vs Stardawg)"],
    curatorNote:
      "Brownie Scout is a decadent Cookies-family indica that leans into cocoa, brown sugar, and cookie dough with a gassy diesel kick. The high opens with happy, uplifting euphoria true to its Cookies roots before sinking into a sedating, full-body heaviness. It's a nighttime cultivar best saved for when you have nowhere to be.",
    tagline: "Chocolate cookie gas knockout",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Candy Blitz",
    breeder: "Cookies",
    lineage: {
      parents: ["Candy Rain", "Zkittlez"],
      cross: "Candy Rain × Zkittlez",
    },
    sensoryFamily: "candy-exotic",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Listed parentage attributed to Cookies but not officially published"],
    curatorNote:
      "Candy Blitz reads like a fistful of fruit gummies dusted with light fuel. The sweetness leads and the gas trails behind, giving an upbeat, social euphoria that mellows into easy relaxation. Best for daytime sessions where mood matters more than couch time.",
    tagline: "Fruit gummies meet light gas",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Candy Cartel",
    lineage: {
      parents: ["Sherb Cream Pie", "Biscotti"],
      cross: "Sherb Cream Pie × Biscotti",
    },
    sensoryFamily: "purple-berry",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Gelato/Zkittlez-adjacent with grape and cherry contributions"],
    curatorNote:
      "Candy Cartel trades bright citrus candy for syrupy grape and cordial-cherry darkness. The nose is saturated and confectionary, while the high lands fast with euphoria before settling into a warm, dreamy body calm. A nighttime-leaning candy strain with real depth.",
    tagline: "Dark grape candy depth",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Candy Fumes",
    marketNames: ["Candy Fumez"],
    breeder: "Bloom Seed Co",
    lineage: {
      parents: ["Zkittlez", "Sherbanger"],
      cross: "Zkittlez × Sherbanger",
    },
    sensoryFamily: "candy-exotic",
    phenotypeNotes: ["Zkittlez parent supplies rainbow-candy berry and tropical lift", "Sherbanger parent adds the funky diesel and bud density"],
    curatorNote:
      "Candy Fumes is the most overtly gassy of the candy set, pairing sugary berry sweetness with a pungent fuel exhale. Despite the indica lean, users often report a clarifying, task-friendly focus before the body relaxation creeps in. A loud, sticky strain for those who want candy with a kick of funk.",
    tagline: "Candy shop versus gas station",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Candy Funk",
    breeder: "Doja Exclusive x Backpack Boyz",
    lineage: {
      parents: ["LCG", "Zkittlez x Guava BX1"],
      cross: "LCG × (Zkittlez × Guava BX1)",
    },
    sensoryFamily: "skunk-funk",
    phenotypeNotes: ["Name denotes a candy-funk phenotype rather than a single registered cultivar"],
    curatorNote:
      "Candy Funk leans harder into the funk than the candy, layering sweet fruit over earthy, skunky depth. The high starts cerebral and creative before easing into a relaxed body buzz that can creep. Treat this as a phenotype style rather than a fixed pedigree.",
    tagline: "Sweet candy, deep funk",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Cherries 888",
    marketNames: ["888 Cherries"],
    breeder: "Crop King Seeds",
    lineage: {
      parents: [],
      cross: "Unknown cherry cross",
    },
    sensoryFamily: "purple-berry",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Documented as a balanced hybrid from an undisclosed cherry cross"],
    curatorNote:
      "Cherries 888 opens with a burst of tart cherry and berry that resolves into soft vanilla and resinous pine. Effects begin clear and uplifting, sharpening mood and creativity before a gradual, gentle body relaxation. One of the more potent and well-balanced picks in this lineup.",
    tagline: "Tart cherry, vanilla finish",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Cherry Paloma",
    breeder: "Raw Genetics",
    lineage: {
      parents: ["Tropicana Cherries", "Georgia Pie"],
      cross: "Tropicana Cherries × Georgia Pie",
    },
    sensoryFamily: "tropical-fruit",
    phenotypeNotes: ["Displays magenta and royal purple hues as early as flowering week four", "Limonene-, linalool-, and caryophyllene-dominant terpene profile"],
    curatorNote:
      "Cherry Paloma is the brightest, most citrus-forward cherry profile here, balancing sweet fruit against a clean gas edge. The high is uplifting and creative with a tingly body buzz that relaxes without sedation, making it a strong social and daytime choice. Terpene-rich Raw Genetics pheno-hunting shows in the saturated nose.",
    tagline: "Bright cherry citrus lift",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Cherry Swirl",
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Name used across multiple dessert-style cherry cuts with no single registered pedigree"],
    curatorNote:
      "Cherry Swirl is the creamiest of the cherry profiles, pairing tart cherry candy with a smooth, soda-like sweetness. Effects tend toward clear mental focus with gentle body relaxation, suiting balanced daytime or early-evening use. Expect garden-to-garden variation given the unsettled lineage.",
    tagline: "Cherry candy, creamy swirl",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    ...
    lineage: {
      parents: ["LA Kush Cake", "Coco Milk"],
      cross: "LA Kush Cake × Coco Milk",
    },
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Documented lineage is LA Kush Cake x Coco Milk; name shared across breeders"],
    curatorNote:
      "Coconut Cream is the heaviest, most sedative profile in the set, leading with creamy vanilla milk and a gassy diesel undertone. A brief euphoric lift is quickly overtaken by deep, body-heavy relaxation that suits evening and pre-sleep use. Potent and richly dessert-like, with notable variability between cuts.",
    tagline: "Creamy vanilla, heavy sedation",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Crumble Cake",
    breeder: "3rd Coast Genetics",
    lineage: {
      parents: ["Cookies and Cream", "Secret Weapon"],
      cross: "Cookies and Cream × Secret Weapon",
    ...
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Phenotype of the Oreoz line", "Powdered-sugar trichome coat; caryophyllene-driven peppery exhale"],
    curatorNote:
      "Crumble Cake leads with creamy vanilla pastry before a clove-pepper spice keeps it from going syrupy. The body weight lands in the evening tier, ideal for tension and appetite. Expect dense, sugar-dusted buds typical of the Cake family.",
    tagline: "Vanilla pastry with pepper",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Crunch Berries",
    marketNames: ["Crunch Berry", "Captain Crunch"],
    breeder: "Exotic Genetix",
    lineage: {
      parents: ["Blueberry", "Triple OG"],
      cross: "Blueberry × Triple OG",
    },
    sensoryFamily: "purple-berry",
    phenotypeNotes: ["Cereal-and-cream nose from Blueberry mother", "OG gas from Triple OG father; indica-dominant ~70/30"],
    curatorNote:
      "Crunch Berries opens with vivid blueberry-cereal sweetness then reveals an earthy-pine OG underbelly. Fast euphoria gives way to couch-friendly relaxation without a full knockout. A standout for berry chasers who still want gas.",
    tagline: "Berry cereal meets gas",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Crypto Cherries",
    sensoryFamily: "gelato-exotic",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Cherry-forward nose over a dessert-gas base"],
    curatorNote:
      "Crypto Cherries presents a vivid cherry-soda lead layered onto a sharp gassy backbone with a doughy vanilla underside. The effect window stays head-clearing and calm when dosed moderately. Treat it as a house or regional cut that may vary by operator.",
    tagline: "Cherry soda over gas",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "D-Lish",
    marketNames: ["Doja D-Lish", "Delish"],
    lineage: {
      parents: ["Zkittlez", "Sweet Retreat"],
      cross: "The Original Z (Zkittlez) × Sweet Retreat",
    },
    sensoryFamily: "candy-exotic",
    phenotypeNotes: ["Balanced 50/50 indica-sativa expression", "Candy-fruit terps from Zkittlez parent; myrcene-limonene-caryophyllene led"],
    curatorNote:
      "D-Lish starts with a happy, euphoric cerebral lift that brightens mood and sparks creativity. It then eases into a smooth, balanced body calm without sedation. The candy-bubblegum and creamy citrus profile makes it an easy daytime-to-evening crossover.",
    tagline: "Creamy candy citrus lift",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Dante's Inferno",
    breeder: "Clearwater Genetics",
    lineage: {
      parents: ["Oreoz", "Devil Driver"],
      cross: "Oreoz × Devil Driver",
    },
    sensoryFamily: "gas-og",
    phenotypeNotes: ["Bred with Tiki Madman; indica-dominant ~70/30", "Dense chunky buds with occasional pink/purple accents"],
    curatorNote:
      "Dante's Inferno builds gradually, opening cerebral and expansive before a steady wave of physical ease takes over. The nose moves from creamy-sweet to fruity to a cracked-pepper gassy finish. A potent evening pick for those chasing a spicy-gas exhale.",
    tagline: "Sweet cream, spicy gas finish",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Dark Rainbow",
    breeder: "Archive Seed Bank",
    lineage: {
      parents: ["GMO", "Rainbow Belts F1"],
      cross: "GMO × Rainbow Belts F1",
    },
    sensoryFamily: "candy-exotic",
    phenotypeNotes: ["Dark, anthocyanin-rich bag appeal; caryophyllene-limonene-myrcene leaning"],
    curatorNote:
      "Dark Rainbow opens with fruit-candy sweetness that exhales into a faint diesel-pepper funk. The bag appeal is striking, with deep purple-to-black hues under heavy frost. Effects skew euphoric and giggly with a balanced relaxing tail.",
    tagline: "Dark candy, faint funk",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Drooler",
    lineage: {
      parents: ["Grape Pie", "Do-Si-Dos"],
      cross: "Grape Pie × Do-Si-Dos",
    },
    sensoryFamily: "gas-og",
    phenotypeNotes: ["Multiple regional cuts circulate under the name"],
    curatorNote:
      "Drooler is a boutique dessert-gas cut prized for sticky, glistening resin and a sweet grape-cream nose over fuel. Effects run relaxed and creative with an uplifting, happy edge. Because several growers release cuts under this name, expect lot-to-lot variation.",
    tagline: "Sticky sweet fuel funk",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Fed Reserve OG",
    marketNames: ["Federal Reserve OG"],
    lineage: {
      parents: ["SFV OG", "LA Kush"],
      cross: "SFV OG × LA Kush",
    },
    sensoryFamily: "gas-og",
    phenotypeNotes: ["Pungent pine, gas, and skunk terpene profile", "Nighttime, deeply relaxing OG phenotype"],
    curatorNote:
      "Fed Reserve OG is built on the bones of the SFV OG lineage, all fuel and pine with a skunky backbone. The effect is the textbook OG arc: an immediate euphoric lift that melts into heavy, sedating body relaxation. Reach for it after dark when winding down is the only agenda.",
    tagline: "Classic gas OG sedation",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Fuel Pump",
    marketNames: ["Gas Pump"],
    lineage: {
      parents: ["Venom OG", "Humboldt OG"],
      cross: "Venom OG × Humboldt OG",
    },
    sensoryFamily: "diesel-chem",
    phenotypeNotes: ["Chemmy, rubbery fuel nose with pepper and earth"],
    curatorNote:
      "Fuel Pump is pure pump-island chemistry: rubbery diesel and pepper layered over musky earth. The high opens euphoric and bright before settling into an easygoing relaxed hum. A daytime-into-evening gasser for fans of the Chem and Diesel families.",
    tagline: "High-octane diesel funk",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Garlicane",
    breeder: "In House Genetics",
    lineage: {
      parents: ["GMO", "Slurricane"],
      cross: "GMO × Slurricane",
    },
    sensoryFamily: "garlic-funk",
    phenotypeNotes: ["Pungent garlicky, musky-earth nose with spicy herbs", "Indica-dominant, evening full-body phenotype"],
    curatorNote:
      "Garlicane marries GMO's savory garlic-and-funk punch with Slurricane's resinous fruit, landing on a pungent herbal-spice profile that is unmistakably savory. Effects start with a brief cerebral lift then sink into profound, tingly full-body relaxation. This is a nightcap, not a daytime smoke.",
    tagline: "Savory garlic funk knockout",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Govt Oasis",
    marketNames: ["GovernMint Oasis", "Government Oasis"],
    breeder: "Purple City Genetics",
    lineage: {
      parents: ["GMO", "Gush Mints"],
      cross: "GMO × Gush Mints",
    },
    sensoryFamily: "funky-exotic",
    phenotypeNotes: ["Minty-herbal nose over GMO funk and diesel", "Very high THC, experienced-consumer phenotype"],
    curatorNote:
      "Govt Oasis crosses GMO's pungent funk with Gush Mints' cool, creamy sweetness for a one-of-a-kind minty-herbal-diesel profile. It hits hard and calm, easing the body into a relaxed, euphoric stillness. With THC often near 30 percent, this one is reserved for seasoned palates.",
    tagline: "Minty funk, heavy calm",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Grapelato",
    lineage: {
      parents: ["Grape Kush", "Gelato"],
      cross: "Grape Kush × Gelato",
    },
    sensoryFamily: "gelato-exotic",
    phenotypeNotes: ["Sweet, spicy grape with a sour citrus exhale", "Slow-building giggly, creative euphoria"],
    curatorNote:
      "Grapelato pairs grape-forward terpenes with a Gelato cut for a sweet, slightly sour grape-candy experience. The high builds slowly into a giggly, unfocused euphoria that sparks creativity before drifting toward relaxation. A flavorful, dessert-leaning hybrid for easy afternoons.",
    tagline: "Grape candy gelato bliss",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Hash Burger #3",
    marketNames: ["Hash Burger"],
    breeder: "Skunk House Genetics",
    lineage: {
      parents: ["Han Solo Hash Plant", "Double Burger"],
      cross: "Han Solo Hash Plant × Double Burger",
    },
    sensoryFamily: "skunk-funk",
    phenotypeNotes: ["Earthy, ammonia, onion, and umami funk profile", "Tests very high in THCa, heavily sedating phenotype"],
    curatorNote:
      "Hash Burger #3 is a stinky, savory bruiser drawing on GMO, Donny Burger, and Triangle Kush funk for an onion-and-ammonia umami blast. Effects are heavy and sedating, sliding quickly toward couch-lock and sleep. With THC often above 28 percent, treat this phenotype with respect and save it for night.",
    tagline: "Savory umami funk bomb",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Honeydew",
    lineage: {
      parents: ["Dirty Melon", "Peach Crescendo"],
      cross: "Dirty Melon × Peach Crescendo",
    },
    sensoryFamily: "tropical-fruit",
    phenotypeNotes: ["Sliced honeydew and cucumber nose with herbal undertone", "Sativa-dominant, bright and non-sedating phenotype"],
    curatorNote:
      "Honeydew is all refreshing melon rind and crisp cucumber over a faint herbal soil, finishing minty and clean. The effect is a bright, functional cerebral lift with light physical energy and no couch-lock. Ideal for mornings, creative work, or social daytime sessions.",
    tagline: "Crisp melon daytime lift",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Jack Snowballz",
    sensoryFamily: "haze-sativa",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Frosty, spicy-pine Haze-leaning phenotype inferred from name"],
    curatorNote:
      "Jack Snowballz reads as a frosty Jack Herer relation, pairing the family's spicy pine and citrus with a heavy resin coat hinted at by the Snowballz name. Effects skew energetic, creative, and uplifted in true Haze-sativa fashion. A daytime spark for focus and conversation, pending verified genetics.",
    tagline: "Frosty spicy-pine Jack lift",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Kami",
    marketNames: ["Kami Kush"],
    breeder: "Raw Genetics",
    lineage: {
      parents: ["Skywalker OG", "Zikigai"],
      cross: "Skywalker OG × Zikigai",
    },
    sensoryFamily: "gas-og",
    phenotypeNotes: ["Tall OG-leaning structure with spear tops", "Myrcene, limonene and caryophyllene-forward terpene profile"],
    curatorNote:
      "Kami leads with a diesel-pine handshake before sweet tropical notes round out the jar. The body is classic OG heaviness, yet the head stays euphoric and quietly creative. A relaxed-but-bright pick for unwinding without total sedation.",
    tagline: "OG depth, candy lift",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Leo Stones Tourbillion",
    marketNames: ["Tourbillon"],
    breeder: "Aficionado Seeds",
    lineage: {
      parents: ["Biscotti", "Triangle Kush", "Cherry Pie Kush", "Grateful Breath"],
      cross: "Biscotti × (Triangle Kush × Cherry Pie Kush × Grateful Breath)",
    },
    sensoryFamily: "diesel-chem",
    phenotypeNotes: ["Leans toward Triangle and Cherry Pie Kush morphology", "Roughly 8-9 week flowering window"],
    curatorNote:
      "Tourbillion is pure jet-fuel theater: lemon rind, ethanol and starter-fluid notes stacked over a Kush spine. The high reads like old-school Headband, intensely cerebral and racy. Reserve this one for experienced palates chasing loud gas.",
    tagline: "Lemon rind meets jet fuel",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Love Machine",
    marketNames: ["Cheech and Chong's Love Machine"],
    breeder: "Seed Junky Genetics",
    lineage: {
      parents: ["Pure Kush", "Wedding Crasher"],
      cross: "Pure Kush × Wedding Crasher",
    },
    sensoryFamily: "diesel-chem",
    phenotypeNotes: ["Terpinolene-forward profile", "Strain name is reused across cuts so lab numbers vary by producer"],
    curatorNote:
      "Love Machine opens sweet and diesel-driven with a soft floral edge underneath. Effects skew sativa: energetic, euphoric and conversational rather than couch-bound. A solid pick for daytime creativity and good company.",
    tagline: "Sweet diesel, social lift",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Lu Lu Lemon",
    breeder: "Fiya Farmer",
    lineage: {
      parents: ["Lemon Tree", "Cream Smoothie"],
      cross: "Lemon Tree × Cream Smoothie",
    },
    sensoryFamily: "citrus-haze",
    phenotypeNotes: ["Limonene-dominant with secondary caryophyllene and linalool", "THC commonly testing 30-34%"],
    curatorNote:
      "Lu Lu Lemon is a citrus showpiece, sharp sour lemon riding over smooth cream and a touch of vanilla. The effect is clean, focused energy built for daytime productivity and creative work. Bright, potent and unmistakably zesty.",
    tagline: "Sour lemon, creamy finish",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "MC Nuggets",
    breeder: "Ethos Genetics",
    lineage: {
      parents: ["Martian Candy OG", "Wrank"],
      cross: "Martian Candy OG × Wrank",
    },
    sensoryFamily: "gas-og",
    phenotypeNotes: ["Medium egg-shaped, spongy-dense buds with late foxtailing", "56-63 day flowering, heavy yield, 25%+ THC"],
    curatorNote:
      "MC Nuggets pairs a gassy core with a soft floral-sweet topnote that softens the fuel. The body effect is heavy and relaxing, sliding toward sleepy at the tail end. A modern indica hybrid built for evening decompression.",
    tagline: "Gassy florals, heavy body",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Melted Strawberries",
    breeder: "Bloom Seed Co",
    lineage: {
      parents: ["GMO", "Strawberry Guava"],
      cross: "GMO × Strawberry Guava",
    },
    sensoryFamily: "garlic-funk",
    phenotypeNotes: ["Hunted for glandular trichome stability, prized for extraction", "Roughly 50/50 indica-sativa, 27-31% THC"],
    curatorNote:
      "Melted Strawberries is a study in contrast: savory GMO gas up front, ripe strawberry-guava sweetness underneath. The high is balanced and euphoric with a relaxing body and a reliable appetite bump. Sticky, frosty and built for terp chasers.",
    tagline: "Savory gas, sweet berry",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Midtown Kush",
    sensoryFamily: "kush-classic",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Profile inferred from Kush-style naming convention"],
    curatorNote:
      "Midtown Kush reads as a traditional Kush: earthy, piney and faintly spicy with a grounded woody base. The effect is calm and physically heavy, easing toward sleep over time. A mellow end-of-day choice rather than a daytime driver.",
    tagline: "Earthy Kush, calm evenings",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Mike's Meringue",
    breeder: "TYSON 2.0",
    lineage: {
      parents: ["Lemon Skunk", "Cookies and Cream"],
      cross: "Lemon Skunk × Cookies and Cream",
    },
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Citrusy-doughy nose with sweet cream and Kush undertones", "Spacey, uplifting and creativity-forward"],
    curatorNote:
      "Mike's Meringue smells like lemon-kissed pastry, citrus zest over sweet cream and vanilla dough. The effect is spacey and uplifting, nudging creativity and good mood. A pleasant, dessert-forward daytime sativa for an active day off.",
    tagline: "Lemon pastry, spacey lift",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Moutai #2",
    sensoryFamily: "garlic-funk",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "#2 cut inferred to push the heavier, funkier, more savory side of the line"],
    curatorNote:
      "Moutai #2 reads as a deep, savory-gas funk with earthy and peppery layers rather than sweet candy notes. The high is rounded and sociable, lifting the mood before easing into relaxed calm. Documentation is thin, so treat the profile as a confident read on a funk-forward hybrid.",
    tagline: "Savory gas, quiet funk",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "New Yorker",
    breeder: "Wizard Trees",
    lineage: {
      parents: ["Sour Diesel", "Lemon Cherry Gelato"],
      cross: "Riri Sour Diesel × Lemon Cherry Gelato",
    },
    sensoryFamily: "diesel-chem",
    phenotypeNotes: ["Diesel-dominant phenotypes show sharper fuel; gelato-leaning cuts bring more creamy cherry sweetness"],
    curatorNote:
      "New Yorker opens with spicy diesel that gives way to bright citrus and a creamy cherry-gelato finish. It hits cerebral and fast before smoothing into a balanced body ease, equally at home daytime or evening. A modern high-THC hybrid that stays unmistakably gas-forward.",
    tagline: "Diesel meets cherry gelato",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "No Cap",
    lineage: {
      parents: ["Gelato 33", "Biscotti"],
      cross: "Gelato 33 × Biscotti",
    },
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Reported lineage varies by producer", "Cookie-and-lemon dessert expression most consistent across cuts"],
    curatorNote:
      "No Cap balances an insistently sweet lemon nose against creamy, butter-and-nut cookie depth. The effect lifts the mood first, then settles into easygoing relaxation suited to music or low-key social time. A polished dessert hybrid that earns its upper-tier reputation.",
    tagline: "Sweet lemon cookie lift",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Pearlz #6",
    marketNames: ["Pearlz"],
    breeder: "Preferred Gardens",
    lineage: {
      parents: ["Zoap", "Lazer Gun"],
      cross: "Zoap × Lazer Gun",
    },
    sensoryFamily: "candy-exotic",
    phenotypeNotes: ["#6 phenotype selected for pastel, trichome-heavy buds", "Cleanest melon-sherbet candy expression"],
    curatorNote:
      "Pearlz #6 is pure candy-Z confection, layering soapy gelato, candied peach and a floral melon zest. The high floats in soft and comfortable, easing the body toward the couch without harsh sedation. Frosty, pastel and impeccably terpy, it is built for flavor chasers.",
    tagline: "Frosty candy melon float",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Perma Frost",
    lineage: {
      parents: ["Trainwreck", "White Widow"],
      cross: "Trainwreck × White Widow",
    },
    sensoryFamily: "pine-spice",
    phenotypeNotes: ["Trichome-frosted phenotypes earn the 'frost' name", "Trainwreck-leaning cuts sharpen the pine and spice"],
    curatorNote:
      "Perma Frost is bright and woodland-fresh, with sharp pine, spicy herbs and a frosty White Widow sheen. The high runs energetic and euphoric, sparking creativity before a hungry, mellow tail-off. A classic-leaning sativa hybrid for daytime motion.",
    tagline: "Crisp pine, creative spark",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Pink Passion",
    marketNames: ["Pink Passionfruit"],
    lineage: {
      parents: ["Passion Fruit", "Pink Kush"],
      cross: "Passion Fruit × Pink Kush",
    },
    sensoryFamily: "tropical-fruit",
    phenotypeNotes: ["Sativa-dominant phenotypes (~60/40) emphasize tropical-citrus brightness over body weight"],
    curatorNote:
      "Pink Passion is all juicy tropical fruit and pink grapefruit dressed in floral sweetness. The effect is clear-headed and sociable, lifting mood, focus and creativity without heavy sedation. A vivid, fruit-forward daytime sativa hybrid.",
    tagline: "Juicy tropical daytime lift",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Project Lato",
    sensoryFamily: "gelato-exotic",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Profile inferred from the gelato dessert family"],
    curatorNote:
      "Project Lato sits squarely in gelato territory, leading with sweet cream, soft berry and vanilla over a faint earthy base. The high opens euphoric and creative before melting into balanced relaxation. Public records are scarce, so the profile is a confident read on a dessert-gelato exotic.",
    tagline: "Sweet cream gelato exotic",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Red Hotz",
    marketNames: ["Red Hots"],
    breeder: "Fiya Farmer",
    lineage: {
      parents: ["Biscotti", "Gassius Clay", "Fun Dip"],
      cross: "Biscotti × Gassius Clay × Fun Dip",
    },
    sensoryFamily: "candy-exotic",
    phenotypeNotes: ["Bold cinnamon-candy nose with spicy-orange undertones", "Gassy diesel notes dominate the aftertaste"],
    curatorNote:
      "Red Hotz reads like spicy cinnamon candy dipped in citrus, then dragged through a fuel tank. The high is energetic and creatively charged rather than sedating. Best for daytime motivation when you want flavor with a bite.",
    tagline: "Cinnamon candy with gas",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Scotties Cake",
    breeder: "Seed Junky Genetics",
    lineage: {
      parents: ["Biscotti", "Gelato 41", "Animal Mints BX1"],
      cross: "Biscotti × (Gelato 41 × Animal Mints BX1)",
    },
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Frosty, dense bag appeal from the Cookies-Cake lineage", "Creamy vanilla cake nose with a subtle gassy lift"],
    curatorNote:
      "Scotties Cake is a velvety dessert profile, all sweet cake batter and whipped vanilla cream. The Biscotti and Animal Mints backbone pushes potency well above casual territory. A relaxing, mood-lifting smoke that finishes smooth.",
    tagline: "Creamy vanilla cake batter",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Shot Caller",
    breeder: "Solfire Gardens",
    lineage: {
      parents: ["Don Mega", "Hood Candyz"],
      cross: "Don Mega × Hood Candyz",
    },
    sensoryFamily: "citrus-haze",
    phenotypeNotes: ["Zesty citrus over resinous pine with a cream-sweet undertone", "Caryophyllene-limonene-linalool dominant terpene stack"],
    curatorNote:
      "Shot Caller leads with zesty citrus and fresh resinous pine, sitting on a creamy sweet cushion. The effect is clear, social, and focused rather than couch-locking. A confident daytime pick for getting things done.",
    tagline: "Bright citrus pine focus",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Stadankohhh",
    breeder: "Cheech and Chong / Southern Sky Brands",
    sensoryFamily: "skunk-funk",
    phenotypeNotes: ["Pungent skunk-and-gas nose that carries through the package"],
    curatorNote:
      "Stadankohhh is exactly what the name promises: an unapologetically dank, skunky, gassy funk bomb. The indica-leaning effect settles the body into calm while keeping the mood lightly lifted. A loud-smelling evening strain for funk chasers.",
    tagline: "Loud skunky gas funk",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Star Boys",
    marketNames: ["Starboy"],
    breeder: "Three Flavors Farms",
    lineage: {
      parents: ["Star Killer OG", "GG4"],
      cross: "Star Killer OG × GG4",
    },
    sensoryFamily: "diesel-chem",
    phenotypeNotes: ["Intense diesel-gas nose from the Stardawg-Glue lineage"],
    curatorNote:
      "Star Boys is a fuel-forward, chem-leaning heavyweight with a dense diesel and earthy gas profile. The effect is intensely physical, leaning stony and couch-bound rather than euphoric. Reserve it for nights with nowhere to be.",
    tagline: "Heavy diesel body buzz",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Super Jack",
    marketNames: ["Super Jack Herer"],
    lineage: {
      parents: ["Super Silver Haze", "Jack Herer"],
      cross: "Super Silver Haze × Jack Herer",
    },
    sensoryFamily: "haze-sativa",
    phenotypeNotes: ["Peppered pine and citrus-zest nose with incense-like spice", "Fast cerebral onset with classic Haze sparkle"],
    curatorNote:
      "Super Jack is a textbook Haze experience, layering peppery pine and bright citrus over a skunky incense backbone. The high is fast, clear-headed, and energizing, tuned for focus and creativity. A daytime sativa for motivation and mental clarity.",
    tagline: "Classic energizing Haze sparkle",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Tear Gas",
    marketNames: ["The Tear Gas"],
    lineage: {
      parents: ["Stardawg", "Chemdawg"],
      cross: "Stardawg × Chemdawg",
    },
    sensoryFamily: "gas-og",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Heavy gassy-diesel nose with sulfurous skunk thiols"],
    curatorNote:
  ...
  },
  {
    ...
    sensoryFamily: "candy-exotic",
    phenotypeNotes: ["Compact, bushy structure with tight internodes", "Resin-drenched limonene-dominant calyxes"],
    curatorNote:
      "Tide threads cool mint through candy fruit, a Kush Mints chill laid over Zkittlez sweetness. The arc is gentle: a euphoric crest that recedes into a smooth, relaxed tide rather than a sedative crash. Best for an even, social wind-down.",
    tagline: "Minted fruit, gentle pull",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Toad",
    marketNames: ["The Toad"],
    lineage: {
      parents: ["Chemdawg", "Afghani"],
      cross: "Chemdawg × Afghani",
    },
    sensoryFamily: "diesel-chem",
    phenotypeNotes: ["Mature, layered scent over candy sweetness", "60/40 indica-leaning expression"],
    curatorNote:
      "Toad is the antidote to candy exotics: earthy, coffee-dark, and diesel-forward rather than sugary. It begins with surprising mental clarity before the Afghani backbone hauls you into deep physical weight. A connoisseur's gas strain that rewards patience.",
    tagline: "Coffee, gas, and gravity",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Triple Burger",
    marketNames: ["GMO Burger"],
    breeder: "Skunk House Genetics",
    lineage: {
      parents: ["GMO", "Double Burger"],
      cross: "GMO × Double Burger",
    },
    sensoryFamily: "garlic-funk",
    phenotypeNotes: ["Caryophyllene-dominant garlic funk", "Larry OG vigor folded into the Burger line"],
    curatorNote:
      "Triple Burger is savory cannabis at full volume: garlic, butter, and ammonia-diesel with a blue-cheese tail. There's no sweetness to hide behind, just loud GMO funk and a sedative, couch-locking body load. Reserve for experienced palates and a clear evening.",
    tagline: "Garlic-butter diesel funk bomb",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Yunicorn",
    marketNames: ["Yunacorn"],
    breeder: "GREASi Genetics",
    lineage: {
      parents: ["Lemon Cherry Gelato", "RO93"],
      cross: "Lemon Cherry Gelato × RO93",
    },
    sensoryFamily: "gelato-exotic",
    phenotypeNotes: ["Sugar-frosted calyxes with lavender undertones", "Identity treated as Yunacorn variant; spelling not independently verified"],
    curatorNote:
      "Yunicorn pairs lemon-cherry zest and vanilla cream with just enough OG gas to keep it grounded. The lift stays upbeat and conversational, sliding into body-soothing calm without true couch-lock. A polished dessert-citrus hybrid for daytime sociability.",
    tagline: "Citrus cream over gas",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Z-Gun",
    sensoryFamily: "candy-exotic",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Tags inferred from Zkittlez/gun exotic naming cues"],
    curatorNote:
      "Z-Gun reads as a Zkittlez-line candy exotic, all loud grape-berry sweetness and rainbow fruit. Expect a euphoric, creative head paired with easy body relaxation rather than sedation. Treat the genetics as inferred until a verified cross surfaces.",
    tagline: "Loud candy-fruit exotic",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Zangbanger",
    breeder: "Wizard Trees",
    lineage: {
      parents: ["Sherbanger #22", "Zangria"],
      cross: "Sherbanger #22 × Zangria",
    },
    sensoryFamily: "diesel-chem",
    phenotypeNotes: ["Octane diesel funk over saturated berry candy", "Glowing frost, dense structure"],
    curatorNote:
      "Zangbanger collides Sherbanger's octane diesel with Zangria's berry-candy brightness for a lemon-fuel nose dusted in blueberry and vanilla. The hit lands buzzy and tingly behind the eyes, then creeps into a numbing, couch-locking calm. Potent enough to respect the dose.",
    tagline: "Lemon-diesel into the couch",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Zangria",
    breeder: "Wizard Trees",
    lineage: {
      parents: ["The Original Z", "Thin Mint Cookies"],
      cross: "Thin Mint Cookies × The Original Z",
    },
    sensoryFamily: "purple-berry",
    phenotypeNotes: ["Forest-green buds laced with violet and purple hues", "Heavy resin, dense colas"],
    curatorNote:
      "Zangria pours a tropical-grape fruit cocktail over an earthy cookie base, the sangria namesake made literal. Despite indica leanings, the high stays balanced and creative before the body relaxation settles in. Striking purple bag-appeal from a marquee Wizard Trees line.",
    tagline: "Grape sangria in bloom",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Zeal",
    breeder: "Umami Seed Co",
    lineage: {
      parents: ["Zwish", "Jealousy"],
      cross: "Zwish × Jealousy",
    },
    sensoryFamily: "diesel-chem",
    phenotypeNotes: ["~31% THC powerhouse expression", "Strong odor requiring late-flower control"],
    curatorNote:
      "Zeal layers coffee-diesel and rich vanilla beneath bright orange citrus and a whisper of lavender. The potency is the headline: intense, long-lasting euphoria that melts into deep, heavy relaxation. A loud, high-test indica for seasoned consumers.",
    tagline: "Coffee-vanilla diesel powerhouse",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Zero Gravity",
    marketNames: ["Zero Grav"],
    breeder: "North Genetics",
    lineage: {
      parents: ["Holy Grail Kush", "Smurfzilla"],
      cross: "Holy Grail Kush × Smurfzilla",
    },
    sensoryFamily: "skunk-funk",
    phenotypeNotes: ["Large, dense buds with skunky-sweet undertones", "Myrcene, limonene, caryophyllene profile"],
    curatorNote:
  ...
  {
    canonicalName: "Jack Grape",
    marketNames: ["Jack's Grape"],
    lineage: {
      parents: ["Jack Herer", "Grape Ape"],
      cross: "Jack Herer × Grape Ape",
    },
    sensoryFamily: "purple-berry",
    phenotypeNotes: ["Sweet grape and berry from the Grape Ape side", "Lemony-woody lift inherited from Jack Herer"],
    curatorNote:
      "An evenly balanced hybrid marrying Jack Herer's lemony lift with Grape Ape's candied purple sweetness. Expect a sweet grape and berry palate with a citrus edge, leading into a relaxed, tranquil calm.",
    tagline: "Sweet grape meets Jack",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Terp Poison",
    sensoryFamily: "haze-sativa",
    phenotypeNotes: ["Label used by multiple craft breeders rather than one canonical clone", "Durban terpinolene sparkle anchored by caryophyllene pepper"],
    curatorNote:
      "A modern terpene-chasing name built around a Durban Poison touchpoint, selected for extraordinary aroma intensity. The core is a zesty, herbaceous Durban sparkle amplified by spice and citrus, driving an energetic, uplifting head buzz.",
    tagline: "Terpene-loud Durban energy",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Big Apple Jacks",
    sensoryFamily: "tropical-fruit",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Name evokes Apple Jack / Big Apple apple-forward lines"],
    curatorNote:
      "An apple-forward novelty name with no verifiable genetics on record, sharing a sensory lane with Apple Jack and Big Apple. Expect crisp green-apple and sweet-cereal aromatics with a cooling pine edge, and a bright, gently euphoric lift.",
    tagline: "Crisp orchard-apple novelty",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Concrete Shoes",
    marketNames: ["Cement Shoes"],
    breeder: "Cult Classics Seeds",
    lineage: {
      parents: ["Animal Cookies", "OGKB", "Wet Dream"],
      cross: "Animal Cookies × (OGKB × Wet Dream)",
    },
    sensoryFamily: "kush-classic",
    phenotypeNotes: ["Commonly sold under the name Cement Shoes", "Body-melting, couch-locking potency from the OGKB influence"],
    curatorNote:
      "A heavy indica-leaning hybrid from Cult Classics that layers Animal Cookies dough over an OGKB gas spine with a brisk lemon-kush top. The palate carries nutty citrus and a minty-berry exhale before the high collapses into sedative, couch-locking weight.",
    tagline: "Heavy gassy couch-lock kush",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Long Island Skunk",
    sensoryFamily: "skunk-funk",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Closest documented relative is Island Sweet Skunk"],
    curatorNote:
  ...
  {
    canonicalName: "Union Frost",
    sensoryFamily: "pine-spice",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "No canonical breeder or genetics found under this exact name"],
    curatorNote:
      "A frost-named hybrid with no documented genetics under this label, grouped here with resin-heavy Frost-family cultivars. Expect an earthy-sweet nose touched with pine and a relaxed, happy, mellow effect.",
    tagline: "Frosty earthy-sweet calm",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Macaroon",
    marketNames: ["French Macaron"],
    lineage: {
      parents: ["Gelato 33", "Cookies and Cream"],
      cross: "Gelato 33 × Cookies and Cream",
    },
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Sold under both Macaroon and French Macaron names", "Cream-and-nut nose with a subtle gassy back end"],
    curatorNote:
      "Macaroon reads like a patisserie counter, all toasted coconut, vanilla cream and soft nuttiness over a faint earthy gas. The high opens gently behind the eyes before melting into the limbs, making it an easy evening sipper.",
    tagline: "Toasted coconut dessert melt",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Platinum Lemon Cherry Gelato",
    marketNames: ["Platinum LCG"],
    breeder: "Backpack Boyz",
    lineage: {
      parents: ["Girl Scout Cookies", "Sunset Sherbet"],
      cross: "Girl Scout Cookies × Sunset Sherbet",
    },
    sensoryFamily: "gelato-exotic",
    phenotypeNotes: ["Platinum tag denotes a resinous, high-trichome cut rather than separate genetics", "Caryophyllene/limonene/myrcene dominant terpene stack"],
    curatorNote:
      "This is the upper-shelf cut of Lemon Cherry Gelato, leaning louder, frostier and more potent than the standard line. Expect a bright lemon-zest opening that sweetens into cherry hard candy and resolves creamy, with a balanced euphoric lift that slides into body ease.",
    tagline: "Frosty lemon cherry candy",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Biscotti Glaze",
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Reads as a Biscotti-derived glaze selection"],
    curatorNote:
      "Biscotti Glaze sits in the sweet-cookie-meets-gas lane, with a sugary, creamy nose that turns diesel-funky on the exhale. The high is a slow creeper that builds into relaxed, body-heavy euphoria, so dose patiently.",
    tagline: "Glazed cookie diesel funk",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Hotti Fuel",
    sensoryFamily: "diesel-chem",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Name signals a fuel/diesel-dominant profile"],
    curatorNote:
      "Hotti Fuel presents as a pungent, gas-and-diesel cultivar with sharp pine and a peppery edge, leaning chem rather than candy. The experience reads balanced, an alert head-high settling toward relaxed euphoria.",
    tagline: "Pungent high-octane gas",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Lemon Cherry Zolato",
    marketNames: ["Lemon Cherry Zelato"],
    lineage: {
      parents: ["Lemon Cherry Gelato", "Gelato"],
      cross: "Lemon Cherry Gelato × Gelato",
    },
    sensoryFamily: "gelato-exotic",
    phenotypeNotes: ["Zolato spelling appears alongside Zelato in market listings", "Carries the lemon-cherry-vanilla nose of the LCG line with added Gelato sweetness"],
    curatorNote:
      "Lemon Cherry Zolato keeps the signature LCG citrus-and-cherry brightness and layers in extra Gelato creaminess. A fresh grind gives lemon peel and sweet cherry over soft earth, and the effect is a tidy head lift that loosens into comfortable body calm.",
    tagline: "Lemon cherry gelato lift",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "White Devil",
    lineage: {
      parents: ["White Widow", "Haze"],
      cross: "White Widow × Haze",
    },
    sensoryFamily: "citrus-haze",
    phenotypeNotes: ["Label applied to varying genetics across regional markets", "White Widow resin with Haze-driven cerebral length"],
    curatorNote:
      "White Devil noses of pine and forest-floor earth with a spicy citrus edge and faint florals, a classic haze-adjacent profile. The high opens with a clear cerebral lift and energetic brightness before easing into smooth body relaxation.",
    tagline: "Piney haze cerebral lift",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Cherry Apples",
    marketNames: ["Cherry Apple"],
    lineage: {
      parents: ["Apple Fritter", "Tropicana Cherry"],
      cross: "Apple Fritter × Tropicana Cherry",
    },
    sensoryFamily: "tropical-fruit",
    phenotypeNotes: ["Sold as both Cherry Apples and Cherry Apple", "Juicy cherry-and-apple nose with a crisp citrus lift"],
    curatorNote:
      "Cherry Apples is a juicy, orchard-fruit hybrid, all ripe cherries and crisp apple with a bright citrus snap. The effect is a versatile, day-or-night balance: a happy cerebral uplift that softens into gentle relaxation without tipping into couch-lock.",
    tagline: "Ripe cherry crisp apple",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Lemon Cherry Pop",
    marketNames: ["Lemon Cherry Poppers"],
    lineage: {
      parents: ["Lemon Cherry Gelato"],
      cross: "Lemon Cherry Gelato selection",
    },
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Selected pheno emphasizing bright lemon top-note over candied cherry base", "Creamy confectionary undertone with limonene/caryophyllene dominance"],
    curatorNote:
      "Lemon Cherry Pop opens with a clean burst of lemon peel that gives way to maraschino-cherry candy and a soft cream base. The high arrives as a quick cerebral sparkle before melting into a tingling, unhurried body calm.",
    tagline: "Lemon zest meets cherry cream",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Sherb Cream Pie",
    breeder: "Seed Junky Genetics",
    lineage: {
      parents: ["Ice Cream Cake", "Sherb BX1"],
      cross: "Ice Cream Cake × Sherb BX1",
    },
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Co-dominant caryophyllene and limonene with minor linalool", "Soft, dough-like cream profile over a faint berry top"],
    curatorNote:
      "Sherb Cream Pie smells like a slice of vanilla berry pie fresh from the oven, soft and inviting rather than loud. It lifts the mood gently before easing the body into a warm, sleepy calm.",
    tagline: "Creamy vanilla berry nightcap",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Forbidden Kush",
    breeder: "Salve My Body Medicinals",
    lineage: {
      parents: ["King Kush Breath F", "Gods Garden M"],
      cross: "King Kush Breath F × Gods Garden M",
    },
    sensoryFamily: "kush-classic",
    phenotypeNotes: ["Profile inferred from classic kush-family aroma and indica-dominant reports"],
    curatorNote:
      "Forbidden Kush carries the deep earthy, fuel-tinged signature of the classic kush family, with woody and faintly spicy undertones. Effects lean heavily physical, settling into a sedating, body-anchoring calm.",
    tagline: "Earthy gas, heavy body",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Lemon Drop",
    sensoryFamily: "citrus-haze",
    phenotypeNotes: ["Limonene-dominant with intense lemon candy and lemongrass character", "Lineage varies by producer; Lemon Skunk is the common anchor"],
    curatorNote:
      "Lemon Drop is pure lemon-candy zest, bright and effervescent with a faint skunky sharpness underneath. The high is clear and cerebral, nudging users toward talkative, motivated, creative energy.",
    tagline: "Bright lemon candy lift",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Dante's Rainbow",
    marketNames: ["Rainbow Inferno"],
    breeder: "Rolling Green",
    lineage: {
      parents: ["Dante's Inferno", "Cadillac Rainbow"],
      cross: "Dante's Inferno × Cadillac Rainbow",
    },
    sensoryFamily: "purple-berry",
    phenotypeNotes: ["Likely a vendor label for Rainbow Sherbet x Dante's Inferno"],
    curatorNote:
      "Dante's Rainbow pairs sweet cherry-berry fruit up front with a spicy, dank backbone. The experience starts happy and lifted before deepening into a soothing, sedative body calm.",
    tagline: "Sweet berry, sedative drift",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Glitter Bomb",
    breeder: "Compound Genetics",
    lineage: {
      parents: ["Grape Gas", "OGKB Blueberry Headband"],
      cross: "Grape Gas #10 × OGKB Blueberry Headband",
    },
    sensoryFamily: "gas-og",
    phenotypeNotes: ["Glittering trichome coverage gives the strain its name", "Very high THC (27-34%)"],
    curatorNote:
      "Glitter Bomb hits the nose with ripe grape and berry wrapped in heavy fuel and a citrusy OG lift. Its very high potency delivers a happy, hungry, deeply relaxing stone best left to experienced users.",
    tagline: "Grape gas, glittering frost",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Mac Flurry",
    marketNames: ["McFlurry"],
    breeder: "Knock Out Genetics",
    lineage: {
      parents: ["MAC"],
      cross: "MAC (Miracle Alien Cookies) selection",
    },
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Caryophyllene-forward MAC backbone with limonene and linalool flashes", "Butter/vanilla dessert profile"],
    curatorNote:
      "Mac Flurry tastes like its namesake dessert, buttery vanilla and sweet pastry over the dense, frosty MAC structure. The high is uplifting and giggly before easing into a gentle, relaxed slide rather than a crash.",
    tagline: "Buttery vanilla cookie cream",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Satan's Cookies",
    breeder: "Rolling Green",
    lineage: {
      parents: ["Oreoz", "Devil Driver"],
      cross: "Oreoz × Devil Driver",
    ...
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Chunky, frosting-coated nugs over an 8-9 week flower", "Chocolate-cookie sweetness balanced by tropical citrus fuel"],
    curatorNote:
      "A decadent cookies hybrid that leads with sweet cream and chocolate before a sharp citrus-fuel lift cuts through. The high is bright and creative up top, then eases into balanced body relaxation.",
    tagline: "Sweet cream, devilish punch",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Wrank",
    marketNames: ["Wrank R2"],
    breeder: "Ethos Genetics",
    lineage: {
      parents: ["Strawberry OG Cookies", "End Game #3"],
      cross: "Strawberry OG Cookies × End Game #3",
    },
    sensoryFamily: "funky-exotic",
    phenotypeNotes: ["Myrcene, limonene and caryophyllene lead the terpene deck", "Berry-and-yogurt nose with fruity earthy undertones"],
    curatorNote:
      "Wrank reads like a strawberry-yogurt parfait with a citrus edge and a faint earthy funk underneath. Onset is an energetic euphoric rush that mellows into relaxed calm, mirroring its balanced heritage.",
    tagline: "Berry yogurt, balanced lift",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Animal Scout",
    lineage: {
      parents: ["Brownie Scout", "Animal Face"],
      cross: "Brownie Scout × Animal Face",
    },
    sensoryFamily: "garlic-funk",
    phenotypeNotes: ["Limonene-dominant with myrcene and caryophyllene support", "Bright mango-citrus peel layered over earthy chocolate funk"],
    curatorNote:
      "An indica-leaning cookies powerhouse that surprises with a bright citrus-peel lift over a deep, chocolatey-earthy base. A whisper of savory garlic funk adds complexity beneath the sweetness.",
    tagline: "Citrus lift, earthy funk",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Gogurtz",
    breeder: "Seed Junky Genetics",
    lineage: {
      parents: ["Runtz", "Cap Junky"],
      cross: "Runtz × Cap Junky",
    },
    sensoryFamily: "candy-exotic",
    phenotypeNotes: ["Caryophyllene, limonene and myrcene drive the candy-to-pepper arc", "Resin-frosted flowers flashing lime to deep forest green"],
    curatorNote:
      "Gogurtz opens on tropical candy and creamy lemon before pine, cracked pepper and a faint solvent edge take over. The experience lifts mood and eases chatter, then cushions into a warm full-body calm.",
    tagline: "Candy gas, creamy exhale",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Grape Bubblegum",
    lineage: {
      parents: ["GMO", "Purple Punch"],
      cross: "GMO × Purple Punch",
    },
    sensoryFamily: "purple-berry",
    phenotypeNotes: ["Multiple lineages circulate under the Grape Bubblegum name", "Myrcene-forward with limonene and caryophyllene support"],
    curatorNote:
      "A candy-shop indica leaning into ripe grape and bubblegum sweetness with a faint spicy edge. The high is mellow and euphoric, easing toward relaxation without sativa raciness.",
    tagline: "Juicy grape candy chew",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Tamarindo",
    breeder: "Green Fire Genetics",
    lineage: {
      parents: ["Green Fire", "Grape Pie"],
      cross: "Green Fire × Grape Pie × Lil Miss HS",
    },
    sensoryFamily: "funky-exotic",
    phenotypeNotes: ["Sources disagree on parentage"],
    curatorNote:
      "Tamarindo offers a complex tangy nose of citrus and grape over savory funk with a coffee-tinged finish. Effects skew uplifted and clear, settling into focused creativity that suits daytime use.",
    tagline: "Tangy citrus, daytime focus",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Papaya Wine",
    breeder: "Atlas Seed",
    lineage: {
      parents: ["Papaya Bomb"],
      cross: "Papaya Bomb cross",
    },
    sensoryFamily: "tropical-fruit",
    phenotypeNotes: ["Semi-full-term Papaya Bomb cross via Purple City Genetics", "Pronounced ripe-papaya nose with a sweet fuel backbone"],
    curatorNote:
      "Papaya Wine leans hard into juicy tropical papaya nectar with a sweet diesel undertone that keeps it from reading purely fruity. The body experience is relaxing and happy with an appetite nudge typical of the Papaya line.",
    tagline: "Tropical papaya, sweet diesel",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Champagne Patties",
    breeder: "Skunk House Genetics",
    lineage: {
      parents: ["Strawberry Mimosa", "Double Burger"],
      cross: "Strawberry Mimosa × Double Burger",
    },
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Dessert-leaning sativa-dominant hybrid with berry-mimosa brightness", "Resinous Double Burger structure adds skunky depth"],
    curatorNote:
      "A celebratory pour in flower form: grape skins and citrus zest sparkle up front before settling into warm vanilla cream. The high is clear-headed euphoria with just enough body ease to stay social.",
    tagline: "Sparkling grape-cream euphoria",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "LA Pop Rockz",
    marketNames: ["LA Pop Rocks"],
    breeder: "Seed Junky Genetics",
    lineage: {
      parents: ["Z Animal", "Triangle Kush BX2"],
      cross: "Z Animal × TK Bx2",
    },
    sensoryFamily: "candy-exotic",
    phenotypeNotes: ["Indica-dominant (~70/30) with candy-apple terps from the Z side", "Triangle Kush backbone delivers potent classic kush relaxation"],
    curatorNote:
      "Sour-apple candy and orange zest pop against a spicy kush backbone for a genuinely playful nose. The buzz launches euphoric and alert before tingling down into sedation.",
    tagline: "Sour-candy kush rush",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Millionaire",
    breeder: "707 Seed Bank",
    lineage: {
      parents: ["Gorilla Glue #4", "Kush Cleaner"],
      cross: "Gorilla Glue #4 × Kush Cleaner",
    },
    sensoryFamily: "gas-og",
    phenotypeNotes: ["Cross attributed but unconfirmed by the breeder", "Most phenos lean to the gassy GG4 side"],
    curatorNote:
  ...
  {
    canonicalName: "OG Chem Haze",
    marketNames: ["Chem Haze"],
    breeder: "Connoisseur Genetics",
    lineage: {
      parents: ["Chemdawg", "Super Silver Sour Diesel Haze"],
      cross: "Chemdawg × Super Silver Sour Diesel Haze",
    },
    sensoryFamily: "diesel-chem",
    phenotypeNotes: ["Sits at the crossroads of the Chem and Haze families", "Terpinolene-led phenos skew zesty; caryophyllene phenos add black-pepper warmth"],
    curatorNote:
      "A connoisseur's collision of Chem funk and soaring Haze brightness, all lemon candy and sour fuel. The effect is stimulating and layered, ideal for creative or active daytime sessions.",
    tagline: "Sour fuel haze lift",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Persimmon",
    marketNames: ["Perzimmon"],
    breeder: "Compound Genetics",
    lineage: {
      parents: ["Rainbow Cheddar", "GastroPop"],
      cross: "Rainbow Cheddar × GastroPop",
    },
    sensoryFamily: "funky-exotic",
    phenotypeNotes: ["~75/25 indica-dominant; expect deep purple shades and extreme frost", "Candy Zkittlez terps layered over UK Cheese funk"],
    curatorNote:
      "Candy-sweet tropical fruit up top gives way to a loud, savory cheese-and-gas funk that keeps it interesting. An evening cultivar that calms the mind and eases the body toward peaceful sleep.",
    tagline: "Candy fruit cheese funk",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    ...
    breeder: "Purple City Genetics",
    lineage: {
      parents: ["Slurty3", "Street Guru"],
      cross: "Slurty3 × Street Guru",
    },
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Multiple breeder versions exist; profiled as Purple City Genetics' indica-dominant cut", "Street Guru lends creamy, minty, sparkling undertones"],
    curatorNote:
      "Fizzy sweetness with berry and creamy-mint layers makes Hooch taste like its name suggests, a dessert with a kick. Very high THC drives a deeply relaxing, body-heavy session well suited to unwinding.",
    tagline: "Fizzy sweet berry sedation",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Boogie Wuggie",
    breeder: "B Noble",
    sensoryFamily: "kush-classic",
    phenotypeNotes: ["Sold as a B Noble brand indica flower in New York"],
    curatorNote:
      "A B Noble brand indica built on bold citrus-pine brightness over earthy depth. Its high potency translates to deeply soothing, body-heavy calm that drifts toward sleep.",
    tagline: "Citrus-pine body sedation",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Mimosa Kush Mints",
    lineage: {
      parents: ["Mimosa", "Kush Mints"],
      cross: "Mimosa × Kush Mints",
    },
    sensoryFamily: "gelato-exotic",
    phenotypeNotes: ["Limonene and beta-caryophyllene lead, with linalool and humulene support", "Citrus-clarity Mimosa phenotype layered over creamy Kush Mints depth"],
    curatorNote:
      "A modern designer hybrid that opens with a sparkling mandarin lift before the Kush Mints lineage warms the body into a smooth, creamy mint finish. Clear-headed euphoria dominates the first hour.",
    tagline: "Mandarin lift, minty cream",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Sativa Vee",
    marketNames: ["Viva Sativa"],
    sensoryFamily: "citrus-haze",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Reported terpinolene-limonene-ocimene triad consistent with a Haze-leaning cut"],
    curatorNote:
      "A bright, terpinolene-driven sativa that lifts fast with clean, sparkling energy ideal for daytime focus and creativity. The bouquet skews citrus peel and herbaceous pine with a whisper of floral sweetness.",
    tagline: "Bright citrus-pine daytime lift",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "That Gas",
    sensoryFamily: "gas-og",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Aroma sits in the gas/diesel end of the exotic spectrum"],
    curatorNote:
      "An unapologetically gassy cut that leads with pungent diesel and skunky earth over a thin sweet backbone. Effects lean relaxed and euphoric, easing into a heavier body as the session settles.",
    tagline: "Pure pungent fuel funk",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Blue Runtz",
    marketNames: ["BRunTZ", "Blue Rntz"],
    lineage: {
      parents: ["Blueberry", "White Runtz"],
      cross: "Blueberry × White Runtz",
    },
    sensoryFamily: "candy-exotic",
    phenotypeNotes: ["Limonene-dominant with caryophyllene and myrcene building a musky herbal base", "Carries Runtz fruit-and-cream character with a blueberry overlay"],
    curatorNote:
      "A candy-coated indica-leaning hybrid that opens with bright, slightly candied blueberry and pear before a creamy vanilla undertone takes over. The mental lift is euphoric and creative while the body stays tingly and chill.",
    tagline: "Candied blueberry, creamy calm",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Bubblegum Haze",
    lineage: {
      parents: ["Bubblegum", "Super Silver Haze"],
      cross: "Bubblegum × Super Silver Haze",
    },
    sensoryFamily: "sweet-haze",
    phenotypeNotes: ["Sativa-dominant expression (~60/40) fusing candy sweetness with Haze energy", "Some sources trace background genetics through Purple Thai and Pure Haze"],
    curatorNote:
      "A sativa-forward Haze that smells like opening a fresh pack of bubblegum, sweet and sugary with a citrus-spice lift. The high launches into a focused, chatty, creative headspace before tapering gently without a crash.",
    tagline: "Sweet bubblegum, soaring haze",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Randy Marsh",
    lineage: {
      parents: ["Apples and Bananas", "Gary Payton"],
      cross: "Apples and Bananas × Gary Payton",
    },
    sensoryFamily: "tropical-fruit",
    phenotypeNotes: ["Caryophyllene, humulene, limonene and linalool lead the terpene profile", "Lineage varies by source"],
    curatorNote:
      "A balanced hybrid that hits fast with high-flying euphoria and bright, tingly energy plus a touch of focus. The nose is sweet melon and tropical fruit over a pungent gassy base, finishing with a citrusy lemon flavor.",
    tagline: "Sweet melon, gassy energy",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Blackened Blue",
    sensoryFamily: "purple-berry",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Profile aligns with dark Blueberry-style indica crosses"],
    curatorNote:
      "A heavy, dark-berry indica built for the end of the night, with sweet blueberry up front giving way to sour earth, sage and black pepper. The body effects run narcotic and sedating, sliding toward couch-lock and sleep.",
    tagline: "Dark berry, deep sedation",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Grandma's House",
    breeder: "Dark Heart Genetics",
    lineage: {
      parents: ["Romulan Grapefruit", "Kush Mints"],
      cross: "Romulan Grapefruit × Kush Mints",
    },
    sensoryFamily: "kush-classic",
    phenotypeNotes: ["Earthy oak-forward kush phenotype with a faint citrus-mint candy lift", "Indica-leaning with grounded, non-sedating relaxation"],
    curatorNote:
      "Grandma's House leads with warm earth and oak before a whisper of sweet hard candy rounds the finish. The body settle is calming and clear rather than couch-locking, making it a comfortable evening companion.",
    tagline: "Cozy oak and candy kush",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Sugar Kushions",
    breeder: "Dark Heart",
    lineage: {
      parents: ["4n Kush Mints", "Sugarcane Kush"],
      cross: "4n Kush Mints × Sugarcane Kush",
    },
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Sweet, plush candy-kush dessert profile"],
    curatorNote:
      "Sugar Kushions reads as a soft, sugary kush dessert with creamy sweetness draped over a mild earthy base. The effect is a plush, happy relaxation that drifts toward appetite and rest.",
    tagline: "Plush sugary kush dessert",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    ...
    lineage: {
      ...
      cross: "Modified Muffins #10 × Lady Madonna #10",
    },
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Balanced hybrid pairing baked-muffin sweetness with citrus-pine brightness", "High-potency expression often testing high-20s to low-30s THC"],
    curatorNote:
      "Nuclear Muffins greets the nose with citrus, pine and sweet berry over a baked-goods warmth. Effects split the difference between an uplifting, creative cerebral lift and smooth calming ease without heavy sedation.",
    tagline: "Citrus berry baked dessert hybrid",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Heir Heads",
    marketNames: ["Hair Heads"],
    lineage: {
      parents: ["Apples and Bananas", "Pink Runtz"],
      cross: "Apples and Bananas × Pink Runtz",
    },
    sensoryFamily: "candy-exotic",
    phenotypeNotes: ["Evenly balanced 50/50 hybrid with complex fruit acidity", "Sweet tropical-candy and spiced-apple notes over a diesel-funk base"],
    curatorNote:
      "Heir Heads opens with ripe fruit, spiced apple and sweet tropical candy carried on a pungent diesel undertone. The arc moves from a euphoric, creative cerebral buzz into deepening physical relaxation.",
    tagline: "Spiced fruit candy diesel hybrid",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Creamsicle Sunset",
    sensoryFamily: "citrus-haze",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Loud orange-cream and vanilla profile typical of the Creamsicle line"],
    curatorNote:
      "Creamsicle Sunset pours out bright orange citrus wrapped in smooth vanilla cream, exactly as the name promises. The high arrives as slow waves of happy euphoria that mellow into relaxed contentment.",
    tagline: "Orange vanilla cream sunset",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Gazzurple",
    breeder: "Humboldt Seed Company",
    lineage: {
      parents: ["Gazzurple Bx2", "Poddy Mouth", "Macaroon"],
      cross: "Gazzurple Bx2 × Poddy Mouth × Macaroon",
    },
    sensoryFamily: "purple-berry",
    phenotypeNotes: ["Indica-dominant hybrid with a diesel-forward, grape-and-cream terpene stack", "Fast onset moving from cerebral lift into body-forward relaxation"],
    curatorNote:
      "Gazzurple delivers a concentrated diesel snap layered with grape peel, dark berry and a touch of cream. Onset is quick and floaty before settling into a warm, body-forward relaxation that loosens tension.",
    tagline: "Diesel grape berry cream",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Animal Mint Cake",
    marketNames: ["Animal Mints Cake"],
    breeder: "Seed Junky Genetics",
    lineage: {
      parents: ["Animal Cookies", "Wedding Cake"],
      cross: "Animal Cookies × Wedding Cake",
    },
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Dessert-leaning cake pheno with pronounced mint overlay", "Heavy trichome coverage typical of the Mints line"],
    curatorNote:
      "A nightcap dessert strain that pairs tingly menthol with creamy vanilla-cake sweetness. The sedative body load arrives after an euphoric, talkative opening, making it an evening sipper.",
    tagline: "Minty vanilla cake nightcap",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Facetz #12",
    marketNames: ["Facetz"],
    breeder: "Compound Genetics",
    lineage: {
      parents: ["Pave", "Gastro Pop #5"],
      cross: "Pave × Gastro Pop #5",
    },
    sensoryFamily: "funky-exotic",
    phenotypeNotes: ["#12 selection skews citrus-and-diesel rather than the sugary grape pheno", "Award pedigree: first place 2024 Copa de la Marihuana, Madrid"],
    curatorNote:
      "A loud, exotic citrus-diesel cut from Compound's grape-gas Facetz line. Euphoric mental clarity rolls into a heavy, empty-headed body relaxation.",
    tagline: "Loud citrus diesel exotic",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Golden Sands",
    breeder: "Humboldt Seed Company",
    lineage: {
      parents: ["GMO", "Kashmir OG", "Blackberry Kush"],
      cross: "GMO × Kashmir OG × Blackberry Kush",
    },
    sensoryFamily: "garlic-funk",
    phenotypeNotes: ["80% indica / 20% sativa expression", "Selected over backcrosses for dry, bulbous, hash-grade trichomes"],
    curatorNote:
      "A GMO-forward funk bomb built for hash makers, layering savory OG gas with soft floral lift. The high is deeply physical and long-lasting with a euphoric, mildly creative head.",
    tagline: "Funky gas hash trichomes",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Jayna's Sunshine",
    breeder: "Grassroots",
    sensoryFamily: "citrus-haze",
    phenotypeNotes: ["Profile suggests citrus/terpinolene-forward haze parentage"],
    curatorNote:
      "A sunny, citrus-dominant sativa-leaner geared toward creative daytime use. Bright lemon and tropical sweetness lead into an uplifting cerebral high with a calm, soothing tail.",
    tagline: "Bright citrus daytime uplift",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Problem Child",
    breeder: "Jinxproof Genetics",
    lineage: {
      parents: ["Tangie", "9lb Hammer"],
      cross: "Tangie × 9lb Hammer",
    },
    sensoryFamily: "sweet-haze",
    phenotypeNotes: ["Slightly indica-dominant (~65% indica / 35% sativa)", "Developed over three years of selective breeding in micro-batches"],
    curatorNote:
  ...
  {
    canonicalName: "Triple Mints",
    marketNames: ["Triple Mint"],
    breeder: "In House Genetics",
    lineage: {
      parents: ["Triple Hitter", "Platinum Kush Mints BX2"],
      cross: "Triple Hitter × Platinum Kush Mints BX2",
    },
    sensoryFamily: "kush-classic",
    phenotypeNotes: ["Mostly indica structure with stocky limbs and tight internodes", "Flowers 8-10 weeks with resin-rich buds"],
    curatorNote:
      "A menthol-forward indica that layers cooling spearmint over gassy kush and a whisper of Urkle berry. The finish is creamy and luxurious, and the effect is relaxed, calming and ultimately sleepy.",
  ...
  },
  {
    ...
    sensoryFamily: "tropical-fruit",
    phenotypeNotes: ["Profile inferred from related Bloom Seed Co 'Island Blends' line"],
    curatorNote:
  ...
  },
  {
    ...
    sensoryFamily: "citrus-haze",
    phenotypeNotes: ["Vibrant orange hairs and dense trichomes"],
    curatorNote:
  ...
  },
  {
    ...
    sensoryFamily: "candy-exotic",
    phenotypeNotes: ["Brand-level Zkittlez x Spritzer candy hybrid"],
    curatorNote:
  ...
  },
  {
    ...
    breeder: "Don Merfos Exotics",
    lineage: {
      parents: ["Super Lemon Haze", "Cherry Pie"],
      cross: "Super Lemon Haze × Cherry Pie",
    },
    sensoryFamily: "gelato-exotic",
    phenotypeNotes: ["Hyped Bay Area exotic; rumored Super Lemon Haze x Cherry Pie"],
    curatorNote:
  ...
  {
    canonicalName: "King Kong Gelato",
    sensoryFamily: "gelato-exotic",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Distinct from King Gelato (High Octane x Curelato)"],
    curatorNote:
      "King Kong Gelato hits the nose with a heavy wave of gas before sweeter berry and cream tones settle in underneath. The body effect is weighty and calming, leaning firmly indica.",
    tagline: "Gassy berry-cream heavyweight",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Jelly Beanz",
    ...
    sensoryFamily: "candy-exotic",
    phenotypeNotes: ["Likely tied to the TGA Jillybean candy-citrus line"],
    curatorNote:
      "Jelly Beanz leads with orange candy and tangerine peel over a soft floral-spice finish, evoking a bag of fruit chews. Effects skew upbeat, creative, and daytime-friendly.",
    tagline: "Orange-candy creative uplift",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Jellie Pie",
    breeder: "Left Coast Extracts",
    lineage: {
      parents: ["Gelato", "Wedding Pie"],
      cross: "Gelato × Wedding Pie",
    },
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Released as a Left Coast Extracts seasonal cultivar"],
    curatorNote:
      "Jellie Pie tastes like grape jelly spread on warm pastry, with a creamy vanilla undertone from its Gelato and Wedding Pie parents. The balance lands between sweet euphoric lift and a cozy relaxed settle.",
    tagline: "Grape jelly on pastry",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Honey Badger",
    breeder: "Twenty 20 Genetics",
    sensoryFamily: "sweet-haze",
    phenotypeNotes: ["Name shared across breeders with differing genetics"],
    curatorNote:
      "Honey Badger opens with a honeyed wildflower bouquet, clover and chamomile laced with light citrus and a pepper-pine backbone. Effects lean happy, energetic, and focused with creative lift.",
    tagline: "Honeyed wildflower citrus lift",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Her Majesty",
    breeder: "Delicatessen",
    lineage: {
      parents: ["Mexican", "Queen Mother"],
      cross: "Mexican × Queen Mother",
    },
    sensoryFamily: "sweet-haze",
    phenotypeNotes: ["Documented Delicatessen sativa-dominant cultivar"],
    curatorNote:
      "Her Majesty offers a sweet, flowery, fruity profile that carries identically from aroma to flavor. The high is exceptionally cerebral and clear-headed with unusually long-lasting energy for a sativa.",
    tagline: "Sweet floral cerebral sativa",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Halle Berry",
    breeder: "Blockhead Buds",
    lineage: {
      parents: ["Ice Cream Cake", "Blockberry"],
      cross: "Ice Cream Cake × Blockberry",
    },
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Clone-only cultivar from Blockhead Buds"],
    curatorNote:
      "Halle Berry leads on the nose with dank woody pine and bright citrus, then delivers a creme-saver flavor of candy orange over creamy vanilla and berry. Effects are energizing and creative without anxiety.",
    tagline: "Creme-saver citrus and pine",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Guavatron",
    breeder: "To the Moon",
    lineage: {
      parents: ["Guava Runtz", "Lemon Cherry Gelato"],
      cross: "Guava Runtz × Lemon Cherry Gelato",
    },
    sensoryFamily: "tropical-fruit",
    phenotypeNotes: ["Documented as a To the Moon cultivar; very high reported THC"],
    curatorNote:
      "Guavatron tastes of vibrant tropical guava that evolves into a candy-sweet finish, true to its Guava Runtz x LCG lineage. The effect is calm, happy, and relaxed without heavy sedation.",
    tagline: "Tropical guava candy calm",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Grape Gasoline",
    breeder: "Compound Genetics",
    lineage: {
      parents: ["Grape Pie", "Jet Fuel Gelato"],
      cross: "Grape Pie × Jet Fuel Gelato",
    ...
    sensoryFamily: "purple-berry",
    phenotypeNotes: ["Cannarado x Compound Genetics collaboration", "Myrcene-dominant with linalool and caryophyllene"],
    curatorNote:
      "A study in contrast where sweet fermented grape collides with a volatile fuel layer in a single inhale. The onset lifts cerebrally before sinking into a heavy evening body high.",
    tagline: "Grape candy meets jet fuel",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Golden Glove",
    sensoryFamily: "gas-og",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Profile inferred from related Glove/Gary Payton gas lineages"],
    curatorNote:
      "Documentation for this exact name is thin, so the profile is mapped to the gassy Glove family it appears named after. Expect a loud diesel-forward nose with a sweet, spiced finish and a relaxed, giggly hybrid arc.",
    tagline: "Loud gas, sweet finish",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Gluttony",
    breeder: "FireFly Genetics",
    lineage: {
      parents: ["Poppin Bottlez", "Jealousy"],
      cross: "Poppin Bottlez × Jealousy F2",
    },
    sensoryFamily: "candy-exotic",
    phenotypeNotes: ["Indica-leaning, roughly 60-80% indica", "Multiple breeders use the Gluttony name; FireFly cut profiled here"],
    curatorNote:
      "An indulgent indica-leaning hybrid built for flavor chasers, layering sweet cream and ripe berry over citrus and spice. The arc opens euphoric and creative before settling into full-body calm with a strong appetite boost.",
    tagline: "Decadent sweet cream berry",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Gastro Pop",
    breeder: "Compound Genetics",
    lineage: {
      parents: ["Apples and Bananas", "Grape Gas"],
      cross: "Apples and Bananas × Grape Gas",
    },
    sensoryFamily: "candy-exotic",
    phenotypeNotes: ["Top phenos include #5 and #28", "Bred by Chris Lynch of Compound Genetics"],
    curatorNote:
      "An elite-looking exotic that pairs fizzy grape candy with apple-banana fruit and a pungent gassy backbone. Effects arrive as fast cerebral euphoria with a tingly body and a strong appetite cue, easing into a stoney calm.",
    tagline: "Fizzy grape candy soda",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Gasolina",
    marketNames: ["Lemon Gasolina"],
    breeder: "Mohave Cannabis Co.",
    lineage: {
      parents: ["Silver Sour Diesel", "Blueberry", "Meao Thai", "Oldtimers' Haze"],
      cross: "Silver Sour Diesel × Blueberry × Meao Thai × Oldtimers' Haze",
    },
    sensoryFamily: "diesel-chem",
    phenotypeNotes: ["Name circulates across several diesel-OG lines", "Profiled here as the Mohave indica-dominant cut"],
    curatorNote:
      "A diesel-forward indica-leaning hybrid whose name nods to its piercing fuel nose over earth and lemon-pine. The experience is mostly calming and relaxing with a euphoric lift and a heavy body settle.",
    tagline: "Lemon pine diesel fuel",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Gas Berry",
    sensoryFamily: "purple-berry",
    phenotypeNotes: ["Circulates as multiple cuts; genetics vary by market", "Two clusters reported: gassy lime-green vs berry-purple"],
    curatorNote:
      "A resin-heavy indica-leaning hybrid that opens with volatile diesel and finishes on dark fruit sweetness. Phenotypes split between a gassy lime-green expression and a purple berry-forward one.",
    tagline: "Diesel into dark berry",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Gelato Skittlez",
    marketNames: ["Gelato Zkittlez"],
    breeder: "Purple Caper Seeds",
    lineage: {
    ...
    sensoryFamily: "gelato-exotic",
    phenotypeNotes: ["Worked by multiple breeders; cuts vary in resin vs flavor focus", "Averages around 21% THC"],
    curatorNote:
      "A modern California dessert hybrid marrying Gelato's creamy sweetness to Zkittlez's candy-fruit brightness. The nose opens peppery before yielding a baked-good and tropical-confection sweetness.",
    tagline: "Creamy candy fruit dessert",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Fried Ice Cream",
    marketNames: ["Deep Fried Ice Cream"],
    breeder: "Exotic Genetix",
    lineage: {
      parents: ["Gelato 41", "The Menthol"],
      cross: "Gelato 41 × The Menthol",
    },
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["More a flavor movement than a single pedigree", "Other versions trace to Ice Cream Cake / Deep Breath"],
    curatorNote:
      "A pastry-forward hybrid built around custard, fried-dough, and toasted-cone sweetness with a faint cooling spice from its Menthol parent. The effect is lighthearted and giggly, sociable, then physically relaxing.",
    tagline: "Custard fried-dough dessert",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Dumbo Diesel",
    breeder: "Gage Green Genetics",
    lineage: {
      parents: ["Grape Stomper", "Sour Diesel"],
      cross: "Grape Stomper × Sour Diesel",
    },
    sensoryFamily: "diesel-chem",
    phenotypeNotes: ["Grape-forward fuel phenotype with limonene-myrcene-pinene lean", "Sativa-dominant cerebral expression"],
    curatorNote:
      "Crack the jar and diesel hits first, trailed by crushed grape skin and a citrus-pine edge. The high is bright and motivating, a clear creative head buzz over light body ease.",
    tagline: "Fuel-soaked grape sativa",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Detroit Purps",
    sensoryFamily: "purple-berry",
    phenotypeNotes: ["Purps-derived purple phenotype, exact cross varies by grower", "Caryophyllene-myrcene-limonene lean"],
    curatorNote:
      "Grape soda and black-cherry skin pour out of the jar with a soft lilac note before a solvent-bright fuel edge. Effects run soothing yet assertive, a happy body calm that can hit hard alongside peppery citrus.",
    tagline: "Grape-gas purple powerhouse",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Dark Matter OG",
    lineage: {
      parents: ["Cherry Thunderfuck", "Rusty Haze"],
      cross: "Cherry Thunderfuck × Rusty Haze",
    },
    sensoryFamily: "purple-berry",
    phenotypeNotes: ["Umbrella name; reported lineages vary across breeders", "Cherry-tart earthy phenotype around 18-26% THC"],
    curatorNote:
      "Smells like a fresh cherry tart dusted with cinnamon set in a wet pine wood, sweet berry over deep earth. The onset is a buzzing, tingly head-high that mellows into happy, uplifted tranquility.",
    tagline: "Dark cherry forest tart",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Dank N' Donuts",
    breeder: "DANK",
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Marketed brand product with bakery-glaze profile"],
    curatorNote:
      "Pure pastry on the nose, sweet glaze and vanilla icing over a warm doughy base. The high opens with an uplifting cerebral buzz then sinks into a deep, relaxing body calm.",
    tagline: "Glazed vanilla dough hybrid",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Cherry Slushie",
    marketNames: ["Cherry Zlushie"],
    lineage: {
      parents: ["Ice Cream Cake", "Gelato 41"],
      cross: "Ice Cream Cake × Gelato #41",
    },
    sensoryFamily: "candy-exotic",
    phenotypeNotes: ["Family of closely related cuts; lineage varies by seed line", "Linalool-caryophyllene-myrcene lean, ~60/40 indica"],
    curatorNote:
      "A bright maraschino-cherry top note melts into chilled syrup and soft candy florals. The lift is fast and euphoric, a mood-brightening lift that eases into cozy body calm without heavy couch-lock.",
    tagline: "Chilled cherry candy syrup",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Cherry Poppins",
    sensoryFamily: "candy-exotic",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Distinct from similarly named Cherry Poppers/Popper lines"],
    curatorNote:
      "Sweet red cherry and candied berry lead the nose with a light floral lift. Effects skew happy and uplifting with a giggly, sociable edge settling into mild relaxation.",
    tagline: "Sweet cherry candy lift",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Chem x Chocolate",
    lineage: {
      parents: ["Chemdawg", "Chocolate Diesel"],
      cross: "Chemdawg × Chocolate Diesel",
    },
    sensoryFamily: "diesel-chem",
    phenotypeNotes: ["No single breeder of record; parents vary by seedmaker", "Caryophyllene-limonene over diesel base, ~60/40 sativa"],
    curatorNote:
      "Loud at first sniff, fuel and rubber skunk burst out before cocoa powder and espresso ground the bouquet in damp earth. The high is a bright creative lift that loosens into easy body calm.",
    tagline: "Loud fuel meets cocoa",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Chem Cookies",
    breeder: "Mamiko Seeds",
    lineage: {
      parents: ["Chemdawg D", "Girl Scout Cookies"],
      cross: "Chemdawg D × Forum Cut GSC",
    },
    sensoryFamily: "diesel-chem",
    phenotypeNotes: ["Versions exist from multiple breeders with varied parents", "Tests 24-30% THC, sedating cookie-gas phenotype"],
    curatorNote:
      "Industrial funk leads, petrol, rubber and a faint garlic-onion bite over brown sugar and vanilla dough with a cool mint finish. Onset is instant euphoria sliding into full body relaxation and couch-lock.",
    tagline: "Pungent gas cookie funk",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Cheddar Cheeze",
    marketNames: ["Cheddar Cheese"],
    breeder: "Grassroots",
    lineage: {
      parents: ["UK Cheese", "Gorilla Diesel"],
      cross: "UK Cheese × Gorilla Diesel",
    },
    sensoryFamily: "skunk-funk",
    phenotypeNotes: ["Pronounced fermented-cheese funk with garlic/onion allium undertones", "Heavy, slow-building body relaxation"],
    curatorNote:
      "Cheddar Cheeze leads with an unmistakable wall of aged-cheese funk laced with sulfurous allium and sharp diesel. It is a savory, almost umami smoke that rewards drinkers who like loud, pungent flower over candy sweetness.",
    tagline: "Funky savory cheese gas",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Candy Kush",
    marketNames: ["Kandy Kush"],
    breeder: "DNA Genetics",
    lineage: {
    ...
    sensoryFamily: "kush-classic",
    phenotypeNotes: ["Sweet lemon-candy nose over earthy Kush base", "Balanced mood lift with notable munchies"],
    curatorNote:
      "Candy Kush opens with a bright, sugary citrus sweetness that softens the classic earthy Kush spine beneath it. The effect is mellow and sociable rather than overwhelming, with a steady mood boost and a healthy appetite.",
    tagline: "Sweet lemon Kush candy",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Boofberry Zilla",
    sensoryFamily: "funky-exotic",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Name suggests a Boof-family berry cross with frosty, candy-gas character"],
    curatorNote:
      "Boofberry Zilla reads as a loud, berry-forward exotic in the popular Boof lineage, layering sweet dark-fruit candy over a funky gas undertone. Expect a frosty, fragrant flower with a balanced, euphoric-into-relaxed arc.",
    tagline: "Loud berry candy gas",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Silver Haze",
    breeder: "Sensi Seeds",
    lineage: {
      parents: ["Skunk #1", "Northern Lights #5", "Haze"],
      cross: "Skunk #1 × Northern Lights #5 × Haze",
    },
    sensoryFamily: "citrus-haze",
    phenotypeNotes: ["Sharp lemon-citrus over earthy pine and incense spice", "Fast-hitting, motivating cerebral high"],
    curatorNote:
      "Silver Haze is a cornerstone Haze sativa, leading with bright lemon-citrus zest wrapped in earthy pine and peppery spice. The high arrives fast and clear-headed, sparking energy, creativity and an upbeat focus ideal for daytime.",
    tagline: "Bright energetic citrus Haze",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Scented Marker",
    breeder: "Seed Junky Genetics",
    lineage: {
      parents: ["Permanent Marker", "Pineapple Fruz"],
      cross: "Permanent Marker × Pineapple Fruz",
    },
    sensoryFamily: "tropical-fruit",
    phenotypeNotes: ["Overripe pineapple over inky permanent-marker and rubber notes", "Whisper of lavender florals with spicy gas"],
    curatorNote:
      "Scented Marker fuses juicy overripe pineapple with the signature inky, rubbery funk of Permanent Marker and a sharp diesel edge. The effect comes on fast and euphoric, blooming into creative energy before settling into a relaxed, hungry headspace.",
    tagline: "Pineapple ink diesel funk",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Space Jam",
    lineage: {
      parents: ["Space Cake", "Wedding Cake"],
      cross: "Space Cake × Wedding Cake",
    },
    sensoryFamily: "gelato-exotic",
    phenotypeNotes: ["Orange zest and sugared berry jam over creamy vanilla", "Several competing lineages circulate; Space Cake x Wedding Cake most cited"],
    curatorNote:
      "Space Jam pours on bright orange-citrus snap and sticky berry-jam sweetness over a smooth cream-and-vanilla base, often with a surprising cool mint lift. It plays as a sociable, dessert-leaning hybrid with a creative, talkative head and gentle body ease.",
    tagline: "Berry jam citrus cream",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Sour Blueberry",
    lineage: {
      parents: ["Sour Diesel", "Blueberry"],
      cross: "Sour Diesel × Blueberry",
    },
    sensoryFamily: "purple-berry",
    phenotypeNotes: ["Sour citrus-diesel top-notes over sweet blueberry middle", "Lingering blueberry-skin astringency on the finish"],
    curatorNote:
      "Sour Blueberry threads sharp Sour Diesel citrus-gas through sweet, ripe blueberry, closing with a tart berry-skin zing. It is an approachable, moderate-strength hybrid that leans heady and energetic, lifting mood and sparking creativity.",
    tagline: "Sour diesel ripe blueberry",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Rolex Runtz",
    lineage: {
      parents: ["Runtz", "Paris OG"],
      cross: "Runtz × Paris OG",
    },
    sensoryFamily: "candy-exotic",
    phenotypeNotes: ["Colorful candy-coated nugs with heavy trichome frost", "Vanilla-cream sweetness over OG funk"],
    curatorNote:
      "Rolex Runtz opens with powdered-sugar and vanilla-cream sweetness before a tropical fruit lift and grounding OG gas settle in. The high is elegant and balanced, starting cerebral and uplifting before easing into a velvety body calm.",
    tagline: "Candy sweetness over gas",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Retro 1Z",
    breeder: "Packs",
    sensoryFamily: "skunk-funk",
    phenotypeNotes: ["Dense forest-green buds", "Throwback earthy-skunk character with pine"],
    curatorNote:
      "Retro 1Z leans into a deliberately old-school aroma of earth and skunk, brightened by pine and a hint of citrus that sharpens as the buds are broken apart. The effect is sociable and clear, a smooth cerebral lift that settles into easy body relaxation.",
    tagline: "Old-school skunk and pine",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Red Zprite",
    breeder: "Smoke Wrld",
    sensoryFamily: "candy-exotic",
    phenotypeNotes: ["Cherry-red and purple-tinged candy flower", "Fizzy citrus-candy terp expression"],
    curatorNote:
      "Red Zprite is loud and candy-bright, layering sweet cherry and citrus zest over tropical fruit for a soda-like fizzy finish. Effects run uplifting and creative with a mellow euphoria that keeps it daytime-friendly.",
    tagline: "Fizzy cherry citrus candy",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Rainbow Cookies",
    lineage: {
      parents: ["Sunset Sherbet", "Animal Cookies"],
      cross: "Sunset Sherbet × Animal Cookies",
    },
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Colorful buds with sweet dough and berry notes", "Nutty, skunky aftertaste"],
    curatorNote:
      "Rainbow Cookies blends sweet berries and baked-confection dough with a sour-pine edge and a nutty, skunky finish. The high is grounding and dreamy, mixing euphoria and appetite before easing toward relaxation.",
    tagline: "Berry baked-cookie dessert",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Quarter Water",
    sensoryFamily: "candy-exotic",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Profile inferred from name and exotic-candy category conventions"],
    curatorNote:
      "Quarter Water is a candy-exotic styled after the sugary fruit-drink it's named for, reading sweet and juicy with tropical and berry top notes. Effects are described as relaxing and happy with an easy euphoric lift.",
    tagline: "Sweet juicy fruit candy",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Pushing Pluto",
    breeder: "To The Moon",
    sensoryFamily: "diesel-chem",
    phenotypeNotes: ["Dense nugs with a frosty trichome coat", "Sour lemon-citrus over skunky-earth funk"],
    curatorNote:
      "Pushing Pluto carries a sour lemon-citrus nose over skunky earth and a woody, spicy undertone. The high pushes potency, opening with a euphoric uplift before settling into deep, heavy-bodied relaxation.",
    tagline: "Sour citrus skunk punch",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Pound for Pound Cake",
    breeder: "Tyson 2.0",
    lineage: {
      parents: ["Sunset Sherbet", "Wedding Cake"],
      cross: "Sunset Sherbet × Wedding Cake",
    ...
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Creamy vanilla-cake flavor with citrus zest", "Second parent debated, likely Wedding Cake family"],
    curatorNote:
      "Pound for Pound Cake delivers a creamy vanilla-cake sweetness laced with zesty lemon and grapefruit over a touch of woody pine. The high is immediate and full-bodied, sliding quickly into couch-lock relaxation with a sharp pang of munchies.",
    tagline: "Creamy vanilla cake couch-lock",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Petro Chem",
    breeder: "Archive Seed Bank",
    lineage: {
      parents: ["Gorilla Glue #4", "Moonbow #75"],
      cross: "Gorilla Glue #4 × Moonbow #75",
    },
    sensoryFamily: "diesel-chem",
    phenotypeNotes: ["Peppery caryophyllene with zesty limonene and earthy myrcene", "Rubbery adhesive gas note over peppered lemon zest"],
    curatorNote:
      "A loud fuel-forward hybrid that leads with raw gas and glue before a bright lemon-fruit lift rounds it out. Effects crest hard and linger, balancing energy with deep relaxation.",
    tagline: "Loud gas, exotic fruit",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Palermo",
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Reads as a sweet, creamy dessert-style hybrid"],
    curatorNote:
      "Public records on Palermo are thin, so this profile is a conservative read of a sweet, dessert-forward hybrid. Expect creamy fruit on the nose with a mellow, balanced lift.",
    tagline: "Sweet, creamy mystery hybrid",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Obsidian Kush",
    sensoryFamily: "kush-classic",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Reads as a dark, earthy Kush-style indica"],
    curatorNote:
      "Obsidian Kush has scant verifiable documentation, so this is a careful read of a classic, dark Kush indica. Anticipate earthy gas and pine giving way to a heavy, sedating body load.",
    tagline: "Dark, earthy Kush sleeper",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "OG Hurricane",
    marketNames: ["Hurricane OG"],
    breeder: "Reserva Privada",
    lineage: {
      parents: ["Panama Punch", "LA Confidential"],
      cross: "Panama Punch × LA Confidential",
    },
    sensoryFamily: "citrus-haze",
    phenotypeNotes: ["Tropical fruit with earthy spice", "70/30 sativa-dominant"],
    curatorNote:
      "A tropical, spice-edged Haze hybrid built for alert, creative daytime sessions. The nose runs fruity and citrus-pine with a peppery undertone, while the high stays giggly and motivated.",
    tagline: "Tropical daytime Haze lift",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "OG Crusher",
    breeder: "Left Coast Extracts",
    lineage: {
      parents: ["OG Kush", "Wedding Cake"],
      cross: "OG Kush × Wedding Cake",
    },
    sensoryFamily: "gas-og",
    phenotypeNotes: ["Rich gas-and-frost aroma with diesel, pine, and creamy vanilla on exhale", "Built for evening and recovery use"],
    curatorNote:
      "An end-of-day knockout pairing classic OG gas with Wedding Cake's creamy dessert sweetness. The exhale turns vanilla-smooth before a fast mental slowdown and heavy couch settle.",
    tagline: "Gassy vanilla couch crusher",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Night Rider",
    marketNames: ["Knightrider"],
    breeder: "Greenpoint Seeds",
    lineage: {
      parents: ["I-95", "Stardawg"],
      cross: "I-95 × Stardawg",
    },
    sensoryFamily: "diesel-chem",
    phenotypeNotes: ["Market name used by multiple breeders", "Peppery diesel over sweet flowery herbs and sharp skunk"],
    curatorNote:
      "A resin-heavy chem hybrid leading with peppery diesel and pungent grapefruit funk. The high lifts the mind into buzzy euphoria before locking the body firmly to the couch.",
    tagline: "Peppery diesel couch-lock",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "NY Sour",
    marketNames: ["NY Sour Diesel"],
    lineage: {
      parents: ["Chemdawg", "NYC Diesel"],
      cross: "Chemdawg × NYC Diesel",
    },
    sensoryFamily: "diesel-chem",
    phenotypeNotes: ["Loud sour citrus and petrol; notes of lime on the break", "Classic underground NYC diesel heritage"],
    curatorNote:
      "A loud, fuel-and-sour-citrus sativa rooted in NYC's underground diesel lineage. The high is a sharp, clear cerebral rush that sparks focus and creativity without sedation.",
    tagline: "Loud sour diesel rush",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Mochi Runtz",
    breeder: "West Coast Cure",
    lineage: {
      parents: ["Mochi", "Runtz"],
      cross: "Mochi × Runtz",
    },
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Resin-glazed, dense flowers with a sugar-vanilla nose", "Creeping onset that builds with each puff"],
    curatorNote:
      "Mochi Runtz reads like a scoop of vanilla gelato dipped in fruit candy, with a creamy sweetness that lingers on the exhale. The high arrives gently then settles into a relaxed, happy ease that pairs well with snacks.",
    tagline: "Creamy candy, easy calm",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Machine Gun Kelly",
    breeder: "Dank by Definition",
    sensoryFamily: "citrus-haze",
    phenotypeNotes: ["Bright orange pistils over lime-green buds with heavy trichome coat"],
    curatorNote:
      "Machine Gun Kelly fires off with pungent citrus and earthy spice cut by a whisper of fuel. The high is immediate and high-octane, electrifying creativity and energy before settling into clear-headed euphoria.",
    tagline: "High-octane citrus rush",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Lucky Charms",
    marketNames: ["Lucky Charmz"],
    breeder: "Bodhi Seeds",
    lineage: {
      parents: ["The White", "Appalachia"],
      cross: "The White × Appalachia",
    },
    sensoryFamily: "purple-berry",
    phenotypeNotes: ["Marketed berry-cereal phenotype emphasizes sweet fruit over the funkier original cut", "Limonene and linalool over caryophyllene"],
    curatorNote:
      "Lucky Charms smells like sun-ripened berries spilling from a cereal bowl, sweet and floral with a hint of citrus. The effect opens cerebral and creative before easing into a relaxed body calm without heavy couch-lock.",
    tagline: "Berry cereal, balanced lift",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Lemon Cherry Sherbert",
    marketNames: ["Lemon Cherry Sherbet"],
    breeder: "Lit Farms",
    lineage: {
      parents: ["Lemon Cherry Gelato", "Sunset Sherbet"],
      cross: "Lemon Cherry Gelato × Sunset Sherbet",
    },
    sensoryFamily: "gelato-exotic",
    phenotypeNotes: ["Lingering lemon-cream aftertaste on a well-cured batch", "Limonene-forward with myrcene and caryophyllene support"],
    curatorNote:
      "Lemon Cherry Sherbert opens with zesty lemon and ripe cherry over a sugary sherbet base that finishes creamy. The high is euphoric and creative up top with a soothing body relaxation that melts tension.",
    tagline: "Cherry-lemon sherbet euphoria",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Lemon Berry Diesel",
    lineage: {
      parents: ["Lemonberry", "Diesel"],
      cross: "Lemonberry × Diesel",
    },
    sensoryFamily: "diesel-chem",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Lemonberry parent contributes Dabney Blue berry and Lemon Thai citrus notes"],
    curatorNote:
      "Lemon Berry Diesel marries tart lemon and sweet blueberry with a pungent diesel kick that sharpens the nose. The effect is uplifting and energetic, sparking creativity and social ease for daytime hours.",
    tagline: "Lemon berry fuel lift",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Lady Madonna",
    sensoryFamily: "citrus-haze",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Sources conflict across multiple lineages"],
    curatorNote:
      "Lady Madonna mixes tangy citrus with savory herbal and spicy notes plus a floral finish that lingers. Effects set in quickly with uplifting energy that boosts motivation, mood, and the urge to socialize.",
    tagline: "Zesty herbal daytime lift",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Krazy Runtz",
    marketNames: ["Crazy Runtz"],
    breeder: "Exotic Genetix",
    lineage: {
      parents: ["Blue Runtz", "Grease Monkey"],
      cross: "Blue Runtz × Grease Monkey",
    },
    sensoryFamily: "candy-exotic",
    phenotypeNotes: ["Grease Monkey influence tightens bud structure and deepens the finish", "Caryophyllene and limonene co-dominate"],
    curatorNote:
      "Krazy Runtz keeps the sweet candy-berry Runtz nose but adds a musky, gassy depth from its Kush side. The experience starts energizing and focused with an appetite bump before gliding into a calm, relaxed close.",
    tagline: "Candy berry, gassy finish",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Lychee Dream",
    lineage: {
      parents: ["Pink Rozay", "White Runtz"],
      cross: "Pink Rozay × White Runtz",
    },
    sensoryFamily: "tropical-fruit",
    phenotypeNotes: ["Sativa-leaning phenotype with clear-headed onset", "Geraniol/linalool-forward lychee top note"],
    curatorNote:
      "A sparkling tropical hybrid that leads with juicy lychee and white florals before settling into vanilla sweetness. The lift is functional and euphoric, making it a daytime crowd-pleaser.",
    tagline: "Juicy lychee, euphoric lift",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Tequila Sunrise",
    breeder: "Lemonnade",
    lineage: {
      parents: ["Lemonchello", "Jet Fuel Gelato #8"],
      cross: "Lemonchello × Jet Fuel Gelato #8",
    },
    sensoryFamily: "citrus-haze",
    phenotypeNotes: ["Suspected tangie/orange-skunk ancestry based on Valencia zest"],
    curatorNote:
  ...
  {
    canonicalName: "Bomb Pop",
    marketNames: ["Bomb Popz"],
    breeder: "Sci-Fi Genetics",
    lineage: {
      parents: ["Chemdawg Guava", "Blue Steel"],
      cross: "Chemdawg Guava × Blue Steel",
    },
    sensoryFamily: "candy-exotic",
    phenotypeNotes: ["Limonene-driven lime brightness with caryophyllene pepper depth", "Lineage debated; Sci-Fi Genetics cross most widely cited"],
    curatorNote:
      "A frozen-treat homage layering cherry, blue raspberry, and lime over a peppery base. Effects pair an uplifting cerebral spark with soothing physical ease, making it versatile day or evening.",
    tagline: "Cherry-lime candy bomb",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Frosted Velvet",
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Heavily frosted, dense dessert-style buds"],
    curatorNote:
      "A creamy dessert-leaning indica defined by plush vanilla and soft berry sweetness. The effect is heavy and calming, drifting toward couch-side relaxation and sleep.",
    tagline: "Plush vanilla cream calm",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Guava Blaze",
    sensoryFamily: "tropical-fruit",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Commonly described as a Gelato #33 phenotype"],
    curatorNote:
      "A tropical, smoothie-sweet sativa lead with creamy guava and a touch of sour earth. Effects skew energetic and euphoric, sparking focus, appetite, and sociability without heavy sedation.",
    tagline: "Creamy guava, energetic spark",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Scarlet Gelato",
    sensoryFamily: "gelato-exotic",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Berry-forward Gelato derivative"],
    curatorNote:
      "A berry-bright take on the creamy Gelato lineage, leading with red fruit over dessert sweetness. The high is euphoric and happy with a relaxed, lightly giggly tail.",
    tagline: "Red-berry creamy Gelato",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Velcroz",
    breeder: "RYTHM",
    lineage: {
      parents: ["Blue Zushie", "Blue Flame"],
      cross: "Blue Zushie × Blue Flame",
    },
    sensoryFamily: "purple-berry",
    phenotypeNotes: ["Near 50/50 balanced hybrid, fast-acting", "Debuted 2024 by RYTHM"],
    curatorNote:
      "A flavor-bomb hybrid balancing sweet blueberry kush against gassy diesel, pine, and black pepper. The onset is fast and euphoric, lifting mood before a mellow relaxation settles over mind and body.",
    tagline: "Blueberry kush, gassy flavor-bomb",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Lemon Tart",
    breeder: "The Cali Connection",
    lineage: {
      parents: ["Lemon Haze", "Super Silver Haze"],
      cross: "Lemon Haze × Super Silver Haze",
    },
    sensoryFamily: "citrus-haze",
    phenotypeNotes: ["Limonene and terpinolene dominant", "Sativa-leaning Haze vigor with cerebral clarity"],
    curatorNote:
      "Lemon Tart leads with sharp lemon zest layered over fresh pine and a faint earthy sweetness. The Haze parentage gives it a clear, energetic lift that suits creative and social daytime sessions.",
    tagline: "Bright zesty Haze energy",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Panama Haze",
    breeder: "ACE Seeds",
    lineage: {
      parents: ["Purple Haze", "Green Haze", "Panama"],
      cross: "Purple Haze × Green Haze × Panama",
    },
    sensoryFamily: "haze-sativa",
    phenotypeNotes: ["Limonene and myrcene present", "Stabilized pure-sativa expression with psychedelic Haze high"],
    curatorNote:
      "Panama Haze opens with tangy citrus and fresh-cut-grass herbal notes that deepen into spice as it matures. The high is the classic Haze profile: clear, energetic, and long-lasting with a hypnotic cerebral edge.",
    tagline: "Deep hypnotic pure sativa",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Tierz",
    lineage: {
      parents: ["Purple Punch", "Zkittlez"],
      cross: "Purple Punch × Zkittlez",
    },
    sensoryFamily: "candy-exotic",
    phenotypeNotes: ["No single breeder-of-record; treat as emerging cultivar documentation", "Fruit-punch confection notes"],
    curatorNote:
      "Tierz is a sweet, tangy fruit-punch hybrid built from candy-leaning Purple Punch and Zkittlez genetics. Lower-temperature sessions pull a buoyant, giggly euphoria with appetite stimulation, while hotter draws lean heavier.",
    tagline: "Sweet tangy fruit-punch hybrid",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Shock Mints",
    lineage: {
      parents: ["Thin Mint Cookies", "Animal Mints"],
      cross: "Thin Mint Cookies × Animal Mints",
    },
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Limonene, caryophyllene, and linalool dominant", "Thick trichome coverage with high total cannabinoids"],
    curatorNote:
      "Shock Mints delivers a cooling mint-candy brightness over a sweet, creamy cookie base. The high opens with a fast euphoric shock then settles into a deepening body calm without full sedation.",
    tagline: "Cooling minty cookie shock",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Scooby Snacks",
    breeder: "Archive Seed Bank",
    lineage: {
      parents: ["Platinum Girl Scout Cookies", "Face Off OG"],
      cross: "Platinum Girl Scout Cookies × Face Off OG",
    },
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Limonene, caryophyllene, and myrcene dominant", "Breeder describes butter cookies over piney OG kush"],
    curatorNote:
      "Scooby Snacks blends sweet butter-cookie notes with piney, gassy OG kush undertones and a touch of citrus. The high opens with euphoric head lift before sinking into a numbing, sedating body relaxation with appetite stimulation.",
    tagline: "Sweet piney kush cookies",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Pomme Jelly",
    marketNames: ["Apple Jelly"],
    breeder: "Grassroots",
    sensoryFamily: "tropical-fruit",
    phenotypeNotes: ["Sweet apple-jelly flavor with tropical and citrus undertones"],
    curatorNote:
      "Pomme Jelly leans into sweet, tart apple-jelly fruitiness backed by tropical and citrus hints over a light earthy base. The effect is energizing, clear-headed, and creative, suiting social and productive daytime use.",
    tagline: "Sweet apple jelly uplift",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Peach Cobbler",
    breeder: "Exclusive Seeds",
    lineage: {
      parents: ["Peach Kush", "Sour Diesel", "Romulan", "Monster Sauce"],
      cross: "Peach Kush × Sour Diesel × Romulan × Monster Sauce",
    },
    sensoryFamily: "tropical-fruit",
    phenotypeNotes: ["Genetics debated; commonly cited four-way cross", "Myrcene, limonene, and caryophyllene dominant"],
    curatorNote:
      "Peach Cobbler offers a dessert-like profile of ripe peaches and cream contrasted by a subtle diesel-and-spice edge. As a balanced hybrid it delivers soothing body relaxation alongside a gentle, mood-lifting cerebral buzz.",
    tagline: "Ripe peaches and cream",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Nuclear Cookies",
    breeder: "Arizona Natural Selections",
    lineage: {
      parents: ["Chernobyl", "Girl Scout Cookies"],
      cross: "Chernobyl × Girl Scout Cookies",
    },
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Terpinolene-forward cuts lean brighter and more citrus-herbal", "Limonene and ocimene drive sweet-citrus top notes"],
    curatorNote:
      "A Cookies-lineage hybrid that wears its citrus and earth proudly without tipping into heavy sedation. The nose is pungent and woody with a nutty herbal lift, and the high stays clear-headed enough for daytime.",
    tagline: "Bright cookies, earthy euphoria",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Lemon Bars",
    marketNames: ["Lemon Barz"],
    lineage: {
      parents: ["Lemon G", "Do-Si-Dos"],
      cross: "Lemon G × Do-Si-Dos",
    },
    sensoryFamily: "citrus-haze",
    phenotypeNotes: ["Reported parentage varies across sources", "Limonene-forward with a caryophyllene pepper edge"],
    curatorNote:
      "Crack the jar and bright lemon peel hits first, then a baked, creamy crust sweetness rounds it out. Effects run focused, social, and clear-minded, making it a strong daytime and creative-work companion.",
    tagline: "Zesty lemon dessert sativa",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Guava Fig",
    breeder: "Mephisto Genetics",
    lineage: {
      parents: ["Satsuma", "Purple Fig"],
      cross: "Satsuma × Purple Fig",
    },
    sensoryFamily: "tropical-fruit",
    phenotypeNotes: ["Autoflower line from Mephisto's Artisanal drop", "Overripe-fruit and skunk phenos with thick frost"],
    curatorNote:
      "This one leans full indica, opening with a strong cerebral push before dropping into intensifying full-body couchlock. The aroma is overripe tropical guava and fig with a fermented, skunky edge that turns jammy when ground.",
    tagline: "Jammy tropical lights-out funk",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Coffee Cake",
    marketNames: ["Koffee Cake"],
    lineage: {
      parents: ["Jungle Cake", "Gorilla Glue #4"],
      cross: "Jungle Cake × Gorilla Glue #4",
    },
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Multiple unrelated Coffee Cake lines exist", "Caryophyllene-led with limonene and myrcene"],
    curatorNote:
      "A dessert hybrid built on roasted coffee, vanilla cream, and a doughy sweetness with a whisper of earthy diesel. The high starts heady and uplifting, then eases into a profound body calm without slamming the door shut.",
    tagline: "Roasted coffee dessert hybrid",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Cherry Inferno",
    breeder: "Tiki Madman",
    lineage: {
      parents: ["Dante's Inferno", "Cherry Pie Breath", "Peanut Butter Breath"],
      cross: "Dante's Inferno × (Cherry Pie Breath × Peanut Butter Breath)",
    },
    sensoryFamily: "purple-berry",
    phenotypeNotes: ["Multiple breeder versions exist", "Myrcene and caryophyllene dominant with limonene and geraniol cherry notes"],
    curatorNote:
      "Deep candied cherry sits at the center, wrapped in a doughy pastry sweetness and cut with peppery, gassy spice. The effect is balanced and pleasant, easing physical tension while keeping a euphoric, happy headspace.",
    tagline: "Candied cherry pastry gas",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Chemgurl",
    marketNames: ["Chem Girl"],
    lineage: {
      parents: ["Chemdawg", "Girl Scout Cookies"],
      cross: "Chemdawg × Girl Scout Cookies",
    },
    sensoryFamily: "diesel-chem",
    phenotypeNotes: ["No single breeder trademark; provenance varies", "Cuts range from pure fuel-forward to sweeter cookie-dough"],
    curatorNote:
      "Unmistakable chem fuel cuts through a sealed jar, then sweet cookie dough, pepper, and a hint of lemon rind round it out. The flowers come dense and resin-caked, and the high is robust and layered rather than mellow.",
    tagline: "Garage gas meets bakery",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Brooklyn Runtz",
    lineage: {
      parents: ["Zkittlez", "Gelato"],
      cross: "Zkittlez × Gelato (Runtz phenotype)",
    },
    sensoryFamily: "candy-exotic",
    phenotypeNotes: ["Regional Runtz-family cut; exact selection undocumented", "Sugary candy nose with tropical citrus and sour-berry top notes"],
    curatorNote:
      "Brooklyn Runtz reads as a textbook candy-bag Runtz, all sugary fruit and tropical citrus with a creamy backbone. The high is euphoric and social up top before settling into an easy, relaxed calm.",
    tagline: "Candy-bag euphoria, Brooklyn style",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Blue Zkittlez",
    marketNames: ["Blue Zkittles"],
    breeder: "Dying Breed Seeds",
    lineage: {
      parents: ["Blueberry", "Zkittlez"],
      cross: "Blueberry × Zkittlez",
    },
    sensoryFamily: "purple-berry",
    phenotypeNotes: ["Berry-forward Zkittlez selection with blueberry sweetness", "Frequently shows purple-blue hues in cured flower"],
    curatorNote:
      "Blue Zkittlez is a berry-candy showcase, layering ripe blueberry over sweet citrus and a whisper of diesel. The high builds slowly into a warm, full-body relaxation that drifts toward sleep.",
    tagline: "Blueberry candy, full-body calm",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Bills Thrills",
    sensoryFamily: "funky-exotic",
    phenotypeNotes: ["Pedigree unverified — limited public documentation", "Profile estimated; treat sensory notes as provisional"],
    curatorNote:
      "Bills Thrills surfaces only in scattered listings with no reliable lineage, so its profile here is a cautious estimate of a sweet, earthy, balanced hybrid. Expect a gentle, mood-lifting effect pending firsthand confirmation.",
    tagline: "Mystery hybrid, gentle lift",
    artStatus: "none",
    sourceConfidence: "low",
  },
  {
    canonicalName: "Blueberry Punch",
    lineage: {
      parents: ["Blueberry", "Purple Punch"],
      cross: "Blueberry × Purple Punch",
    },
    sensoryFamily: "purple-berry",
    phenotypeNotes: ["Lineage ambiguous across breeders; commonly Blueberry x Purple Punch", "Cool-night phenos show purple hues with grape-candy sweetness"],
    curatorNote:
      "Blueberry Punch leans rich and dessert-like, with blueberry compote and grape candy resting on a vanilla-cream foundation. A gentle spice and herbal lilt arrive on the exhale, while effects settle into relaxed, happy ease.",
    tagline: "Blueberry compote and grape candy",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Blue Zangria",
    lineage: {
      parents: ["Rainbow Zangria", "Blue Lobster"],
      cross: "Rainbow Zangria × Blue Lobster",
    },
    sensoryFamily: "candy-exotic",
    phenotypeNotes: ["Parentage varies by breeder", "Creamy blueberry-banana overtone with sharp citrus accents"],
    curatorNote:
      "Blue Zangria blends creamy blueberry and banana with a bright citrus snap over a subtle earthy base. The effect is a sparkling, mood-lifting head high that keeps the mind active while the body eases into light relaxation.",
    tagline: "Creamy berry, sparkling lift",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Biker Kush",
    breeder: "Karma Genetics",
    lineage: {
      parents: ["Hell's OG", "SFV OG Kush"],
      cross: "Hell's OG × SFV OG Kush",
    },
    sensoryFamily: "gas-og",
    phenotypeNotes: ["BX2 OG selection from Karma Genetics", "Aggressive lemon-pine and diesel with black-pepper edge"],
    curatorNote:
      "Biker Kush is a true OG, all aggressive lemon-pine and diesel fuel with a peppery, earthy backbone. The high opens euphoric and cerebral before melting into a heavy, stress-dissolving body stone.",
    tagline: "Pungent lemon-pine OG gas",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Big Buddha Cheese",
    marketNames: ["Big Buddha", "BB Cheese"],
    breeder: "Big Buddha Seeds",
    lineage: {
      parents: ["UK Cheese", "Afghani"],
      cross: "UK Cheese clone × Afghani",
    },
    sensoryFamily: "skunk-funk",
    phenotypeNotes: ["Pungent ripe-cheese nose with skunky backbone", "Indica-leaning structure with cerebral, uplifting onset"],
    curatorNote:
      "A heritage Cheese cut bred to seed and crowned at the 2016 Cannabis Cup. Expect a loud, fermented-cheese funk that mellows into earthy sweetness on the palate. The high stays clear and social before settling into a warm body calm.",
    tagline: "Loud ripe cheese funk",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Big Apple Diesel",
    marketNames: ["Big Apple"],
    breeder: "Seed Junky Genetics",
    lineage: {
      parents: ["Apple Fritter", "Sherbet"],
      cross: "Apple Fritter × Sherbet",
    },
    sensoryFamily: "diesel-chem",
    phenotypeNotes: ["Tart apple-citrus over diesel with creamy sweet finish"],
    curatorNote:
      "A gassy, citrus-bright take on the Big Apple line where diesel notes lead the nose. Tart apple zest and creamy sweetness round out a punchy, uplifting profile.",
    tagline: "Gassy tart apple zest",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Bazooka Haze",
    breeder: "Mantis Genetics",
    lineage: {
      parents: ["Tijuana Haze", "Lucille's OG"],
      cross: "Tijuana Haze × Lucille's OG",
    },
    sensoryFamily: "citrus-haze",
    phenotypeNotes: ["Citrus-forward nose with peppery caryophyllene spice", "Long-flowering sativa with energetic cerebral lift"],
    curatorNote:
      "An explosive haze cut built for daytime creativity and social energy. Zesty citrus leads, with spicy and earthy undertones giving it depth. The high is racy and clear-headed with a light body lift.",
    tagline: "Bright zesty haze rush",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Bananaconda",
    breeder: "Honey Sticks Genetics",
    lineage: {
      parents: ["Snake Cake", "Dual OG #4"],
      cross: "Snake Cake × Dual OG #4",
    },
    sensoryFamily: "tropical-fruit",
    phenotypeNotes: ["Ripe candy-banana nose layered with cream and vanilla bean", "Heavy sedative finish driving couch-lock and sleep"],
    curatorNote:
      "A fruit-forward indica that opens with ripe banana, tropical sweetness, and a creamy vanilla underbelly. Very high THC drives a fast, hazy onset that melts into deep body relaxation.",
    tagline: "Candy banana couch melt",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
    canonicalName: "Blueberry Dream",
    lineage: {
      parents: ["Blueberry", "Haze"],
      cross: "Blueberry × Haze",
    },
    sensoryFamily: "purple-berry",
    phenotypeNotes: ["Sweet ripe-blueberry nose backed by herbal haze and pine", "Sativa-leaning, functional and motivating"],
    curatorNote:
      "A berry-dominant cut of the classic Blue Dream lineage, leaning hard into sweet ripe blueberry. Herbal haze and soft pine ground the sweetness for a layered nose. Effects are clear, creative, and uplifting with only a light physical settle.",
    tagline: "Sweet berry haze lift",
    artStatus: "none",
    sourceConfidence: "medium",
  },
  {
    canonicalName: "Alien Cookies",
    marketNames: ["Alien Cookies OG"],
    breeder: "Jaws Genetics",
    lineage: {
      parents: ["Girl Scout Cookies", "Aliendog"],
      cross: "GSC Forum Cut × Aliendog",
    },
    sensoryFamily: "dessert-cookies",
    phenotypeNotes: ["Pungent fruity-floral nose with rose, lavender, and toasted vanilla", "Even 50/50 hit"],
    curatorNote:
      "A resin-heavy, balanced cookies cut prized as a foundational exotic parent. The nose is loud and complex, blending ripe fruit, floral notes, and toasted vanilla bean. Effects land euphoric and relaxing with an appetite kick.",
    tagline: "Loud floral cookie fruit",
    artStatus: "none",
    sourceConfidence: "high",
  },
  {
  ...
  },
  {
    ...
    breeder: "Carpenter Farms",
    sensoryFamily: "citrus-haze",
    phenotypeNotes: ["Lime-forward phenotype likely drawn from Lime Skunk / Key Lime Pie style families"],
    curatorNote:
