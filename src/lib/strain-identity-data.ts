...
export const IDENTITIES: StrainIdentity[] = [
  ...
  },
  {
    ...
    artPrompt:
      "Vertical 3:4 poster artwork (768x1024) capturing the spirit of a heavy, dense triple-Chem diesel indica. A lone weathered chrome muscle car idling on a fog-bound forest service road deep among dark pines at dusk, headlights cutting a thick haze of warm exhaust and fuel vapour; oil-slick puddles on cracked asphalt throw back an iridescent petrol-rainbow sheen. Palette deep and rooted — diesel-petrol blue and dark pine green over earthy brown and wet black asphalt, amber headlight and dusk glow catching the chrome and the oily shimmer, fading into a wine-dark sky. Mood: relaxing and weighty — a euphoric warmth sinking into a dense, grounded stillness, evening-leaning. Cinematic, painterly, high-contrast, premium editorial poster. Keep the lower third calmer and darker for legible overlay text. The strain name may appear baked into the scene (e.g. on a worn road sign or stamped into the car's plate); no overlaid captions, logos or watermarks; no people, products or cannabis leaves.",
