...
export function TasteMatchClient() {
  ...
  // Existing strain-level verdicts so feedback pills on each
  // recommendation card land pre-filled when a returning user sees
  // results. Hydrated once below alongside the profile fetch.
        ...
        <>
          ...
          <div className="mt-10">
            <ResultsView
              ...
              renderExtra={(rec) => (
                <FeedbackPill
                  strainName={rec.resolvedName || rec.strainName}
                  initial={verdicts[rec.resolvedName || rec.strainName] ?? null}
                  source="taste-match"
                />
              )}
            />
